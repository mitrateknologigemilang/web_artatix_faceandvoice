...
var best_index : i32 = 0;`,`if (${e.getByIndices("input_indices")} ${r.selectLastIndex>0?">=":">"} value) {
         value = ${e.getByIndices("input_indices")};
         best_index = i32(last_index);
       }`,"",i.setByOffset("global_idx","best_index")]},[r.axis],7,r.keepDims),{inputs:[0]})},rO=e=>tL(e)}),nK=es(()=>{nR(),nB(),nL(),nV(),rR=(e,r,i)=>r&&e?`
    ...
    `,rM=(e,r,i,a,n,s,o,u,l,d,p,c)=>{var h,f,m,g,y,_,b,$,v,w,x,S,k,T,I,C,E,z,A,O,R,M,N,B,D;let U,P,L,q,W,V,j,G,H,F,K,Z,X,Q,Y,J,ee,et,er,ei,ea,en,es,eo,eu,el,ed,ep,ec,eh,ef,em,eg,ey=Math.min(e.outputCount,1+ +!!o+ +!!u),e_=ey>1?o:void 0,eb=ey>1?u:void 0,e$=ey>1?d.pastSequenceLength:0,ev=e$+d.kvSequenceLength,ew=l&&tc.size(l.dims)>0?l:void 0,ex=[r,i];e_&&tc.size(e_.dims)>0&&ex.push(e_),ew&&ex.push(ew),p&&ex.push(p),c&&ex.push(c);let eS=e.compute((h=ey,f=r,m=i,g=e_,y=ew,_=d,b=e$,$=p,v=c,U=b+_.kvSequenceLength,P=[_.batchSize,_.numHeads,_.sequenceLength,U],L=h>1&&g,q=_.kvNumHeads?_.kvNumHeads:_.numHeads,W=L?[_.batchSize,q,U,_.headSize]:void 0,V=_.nReps?_.nReps:1,j=0===_.scale?1/Math.sqrt(_.headSize):_.scale,G=tH(_.headSize),H=_.headSize/G,F={x:Math.ceil(U/12),y:Math.ceil(_.sequenceLength/12),z:_.batchSize*_.numHeads},K=[{type:12,data:_.sequenceLength},{type:12,data:H},{type:12,data:U},{type:12,data:_.numHeads},{type:12,data:_.headSize},{type:1,data:j},{type:12,data:b},{type:12,data:_.kvSequenceLength},{type:12,data:V}],Z=L&&g&&tc.size(g.dims)>0,X=["type","type"],Z&&X.push("type"),y&&X.push("type"),$&&X.push("type"),v&&X.push("type"),Q=[{dims:P,dataType:f.dataType,gpuDataType:0}],L&&Q.push({dims:W,dataType:f.dataType,gpuDataType:0}),{name:"AttentionProbs",shaderCache:{hint:`${G};${void 0!==y};${void 0!==g};${h}`,inputDependencies:X},getRunData:()=>({outputs:Q,dispatchGroup:F,programUniforms:K}),getShaderSource:e=>{let r=tY("q",f.dataType,f.dims,G),i=[r,tY("key",m.dataType,m.dims,G)];if(Z){let e=tY("past_key",g.dataType,g.dims,G);i.push(e)}y&&i.push(tY("attention_bias",y.dataType,y.dims));let a=$?tY("seq_lens",$.dataType,$.dims):void 0;a&&i.push(a);let n=v?tY("total_sequence_length_input",v.dataType,v.dims):void 0;n&&i.push(n);let s=tJ("output",f.dataType,P),o=[s];L&&o.push(tJ("present_key",f.dataType,W,G));let u=tj(1,G);return`
  const TILE_SIZE = 12u;
  ...
  }`},getRunData:()=>({outputs:[],dispatchGroup:{x:1,y:T,z:x*S},programUniforms:et})}),{inputs:p&&c?[eS,p,c]:[eS],outputs:[]});let ek=[eS,a];eb&&tc.size(eb.dims)>0&&ek.push(eb),p&&ek.push(p),c&&ek.push(c),e.compute((z=ey,A=eS,O=a,R=eb,M=d,N=e$,B=p,D=c,en=N+M.kvSequenceLength,es=M.nReps?M.nReps:1,eo=M.vHiddenSize*es,eu=z>1&&R,el=M.kvNumHeads?M.kvNumHeads:M.numHeads,ed=eu?[M.batchSize,el,en,M.headSize]:void 0,ep=[M.batchSize,M.sequenceLength,eo],ec={x:Math.ceil(M.vHeadSize/12),y:Math.ceil(M.sequenceLength/12),z:M.batchSize*M.numHeads},eh=[{type:12,data:M.sequenceLength},{type:12,data:en},{type:12,data:M.vHeadSize},{type:12,data:M.numHeads},{type:12,data:M.headSize},{type:12,data:eo},{type:12,data:N},{type:12,data:M.kvSequenceLength},{type:12,data:es}],ef=eu&&R&&tc.size(R.dims)>0,em=["type","type"],ef&&em.push("type"),B&&em.push("type"),D&&em.push("type"),eg=[{dims:ep,dataType:A.dataType,gpuDataType:0}],eu&&eg.push({dims:ed,dataType:A.dataType,gpuDataType:0}),{name:"AttentionScore",shaderCache:{hint:`${void 0!==R};${z}`,inputDependencies:em},getRunData:()=>({outputs:eg,dispatchGroup:ec,programUniforms:eh}),getShaderSource:e=>{let r=tY("probs",A.dataType,A.dims),i=[r,tY("v",O.dataType,O.dims)];ef&&i.push(tY("past_value",R.dataType,R.dims));let a=B?tY("seq_lens",B.dataType,B.dims):void 0;B&&i.push(a);let n=D?tY("total_sequence_length_input",D.dataType,D.dims):void 0;D&&i.push(n);let s=[tJ("output",A.dataType,ep)];return eu&&s.push(tJ("present_value",A.dataType,ed)),`
  const TILE_SIZE = 12u;
...
`)})(o,c)}
  }`}}})(c,n,p,i[0].dataType),{inputs:c})},iA=e=>tL({axis:e.axis})}),n1=es(()=>{nR(),nB(),iO=(e,r,i="f32")=>{switch(e.activation){case"Relu":return`value = max(value, ${r}(0.0));`;case"Sigmoid":return`value = (${r}(1.0) / (${r}(1.0) + exp(-value)));`;case"Clip":return`value = clamp(value, ${r}(${i}(uniforms.clip_min)), ${r}(${i}(uniforms.clip_max)));`;case"HardSigmoid":return`value = max(${r}(0.0), min(${r}(1.0), ${i}(uniforms.alpha) * value + ${i}(uniforms.beta)));`;case"LeakyRelu":return`value = select(${i}(uniforms.alpha) * value, value, value >= ${r}(0.0));`;case"Tanh":return`let e2x = exp(-2.0 * abs(value));
              value = sign(value) * (1.0 - e2x) / (1.0 + e2x);
        `;case"":return"";default:throw Error(`Unsupported activation ${e.activation}`)}},iR=(e,r)=>{"Clip"===e.activation?r.push({type:1,data:e.clipMax},{type:1,data:e.clipMin}):"HardSigmoid"===e.activation?r.push({type:1,data:e.alpha},{type:1,data:e.beta}):"LeakyRelu"===e.activation&&r.push({type:1,data:e.alpha})},iM=(e,r)=>{"Clip"===e.activation?r.push({name:"clip_max",type:"f32"},{name:"clip_min",type:"f32"}):"HardSigmoid"===e.activation?r.push({name:"alpha",type:"f32"},{name:"beta",type:"f32"}):"LeakyRelu"===e.activation&&r.push({name:"alpha",type:"f32"})},iN=e=>{let r=e?.activation||"";if("HardSigmoid"===r){let[i,a]=e?.activation_params||[.2,.5];return{activation:r,alpha:i,beta:a}}if("Clip"===r){let[i,a]=e?.activation_params||[tm,tg];return{activation:r,clipMax:a,clipMin:i}}if("LeakyRelu"===r){let[i]=e?.activation_params||[.01];return{activation:r,alpha:i}}return{activation:r}}}),n2=es(()=>{iB=(e,r)=>{switch(e){case 1:return r;case 2:return`vec2<${r}>`;case 3:return`vec3<${r}>`;case 4:return`vec4<${r}>`;default:throw Error(`${e}-component is not supported.`)}},iD=e=>`
...
`}),n4=es(()=>{nR(),nB(),nV(),n1(),iP=(e,r,i,a,n)=>{let s=a-i;return`
...
`},iL=(e,r,i,a,n=!1,s)=>{let o=e[0].dims,u=e[1].dims,l=o[o.length-2],d=u[u.length-1],p=o[o.length-1],c=tH(d),h=tH(p),f=tH(l),m=tc.size(i)/c/f,g=e.length>2,y=a?a.slice(0,-2):i.slice(0,-2),_=[tc.size(y),l,d],b=[{type:12,data:m},{type:12,data:l},{type:12,data:d},{type:12,data:p}];return iR(r,b),b.push(...tG(y,o,u)),g&&b.push(...tG(e[2].dims)),b.push(...tG(_)),{name:"MatMulNaive",shaderCache:{hint:`${r.activation};${c};${h};${f};${n}`,inputDependencies:g?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:s?s(i):i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(m/64)},programUniforms:b}),getShaderSource:a=>{let s=t1("batch_dims",e[0].dataType,y.length),l=tY("a",e[0].dataType,o.length,h),d=tY("b",e[1].dataType,u.length,c),p=tJ("output",e[0].dataType,_.length,c),m=tV(p.type.tensor),b=iO(r,p.type.value,m),$=[l,d],v="";if(g){let r=n?c:1;$.push(tY("bias",e[2].dataType,e[2].dims.length,r)),v=`${n?`value += bias[col / ${r}];`:`value += ${p.type.value}(bias[row + i]);`}`}let w=[{name:"output_size",type:"u32"},{name:"M",type:"u32"},{name:"N",type:"u32"},{name:"K",type:"u32"}];return iM(r,w),`
...
`}return e})()}
  ...
  `}}}}),n6=es(()=>{nR(),nB(),nV(),n1(),n4(),n2(),iq=(e,r,i="f32",a,n=!1,s=32,o=!1,u=32)=>{let l,d,p,c,h=r[1]*e[1],f=r[0]*e[0],m=n?h:s,g=n?s:h,y=m/r[0],_=s/r[1];if(!((n&&4===y&&4===e[1]||!n&&(3===y||4===y))&&m%r[0]==0&&s%r[1]==0&&4===e[0]))throw Error(`If transposeA ${n} is true, innerElementSize ${y} and workPerThread[1] ${e[1]} must be 4.
...
`},ij=(e,r,i,a,n=!1,s)=>{let o=e[0].dims,u=e[1].dims,l=o.slice(0,-2),d=u.slice(0,-2),p=a?a.slice(0,-2):i.slice(0,-2),c=tc.size(p),h=o[o.length-2],f=o[o.length-1],m=u[u.length-1],g=f%4==0&&m%4==0,y=h<=8?[4,1,1]:[4,4,1],_=[8,8,1],b=[Math.ceil(m/_[0]/y[0]),Math.ceil(h/_[1]/y[1]),Math.ceil(c/_[2]/y[2])],$=g?4:1,v=[...l,h,f/$],w=v.length,x=[...d,f,m/$],S=x.length,k=[c,h,m/$],T=[{type:6,data:h},{type:6,data:m},{type:6,data:f}];iR(r,T),T.push(...tG(p,v,x));let I=["rank","rank"],C=e.length>2;return C&&(T.push(...tG(e[2].dims)),I.push("rank")),T.push(...tG(k)),{name:"MatMul",shaderCache:{hint:`${y};${r.activation};${g};${n}`,inputDependencies:I},getRunData:()=>({outputs:[{dims:s?s(i):i,dataType:e[0].dataType}],dispatchGroup:{x:b[0],y:b[1],z:b[2]},programUniforms:T}),getShaderSource:i=>{let a=p.length,s=t1("batchDims",e[0].dataType,a,1),o=tV(e[0].dataType),u=tY("a",e[0].dataType,w,$),l=tY("b",e[1].dataType,S,$),d=tJ("result",e[0].dataType,k.length,$),c=[u,l];if(C){let r=n?$:1;c.push(tY("bias",e[2].dataType,e[2].dims.length,r))}let h=[{name:"dim_a_outer",type:"i32"},{name:"dim_b_outer",type:"i32"},{name:"dim_inner",type:"i32"}];iM(r,h);let f=tV(d.type.tensor),m=((e,r,i,a,n=!1)=>{let[s,o,u,l]=a,d=tV(a[0].type.tensor);return`
  ...
  ${g?iq(y,_,o,s):iV(y,_,o,s)}
                   `}}}}),n8=es(()=>{nR(),nN(),nV(),n1(),n2(),n3(),n6(),iG=(e,r,i,a,n,s,o,u,l)=>{let d="NHWC"===r.format,p=d?e[0].dims[3]:e[0].dims[1],c=i[0],h=d?i[2]:i[3],f=d?i[1]:i[2],m=d?i[3]:i[1],g=d&&(p%4==0||p%3==0)&&m%4==0,y=d?m:h*f,_=d?h*f:m,b=[8,8,1],$=a<=8?[4,1,1]:[4,4,1],v=[Math.ceil(y/b[0]/$[0]),Math.ceil(_/b[1]/$[1]),Math.ceil(c/b[2]/$[2])];tl("verbose",()=>`[conv2d_mm_webgpu] dispatch = ${v}`);let w=g?d&&p%4!=0?3:4:1,x=b[1]*$[1],S=b[0]*$[0],k=Math.max(b[0]*w,b[1]),T=a%x==0,I=n%S==0,C=s%k==0,E=g?[w,4,4]:[1,1,1],z=[{type:6,data:a},{type:6,data:n},{type:6,data:s},{type:6,data:[r.pads[0],r.pads[1]]},{type:6,data:r.strides},{type:6,data:r.dilations}];iR(r,z),z.push(...tG(e[0].dims,e[1].dims));let A=["rank","rank"];return o&&(z.push(...tG(e[2].dims)),A.push("rank")),z.push(...tG(i)),{name:"Conv2DMatMul",shaderCache:{hint:`${r.cacheKey};${w};${g};${T};${I};${C};${x};${S};${k}`,inputDependencies:A},getRunData:()=>({outputs:[{dims:l?l(i):i,dataType:e[0].dataType}],dispatchGroup:{x:v[0],y:v[1],z:v[2]},programUniforms:z}),getShaderSource:a=>{let n=[{name:"dim_a_outer",type:"i32"},{name:"dim_b_outer",type:"i32"},{name:"dim_inner",type:"i32"},{name:"pad",type:"i32",length:2},{name:"stride",type:"i32",length:2},{name:"dilation",type:"i32",length:2}];iM(r,n);let s=g?4:1,l=tV(e[0].dataType),p=`
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${b}) {
      ...
      setOutputAtCoords(coords[0], coords[1], coords[2], coords[3], value);
        ...
        fn getBiasByOutputCoords(coords : array<u32, 5>) -> ${l} {
          ...
          }`}}}}),n9=es(()=>{nR(),nB(),nV(),n1(),iQ=(e,r,i,a)=>{let n=e.length>2,s=n?"value += b[output_channel];":"",o=e[0].dims,u=e[1].dims,l="NHWC"===r.format,d=l?i[3]:i[1],p=d/r.group,c=l&&p>=4?tH(d):1,h=tc.size(i)/c,f=[{type:12,data:h},{type:12,data:r.dilations},{type:12,data:[r.strides[0],r.strides[1]]},{type:12,data:[r.pads[0],r.pads[1]]},{type:12,data:p}];return iR(r,f),f.push(...tG(o,[u[0],u[1],u[2],u[3]/c])),f.push(...tG([i[0],i[1],i[2],i[3]/c])),{name:"GroupedConv",shaderCache:{hint:`${r.cacheKey}_${c}`,inputDependencies:n?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:a?a(i):i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(h/64)},programUniforms:f}),getShaderSource:a=>{let d=tJ("output",e[0].dataType,i.length,c),p=tV(d.type.tensor),h=iO(r,d.type.value,p),f=tY("x",e[0].dataType,o.length),m=tY("w",e[1].dataType,u.length,c),g=[f,m];n&&g.push(tY("b",e[2].dataType,e[2].dims,c));let y=[{name:"output_size",type:"u32"},{name:"dilations",type:"u32",length:r.dilations.length},{name:"strides",type:"u32",length:2},{name:"pads",type:"u32",length:2},{name:"output_channels_per_group",type:"u32"}];iM(r,y);let _=l?`
  ...
  ${a.mainStart()}
    ...
    ${h}
    ${d.setByOffset("global_idx","value")}
  }`}}},iY=(e,r,i,a)=>{let n=e.length>2,s=tH(i[3]),o=tH(i[2]),u=tc.size(i)/s/o,l=[e[0].dims[0],e[0].dims[1],e[0].dims[2],e[0].dims[3]/s],d=[e[1].dims[0],e[1].dims[1],e[1].dims[2],e[1].dims[3]/s],p=[i[0],i[1],i[2],i[3]/s],c=[{type:12,data:u},{type:6,data:[r.strides[0],r.strides[1]]},{type:6,data:[r.pads[0],r.pads[1]]}];iR(r,c),c.push(...tG(l,d,p));let h=(o-1)*r.strides[1]+d[1];return{name:"GroupedConv-Vectorize",shaderCache:{hint:`${r.cacheKey};${s};${o};${h};${d[0]};${d[1]}`,inputDependencies:n?["rank","rank","type"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:a?a(i):i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:c}),getShaderSource:i=>{let a=tJ("output",e[0].dataType,p.length,s),u=tV(a.type.tensor),c=iO(r,a.type.value,u),f=tY("x",e[0].dataType,l.length,s),m=tY("w",e[1].dataType,d.length,s),g=[f,m];n&&g.push(tY("b",e[2].dataType,e[2].dims,s));let y=[{name:"output_size",type:"u32"},{name:"strides",type:"i32",length:2},{name:"pads",type:"i32",length:2}];return iM(r,y),`
...
`)};
    ...
    ${e.mainStart()}
    ${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.vec_size")}
    ${a}`},getRunData:()=>({outputs:[{dims:s,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:c})}),{inputs:[0]})}}),ss=es(()=>{nR(),nB(),nV(),nQ(),am=e=>{var r;let i,a,n,s;e.inputs.length<2||0===tc.size(e.inputs[1].dims)?ic(e):e.compute((i=(r=e.inputs)[0].dataType,a=tc.size(r[0].dims),s=(n=tc.size(r[1].dims))%4==0,{name:"FastGeluWithBias",shaderCache:{hint:`${s}`,inputDependencies:["type","type"]},getShaderSource:e=>{let r=tY("x",i,[1],4),a=tY("bias",i,[1],4),n=tJ("y",i,[1],4),o=e=>`
  ...
  ${e.mainStart()}
    ...
    input_slice_offsets_data[global_idx] =  base_offset + u32(relative_slice_offset);
      ...
      ${g.setByOffset("global_idx","value")};
  }`}))}}),sp=es(()=>{nR(),nB(),nV(),aS=e=>({transA:e.transA,transB:e.transB,alpha:e.alpha,beta:e.beta,cacheKey:`${e.transA};${e.transB};${1===e.alpha}`}),ak=(e,r)=>{(e=>{if(!e)throw Error("Input is missing");if(e.length<2||e.length>3)throw Error("Invaid input number.");if(3===e.length&&e[2].dims.length>2)throw Error("Invalid input shape of C");if(e[0].dataType!==e[1].dataType||3===e.length&&e[0].dataType!==e[2].dataType)throw Error("Input types are mismatched")})(e.inputs),e.compute(((e,r)=>{let i=e[0].dims.slice(),a=e[1].dims.slice(),[n,s,o]=tf.getShapeOfGemmResult(i,r.transA,a,r.transB,3===e.length?e[2].dims:void 0),u=[n,s],l=Math.ceil(s/16),d=Math.ceil(n/16),p=(tc.size(u),[{type:12,data:l},{type:12,data:n},{type:12,data:s},{type:12,data:o},{type:1,data:r.alpha},{type:1,data:r.beta}]),c=["type","type"];return 3===e.length&&(p.push(...tG(e[2].dims)),c.push("rank")),p.push(...tG(u)),{name:"GemmShared",shaderCache:{hint:`${r.cacheKey}`,inputDependencies:c},getRunData:()=>({outputs:[{dims:u,dataType:e[0].dataType}],dispatchGroup:{x:l*d},programUniforms:p}),getShaderSource:i=>{let a=tY("a",e[0].dataType,e[0].dims),n=tY("b",e[1].dataType,e[1].dims),s=null,o=[a,n];3===e.length&&(s=tY("c",e[2].dataType,e[2].dims.length),o.push(s));let l=tJ("output",e[0].dataType,u.length);o.push(l);let d="",p="";r.transA&&r.transB?(p=`
  ...
  }`}}})(e.inputs,r))}}),sc=es(()=>{nR(),nB(),nW(),nV(),[aT,aI,aC,aE]=[0,1,2,3],az=`
...
`)}
  ...
  }`}},{inputs:[r,i,a],outputs:[-1]})[0]},aF=(e,r)=>{var i,a,n;let s,o,u,l,d,p,c,h,f;"NHWC"===r.format?((e,r,i)=>{let a=r[0].dims,n=a[0],s=a[a.length-1],o=tc.sizeFromDimension(a,1)/s,u=tH(s),l=tc.size(a)/u,d=[{type:12,data:o},{type:12,data:Math.floor(s/u)}],p=!1,c=[0,a.length-1];for(let e=0;e<a.length-2;e++)p=p||1!==a[e+1],c.push(e+1);let h=(p=p&&1!==a[a.length-1])?e.compute(t6(e.inputs[0],c),{inputs:[e.inputs[0]],outputs:[-1]})[0]:e.inputs[0].reshape(Array.from({length:a.length},(e,r)=>a[c[r]])),f=aH(e,h,r[1],r[2],n,o,s,i.epsilon);e.compute({name:"InstanceNormalizationNHWC",shaderCache:{hint:`${u}`,inputDependencies:["type","type"]},getRunData:()=>({outputs:[{dims:a,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:d}),getShaderSource:e=>{let i=tV(r[0].dataType),n=1===u?"vec2f":`mat${u}x2f`,s=e=>{let r=0===e?"x":"y",a=1===u?"f32":`vec${u}f`;switch(u){case 1:return`${i}(${a}(scale.${r}))`;case 2:return`vec2<${i}>(${a}(scale[0].${r}, scale[1].${r}))`;case 4:return`vec4<${i}>(${a}(scale[0].${r}, scale[1].${r}, scale[2].${r}, scale[3].${r}))`;default:throw Error(`Not supported compoents ${u}`)}},o=tY("input",r[0].dataType,r[0].dims,u),l=tJ("output",r[0].dataType,a,u);return`
  ...
  ${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
      ...
      ${n.setByOffset("global_idx","value")};
  }`}},{inputs:[a[0],c]}))}}),s_=es(()=>{nR(),nB(),nV(),aK=(e,r)=>{(e=>{if(!e||e.length<2)throw Error("layerNorm requires at least 2 inputs.")})(e.inputs),e.compute(((e,r,i)=>{let a=r.simplified,n=e[0].dims,s=e[1],o=!a&&e[2],u=tc.normalizeAxis(r.axis,n.length),l=tc.sizeToDimension(n,u),d=tc.sizeFromDimension(n,u),p=tc.size(s.dims),c=o?tc.size(o.dims):0;if(p!==d||o&&c!==d)throw Error(`Size of X.shape()[axis:] == ${d}.
  ...
  ${r.mainStart()}
    ...
    ${_?"inv_std_output[global_idx] = inv_std_dev":""};
        ...
        }`}})):e.compute((n=e.inputs,s=r,A=(z=n[0].dims).length,O=z[A-2],R=s.k,M=s.n,N=z.slice(0,A-2),B=tc.size(N),D=n[1].dims[2]/4,U=n[0].dataType,P=tH(s.k),L=tH(D),q=tH(M),W=N.concat([O,M]),V=O>1&&M/q%2==0?2:1,j=tc.size(W)/q/V,G=[],H=[B,O,R/P],(F=tc.convertShape(n[1].dims).slice()).splice(-1,1,D/L),G.push(...tG(H)),G.push(...tG(F)),G.push(...tG(n[2].dims)),4===n.length&&G.push(...tG(tc.convertShape(n[3].dims))),K=[B,O,M/q],G.push(...tG(K)),{name:"MatMulNBits",shaderCache:{hint:`${s.blockSize};${s.bits};${P};${L};${q};${V};64`,inputDependencies:Array(n.length).fill("rank")},getRunData:()=>({outputs:[{dims:W,dataType:U}],dispatchGroup:{x:j},programUniforms:G}),getShaderSource:e=>{let r=H.length,i=tY("a",n[0].dataType,r,P),a=tY("b",12,F.length,L),o=tY("scales",n[2].dataType,n[2].dims.length),u=[i,a,o],l=4===n.length?tY("zero_points",12,n[3].dims.length):void 0;l&&u.push(l);let d=K.length,p=tJ("output",n[0].dataType,d,q),c=tV(n[0].dataType),h=(()=>{switch(P){case 1:return`array<${c}, 8>`;case 2:return`mat4x2<${c}>`;case 4:return`mat2x4<${c}>`;default:throw Error(`${P}-component is not supported.`)}})(),f=Math.floor(32/s.bits),m=Math.floor(f/8);return`
    ...
    `,u=tY("x",r.dataType,r.dims.length),[l,d,p,c,h]=a1(s,n);return l.push(...tG(r.dims,s)),{name:e,shaderCache:{hint:`${a.cacheKey};${p};${c};${h}`,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:s,dataType:r.dataType}],dispatchGroup:{x:Math.ceil(tc.size(s)/64)},programUniforms:l}),getShaderSource:e=>a2(e,u,r.dims.length,s.length,n,o,"",10===r.dataType?-65504:-1e5,d,p,c,h)}},nr=(e,r)=>{aJ(e.inputs),e.compute(nt("MaxPool",e.inputs[0],!1,r))},ni=e=>{let r,i=e.storage_order,a=e.dilations,n=a4(e);if(0!==i)throw Error("column major storage order is not yet supported for MaxPool");if(0!==n.ceilMode)throw Error("using ceil() in shape computation is not yet supported for MaxPool");let s={storageOrder:i,dilations:a,...n,cacheKey:""};return{...s,cacheKey:(r=s,`${a3(r)};${r.storageOrder};${r.dilations}`)}},na=e=>{let r=e.format;return{format:r,...a9,cacheKey:r}},nn=(e,r)=>{aJ(e.inputs),e.compute(nt("GlobalMaxPool",e.inputs[0],!0,r))}}),sx=es(()=>{nR(),nB(),nW(),nV(),ns=(e,r)=>{var i,a;let n,s,o,u,l,d,p,c,h,f,m,g,y,_,b,$,v,w,x,S,k,T,I;((e,r)=>{if(e.length<2||e.length>3)throw Error("DequantizeLinear requires 2 or 3 inputs.");if(3===e.length&&e[1].dims===e[2].dims)throw Error("x-scale and x-zero-point must have the same shape.");if(3===e.length&&e[0].dataType!==e[2].dataType)throw Error("x and x-zero-point must have the same data type.");if(0!==e[1].dims.length&&1!==e[1].dims.length&&e[1].dims.length!==e[0].dims.length)throw Error("scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.");if(e.length>2){if(e[0].dataType!==e[2].dataType)throw Error("x and x-zero-point must have the same data type.");if(e[1].dims.length!==e[2].dims.length)throw Error("scale and zero-point inputs must have the same rank.");if(!e[1].dims.map((r,i)=>r===e[2].dims[i]).reduce((e,r)=>e&&r,!0))throw Error("scale and zero-point inputs must have the same shape.")}if(r.blockSize>0){if(0===e[1].dims.length||1===e[1].dims.length&&1===e[1].dims[0])throw Error("blockSize must be set only for block quantization.");if(!e[1].dims.map((i,a)=>a===r.axis||i===e[0].dims[a]).reduce((e,r)=>e&&r,!0))throw Error("For block qunatization, scale input shape to match the input shape except for the axis");if(e[1].dims.length!==e[0].dims.length)throw Error("For block qunatization the scale input rank must be the same as the x rank.");let i=e[0].dims[r.axis],a=e[1].dims[r.axis];if(r.blockSize<Math.ceil(i/a)||r.blockSize>Math.ceil(i/(a-1)-1))throw Error("blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].")}})(e.inputs,r),e.compute((i=e.inputs,a=r,n=tc.normalizeAxis(a.axis,i[0].dims.length),o=3===(s=i[0].dataType),u=i[0].dims,l=i[1].dataType,d=tc.size(u),c=(p=3===s||2===s)?[Math.ceil(tc.size(i[0].dims)/4)]:i[0].dims,h=i[1].dims,m=(f=i.length>2?i[2]:void 0)?p?[Math.ceil(tc.size(f.dims)/4)]:f.dims:void 0,y=!1==(g=0===h.length||1===h.length&&1===h[0])&&1===h.length,_=tH(d),$=(b=g&&(!p||4===_))?_:1,v=tY("input",p?12:s,c.length,b&&!p?_:1),w=tY("scale",l,h.length),x=f?tY("zero_point",p?12:s,m.length):void 0,S=tJ("output",l,u.length,$),k=[v,w],x&&k.push(x),T=[c,h],f&&T.push(m),I=[{type:12,data:d/$},{type:12,data:n},{type:12,data:a.blockSize},...tG(...T,u)],{name:"DequantizeLinear",shaderCache:{hint:a.cacheKey,inputDependencies:x?["rank","rank","rank"]:["rank","rank"]},getShaderSource:e=>`
      ...
      }`,getRunData:()=>({outputs:[{dims:u,dataType:l}],dispatchGroup:{x:Math.ceil(d/$/64),y:1,z:1},programUniforms:I})}))},no=e=>tL({axis:e.axis,blockSize:e.blockSize})}),sS=es(()=>{eI(),nR(),nV(),nu=e=>{var r,i,a,n;let s,o,u,l=0,d=0,p=0;6===e.inputs[0].dataType?(l=e.inputs[0].getInt32Array()[0],d=e.inputs[1].getInt32Array()[0],p=e.inputs[2].getInt32Array()[0]):1===e.inputs[0].dataType&&(l=e.inputs[0].getFloat32Array()[0],d=e.inputs[1].getFloat32Array()[0],p=e.inputs[2].getFloat32Array()[0]),z.webgpu.validateInputContent&&((e,r,i)=>{if(e===r||e<r&&i<0||e>r&&i>0)throw Error("Range these inputs' contents are invalid.")})(l,d,p),e.compute((r=l,i=d,a=p,n=e.inputs[0].dataType,o=[s=Math.abs(Math.ceil((i-r)/a))],u=[{type:12,data:s},{type:n,data:r},{type:n,data:a},...tG(o)],{name:"Range",shaderCache:{hint:`${n}`},getShaderSource:e=>{let r=tJ("output",n,o.length),i=r.type.value;return`
  ...
  for (var i = 0u; i < uniforms.num_updates_elements; i++) {
    ...
    ${((e,r,i,a)=>{if("none"!==e&&"i32"!==a&&"u32"!==a&&"f32"!==a)throw Error(`Input ${a} is not supported with reduction ${e}.`);let n=`{
      ...
      }`}}),{inputs:[e.inputs[1],e.inputs[2]],outputs:[]})}}),sT=es(()=>{nR(),nB(),nW(),nV(),np=(e,r,i,a)=>`
