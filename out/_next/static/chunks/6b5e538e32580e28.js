...
`)}get variablesInfo(){if(0!==this.uniforms.length)return this.uniforms.map(e=>[[12,10,1,6][["u32","f16","f32","i32"].indexOf(e.type)],e.length??1])}},t4=(e,r)=>new t3(e,r)}),nG=eo(()=>{nR(),nD(),nV(),nj(),t6=(e,r)=>0!==r.length?r:[...Array(e).keys()].reverse(),t8=(e,r)=>{let i,a,n=e.dataType,s=e.dims.length,o=t6(s,r),u=(i=e.dims,a=o,th.sortBasedOnPerm(i,t6(i.length,a))),l=e.dims,d=u;if(s<2||((e,r)=>{let i=0;for(let a=0;a<e.length;++a)if(1!==r[e[a]]){if(e[a]<i)return!1;i=e[a]}return!0})(o,e.dims))return{name:"TransposeCopy",shaderCache:{inputDependencies:["type"]},getRunData:()=>{let r=th.size(u);return{outputs:[{dims:u,dataType:e.dataType}],dispatchGroup:{x:Math.ceil(r/64/4)},programUniforms:[{type:12,data:Math.ceil(r/4)}]}},getShaderSource:e=>{let r=tJ("input",n,l,4),i=t0("output",n,d,4);return`
  ${e.registerUniform("output_size","u32").declareVariables(r,i)}
  ${e.mainStart()}
    ${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
    output[global_idx] = input[global_idx];
  }`}};let{newShape:p,newPerm:c}=((e,r)=>{let i=[],a=[];for(let n=0;n<e.length;++n)1!==e[n]&&i.push(e[n]),1!==e[r[n]]&&a.push(r[n]);return{newShape:i,newPerm:a}})(e.dims,o),h=th.areEqual(c,[2,3,1]),f=th.areEqual(c,[3,1,2]);return 2===p.length||h||f?(d=[(l=h?[p[0],p[1]*p[2]]:f?[p[0]*p[1],p[2]]:p)[1],l[0]],{name:"TransposeShared",shaderCache:{inputDependencies:["type"]},getRunData:()=>{let r=th.size(u);return{outputs:[{dims:u,dataType:e.dataType}],dispatchGroup:{x:Math.ceil(d[1]/16),y:Math.ceil(d[0]/16)},programUniforms:[{type:12,data:r},...tF(l,d)]}},getShaderSource:e=>{let r=tJ("a",n,l.length),i=t0("output",n,d.length);return`
  ${e.registerUniform("output_size","u32").declareVariables(r,i)}
  ...
  }`}}):{name:"Transpose",shaderCache:{hint:`${r}`,inputDependencies:["rank"]},getRunData:()=>{let r=th.size(u);return{outputs:[{dims:u,dataType:e.dataType}],dispatchGroup:{x:Math.ceil(r/64)},programUniforms:[{type:12,data:r},...tF(l,d)]}},getShaderSource:e=>{let r=tJ("a",n,l.length),i=t0("output",n,d.length);return`
  ${e.registerUniform("output_size","u32").declareVariables(r,i)}
    ...
    ${i.setByOffset("global_idx",r.getByIndices("aIndices"))}
  }`}}},t5=(e,r)=>{((e,r)=>{if(!e||1!==e.length)throw Error("Transpose requires 1 input.");if(0!==r.length&&r.length!==e[0].dims.length)throw Error(`perm size ${r.length} does not match input rank ${e[0].dims.length}`)})(e.inputs,r.perm),e.compute(t8(e.inputs[0],r.perm))},t9=e=>tq({perm:e.perm})}),nF=eo(()=>{nR(),nD(),nj(),nH(),nG(),t7={max:"select(bestValue, candidate, candidate > bestValue)",min:"select(bestValue, candidate, candidate < bestValue)",mean:"bestValue + candidate",sum:"bestValue + candidate",prod:"bestValue * candidate",sumSquare:"bestValue + candidate * candidate",logSumExp:"bestValue + exp(candidate)",l1:"bestValue + abs(candidate)",l2:"bestValue + candidate * candidate",logSum:"bestValue + candidate"},re={max:"select(bestValue, candidate, candidate > bestValue)",min:"select(bestValue, candidate, candidate < bestValue)",mean:"bestValue + candidate",sum:"bestValue + candidate",prod:"bestValue * candidate",sumSquare:"bestValue + candidate",logSumExp:"bestValue + candidate",l1:"bestValue + candidate",l2:"bestValue + candidate",logSum:"bestValue + candidate"},rt={max:"_A[offset]",min:"_A[offset]",mean:"0",sum:"0",prod:"1",sumSquare:"0",logSumExp:"0",l1:"0",l2:"0",logSum:"0"},rr={max:"bestValue",min:"bestValue",sum:"bestValue",prod:"bestValue",sumSquare:"bestValue",logSumExp:"log(bestValue)",l1:"bestValue",l2:"sqrt(bestValue)",logSum:"log(bestValue)"},ri=(e,r,i,a)=>{var n,s,o,u,l,d,p;let c,h,f,m,g,y,_,b=1===e.inputs.length?i:ry(e.inputs,i),$=b.axes;0!==$.length||b.noopWithEmptyAxes||($=e.inputs[0].dims.map((e,r)=>r));let v=th.normalizeAxes($,e.inputs[0].dims.length),w=v,x=e.inputs[0],S=((e,r)=>{let i=[];if(!((e,r)=>{for(let i=0;i<e.length;++i)if(e[e.length-i-1]!==r-1-i)return!1;return!0})(e,r)){for(let a=0;a<r;++a)-1===e.indexOf(a)&&i.push(a);e.forEach(e=>i.push(e))}return i})(w,e.inputs[0].dims.length);S.length>0&&(x=e.compute(t8(e.inputs[0],S),{inputs:[0],outputs:[-1]})[0],w=((e,r)=>{let i=[];for(let a=r-e;a<r;++a)i.push(a);return i})(w.length,x.dims.length));let[k,T]=((e,r)=>{let i=[],a=e.length;for(let n=0;n<a;n++)-1===r.indexOf(n)&&i.push(e[n]);return[i,r.map(r=>e[r])]})(x.dims,w),I=k;b.keepDims&&(I=((e,r)=>{let i=e.length+r.length,a=[],n=0;for(let s=0;s<i;s++)-1===r.indexOf(s)?a.push(e[n++]):a.push(1);return a})(k,v)),e.compute((n=r,s=b.cacheKey,o=[x],u=a,l=e.inputs[0].dataType,d=I,p=T,c=o[0].dims,h=th.size(d),f=th.size(p),m=tJ("_A",o[0].dataType,c),g=t0("output",l,d),y=64,1===h&&(y=256),_=`
       ...
       `,{name:n,shaderCache:{hint:`${s};${y}`,inputDependencies:["type"]},getShaderSource:e=>`
        ...
        fn DIV_CEIL(a : u32, b : u32) -> u32 {
         ...
         if (local_idx == 0u) {
          ${g.setByOffset("outputIndex",`${"mean"===u?`${g.type.storage}(bestValue / f32(uniforms.reduceSize))`:`${g.type.storage}(${rr[u]})`}`)};
         }
        }`,getRunData:()=>({outputs:[{dims:d,dataType:l}],dispatchGroup:{x:h},programUniforms:[{type:12,data:f}]})}),{inputs:[x]})},ra=(e,r)=>{ri(e,"ReduceMeanShared",r,"mean")},rn=(e,r)=>{ri(e,"ReduceL1Shared",r,"l1")},rs=(e,r)=>{ri(e,"ReduceL2Shared",r,"l2")},ro=(e,r)=>{ri(e,"ReduceLogSumExpShared",r,"logSumExp")},ru=(e,r)=>{ri(e,"ReduceMaxShared",r,"max")},rl=(e,r)=>{ri(e,"ReduceMinShared",r,"min")},rd=(e,r)=>{ri(e,"ReduceProdShared",r,"prod")},rp=(e,r)=>{ri(e,"ReduceSumShared",r,"sum")},rc=(e,r)=>{ri(e,"ReduceSumSquareShared",r,"sumSquare")},rh=(e,r)=>{ri(e,"ReduceLogSumShared",r,"logSum")}}),nH=eo(()=>{nR(),nD(),nV(),nj(),nF(),rf=e=>{if(!e||0===e.length||e.length>2)throw Error("Reduce op requires 1 or 2 inputs.");if(2===e.length&&1!==e[1].dims.length)throw Error("Invalid axes input dims.")},rm=e=>["","",`var value = ${e.getByIndices("input_indices")};`,""],rg=(e,r,i,a,n,s,o=!1,u=!1)=>{let l=[],d=i[0].dims,p=d.length,c=th.normalizeAxes(n,p),h=!u&&0===c.length;d.forEach((e,r)=>{h||c.indexOf(r)>=0?o&&l.push(1):l.push(e)});let f=l.length,m=th.size(l);return{name:e,shaderCache:r,getShaderSource:e=>{let r=[],n=tJ("_A",i[0].dataType,p),u=t0("output",s,f),l=a(n,u,c),m=l[2];for(let e=0,i=0;e<p;e++)h||c.indexOf(e)>=0?(o&&i++,m=`for(var j${e}: u32 = 0; j${e} < ${d[e]}; j${e}++) {
...
`)}
        }`},getRunData:()=>({outputs:[{dims:l,dataType:s}],dispatchGroup:{x:Math.ceil(m/64)},programUniforms:[{type:12,data:m},...tF(d,l)]})}},ry=(e,r)=>{let i=[];return e[1].dims[0]>0&&e[1].getBigInt64Array().forEach(e=>i.push(Number(e))),tq({axes:i,keepDims:r.keepDims,noopWithEmptyAxes:r.noopWithEmptyAxes})},r_=(e,r,i,a)=>{let n=e.inputs,s=1===n.length?i:ry(n,i);e.compute(rg(r,{hint:s.cacheKey,inputDependencies:["rank"]},[n[0]],s.noopWithEmptyAxes&&0===s.axes.length?rm:a,s.axes,n[0].dataType,s.keepDims,s.noopWithEmptyAxes),{inputs:[0]})},rb=(e,r,i)=>{if(0===r.length)return i;let a=1,n=1;for(let i=0;i<r.length;i++)-1===r.indexOf(i)?a*=e[i]:n*=e[i];return n<32&&a>1024},r$=(e,r)=>{var i,a;rb(e.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?(i=e,a=r,rf(i.inputs),r_(i,"ReduceMean",a,(e,r,a)=>{let n=1;for(let r=0;r<e.rank;r++)(a.indexOf(r)>=0||0===a.length)&&(n*=i.inputs[0].dims[r]);return["var sum = f32(0);","",`sum += f32(${e.getByIndices("input_indices")});`,`let value = ${r.type.value}(sum / ${n});`]})):ra(e,r)},rv=(e,r)=>{var i,a;rb(e.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?(i=e,a=r,rf(i.inputs),r_(i,"ReduceL1",a,(e,r)=>[`var value = ${r.type.storage}(0);`,"",`value += abs(${e.getByIndices("input_indices")});`,""])):rn(e,r)},rw=(e,r)=>{var i,a;rb(e.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?(i=e,a=r,rf(i.inputs),r_(i,"ReduceL2",a,(e,r)=>[`var t = ${r.type.value}(0); var value = ${r.type.value}(0);`,"",`t = ${e.getByIndices("input_indices")}; value += (t * t);`,"value = sqrt(value);"])):rs(e,r)},rx=(e,r)=>{var i,a;rb(e.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?(i=e,a=r,rf(i.inputs),r_(i,"ReduceLogSumExp",a,(e,r)=>[`var value = ${r.type.storage}(0);`,"",`value += exp(${e.getByIndices("input_indices")});`,"value = log(value);"])):ro(e,r)},rS=(e,r)=>{var i,a;rb(e.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?(i=e,a=r,rf(i.inputs),r_(i,"ReduceMax",a,(e,r,i)=>{let a=[];for(let r=0;r<e.rank;r++)(i.indexOf(r)>=0||0===i.length)&&a.push(e.indicesSet("input_indices",r,0));return[`${a.join(`
`)}`,`var value = ${e.getByIndices("input_indices")};`,`value = max(value, ${e.getByIndices("input_indices")});`,""]})):ru(e,r)},rk=(e,r)=>{var i,a;rb(e.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?(i=e,a=r,rf(i.inputs),r_(i,"ReduceMin",a,(e,r,i)=>{let a=[];for(let r=0;r<e.rank;r++)(i.indexOf(r)>=0||0===i.length)&&a.push(`input_indices[${r}] = 0;`);return[`${a.join(`
`)}`,`var value = ${e.getByIndices("input_indices")};`,`value = min(value, ${e.getByIndices("input_indices")});`,""]})):rl(e,r)},rT=(e,r)=>{var i,a;rb(e.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?(i=e,a=r,rf(i.inputs),r_(i,"ReduceProd",a,(e,r)=>[`var value = ${r.type.storage}(1);`,"",`value *= ${e.getByIndices("input_indices")};`,""])):rd(e,r)},rI=(e,r)=>{var i,a;rb(e.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?(i=e,a=r,rf(i.inputs),r_(i,"ReduceSum",a,(e,r)=>[`var value = ${r.type.storage}(0);`,"",`value += ${e.getByIndices("input_indices")};`,""])):rp(e,r)},rC=(e,r)=>{var i,a;rb(e.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?(i=e,a=r,rf(i.inputs),r_(i,"ReduceSumSquare",a,(e,r)=>[`var t = ${r.type.value}(0); var value = ${r.type.value}(0);`,"",`t = ${e.getByIndices("input_indices")}; value += t * t;`,""])):rc(e,r)},rE=(e,r)=>{var i,a;rb(e.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?(i=e,a=r,rf(i.inputs),r_(i,"ReduceLogSum",a,(e,r)=>[`var value = ${r.type.storage}(0);`,"",`value += ${e.getByIndices("input_indices")};`,"value = log(value);"])):rh(e,r)}}),nK=eo(()=>{nR(),nV(),nH(),rz=e=>{if(!e||0===e.length||e.length>2)throw Error("ArgMinMaxOp op requires 1 or 2 inputs.");if(1!==e[0].dataType)throw Error("Invalid input type.")},rA=(e,r)=>{rz(e.inputs),e.compute(rg("ArgMin",{hint:r.cacheKey,inputDependencies:["rank"]},[e.inputs[0]],(e,i,a)=>{let n=[];for(let r=0;r<e.rank;r++)(a.indexOf(r)>=0||0===a.length)&&n.push(`input_indices[${r}] = 0;`);return[`${n.join(`
`)}`,`var value = ${e.getByIndices("input_indices")};
var best_index : i32 = 0;`,`if (${e.getByIndices("input_indices")} ${r.selectLastIndex>0?"<=":"<"} value) {
         value = ${e.getByIndices("input_indices")};
         best_index = i32(last_index);
       }`,"",i.setByOffset("global_idx","best_index")]},[r.axis],7,r.keepDims),{inputs:[0]})},rO=(e,r)=>{rz(e.inputs),e.compute(rg("argMax",{hint:r.cacheKey,inputDependencies:["rank"]},[e.inputs[0]],(e,i,a)=>{let n=[];for(let r=0;r<e.rank;r++)(a.indexOf(r)>=0||0===a.length)&&n.push(`input_indices[${r}] = 0;`);return[`${n.join(`
`)}`,`var value = ${e.getByIndices("input_indices")};
var best_index : i32 = 0;`,`if (${e.getByIndices("input_indices")} ${r.selectLastIndex>0?">=":">"} value) {
         value = ${e.getByIndices("input_indices")};
         best_index = i32(last_index);
       }`,"",i.setByOffset("global_idx","best_index")]},[r.axis],7,r.keepDims),{inputs:[0]})},rM=e=>tq(e)}),nZ=eo(()=>{nR(),nD(),nq(),nj(),rR=(e,r,i)=>r&&e?`
    ...
    `,rN=(e,r,i,a,n,s,o,u,l,d,p,c)=>{var h,f,m,g,y,_,b,$,v,w,x,S,k,T,I,C,E,z,A,O,M,R,N,B,D;let U,P,L,q,W,V,j,G,F,H,K,Z,X,Q,Y,J,ee,et,er,ei,ea,en,es,eo,eu,el,ed,ep,ec,eh,ef,em,eg,ey=Math.min(e.outputCount,1+ +!!o+ +!!u),e_=ey>1?o:void 0,eb=ey>1?u:void 0,e$=ey>1?d.pastSequenceLength:0,ev=e$+d.kvSequenceLength,ew=l&&th.size(l.dims)>0?l:void 0,ex=[r,i];e_&&th.size(e_.dims)>0&&ex.push(e_),ew&&ex.push(ew),p&&ex.push(p),c&&ex.push(c);let eS=e.compute((h=ey,f=r,m=i,g=e_,y=ew,_=d,b=e$,$=p,v=c,U=b+_.kvSequenceLength,P=[_.batchSize,_.numHeads,_.sequenceLength,U],L=h>1&&g,q=_.kvNumHeads?_.kvNumHeads:_.numHeads,W=L?[_.batchSize,q,U,_.headSize]:void 0,V=_.nReps?_.nReps:1,j=0===_.scale?1/Math.sqrt(_.headSize):_.scale,G=tH(_.headSize),F=_.headSize/G,H={x:Math.ceil(U/12),y:Math.ceil(_.sequenceLength/12),z:_.batchSize*_.numHeads},K=[{type:12,data:_.sequenceLength},{type:12,data:F},{type:12,data:U},{type:12,data:_.numHeads},{type:12,data:_.headSize},{type:1,data:j},{type:12,data:b},{type:12,data:_.kvSequenceLength},{type:12,data:V}],Z=L&&g&&th.size(g.dims)>0,X=["type","type"],Z&&X.push("type"),y&&X.push("type"),$&&X.push("type"),v&&X.push("type"),Q=[{dims:P,dataType:f.dataType,gpuDataType:0}],L&&Q.push({dims:W,dataType:f.dataType,gpuDataType:0}),{name:"AttentionProbs",shaderCache:{hint:`${G};${void 0!==y};${void 0!==g};${h}`,inputDependencies:X},getRunData:()=>({outputs:Q,dispatchGroup:H,programUniforms:K}),getShaderSource:e=>{let r=tJ("q",f.dataType,f.dims,G),i=[r,tJ("key",m.dataType,m.dims,G)];if(Z){let e=tJ("past_key",g.dataType,g.dims,G);i.push(e)}y&&i.push(tJ("attention_bias",y.dataType,y.dims));let a=$?tJ("seq_lens",$.dataType,$.dims):void 0;a&&i.push(a);let n=v?tJ("total_sequence_length_input",v.dataType,v.dims):void 0;n&&i.push(n);let s=t0("output",f.dataType,P),o=[s];L&&o.push(t0("present_key",f.dataType,W,G));let u=tG(1,G);return`
  const TILE_SIZE = 12u;
  ...
  }`}}),{inputs:ex,outputs:ey>1?[-1,1]:[-1]})[0];e.compute((w=eS,x=d.batchSize,S=d.numHeads,k=e$,T=d.sequenceLength,I=ev,C=p,E=c,Y=tH(C?1:I),J=64,(ee=I/Y)<64&&(J=32),et=[{type:12,data:x},{type:12,data:S},{type:12,data:k},{type:12,data:T},{type:12,data:ee},{type:12,data:Math.ceil(I/Y/J)}],er=tj(w.dataType,Y),ei=tG(1,Y),ea=["type"],C&&ea.push("type"),E&&ea.push("type"),{name:"AttentionProbsSoftmax",shaderCache:{hint:`${J};${er};${Y}`,inputDependencies:ea},getShaderSource:e=>{let r=t0("x",w.dataType,w.dims,Y),i=[r],a=C?tJ("seq_lens",C.dataType,C.dims):void 0;a&&i.push(a);let n=E?tJ("total_sequence_length_input",E.dataType,E.dims):void 0;n&&i.push(n);let s=tG(w.dataType);return`
  ...
  }`},getRunData:()=>({outputs:[],dispatchGroup:{x:1,y:T,z:x*S},programUniforms:et})}),{inputs:p&&c?[eS,p,c]:[eS],outputs:[]});let ek=[eS,a];eb&&th.size(eb.dims)>0&&ek.push(eb),p&&ek.push(p),c&&ek.push(c),e.compute((z=ey,A=eS,O=a,M=eb,R=d,N=e$,B=p,D=c,en=N+R.kvSequenceLength,es=R.nReps?R.nReps:1,eo=R.vHiddenSize*es,eu=z>1&&M,el=R.kvNumHeads?R.kvNumHeads:R.numHeads,ed=eu?[R.batchSize,el,en,R.headSize]:void 0,ep=[R.batchSize,R.sequenceLength,eo],ec={x:Math.ceil(R.vHeadSize/12),y:Math.ceil(R.sequenceLength/12),z:R.batchSize*R.numHeads},eh=[{type:12,data:R.sequenceLength},{type:12,data:en},{type:12,data:R.vHeadSize},{type:12,data:R.numHeads},{type:12,data:R.headSize},{type:12,data:eo},{type:12,data:N},{type:12,data:R.kvSequenceLength},{type:12,data:es}],ef=eu&&M&&th.size(M.dims)>0,em=["type","type"],ef&&em.push("type"),B&&em.push("type"),D&&em.push("type"),eg=[{dims:ep,dataType:A.dataType,gpuDataType:0}],eu&&eg.push({dims:ed,dataType:A.dataType,gpuDataType:0}),{name:"AttentionScore",shaderCache:{hint:`${void 0!==M};${z}`,inputDependencies:em},getRunData:()=>({outputs:eg,dispatchGroup:ec,programUniforms:eh}),getShaderSource:e=>{let r=tJ("probs",A.dataType,A.dims),i=[r,tJ("v",O.dataType,O.dims)];ef&&i.push(tJ("past_value",M.dataType,M.dims));let a=B?tJ("seq_lens",B.dataType,B.dims):void 0;B&&i.push(a);let n=D?tJ("total_sequence_length_input",D.dataType,D.dims):void 0;D&&i.push(n);let s=[t0("output",A.dataType,ep)];return eu&&s.push(t0("present_value",A.dataType,ed)),`
  const TILE_SIZE = 12u;
  ...
  }`}},{inputs:d,outputs:[-1,-1,-1]}));return rN(e,h,f,m,e.inputs[4],void 0,void 0,void 0,e.inputs[5],c)}}),nX=eo(()=>{eC(),nR(),nD(),nV(),nj(),rD=(e,r)=>{let i,{inputs:a,outputCount:n}=e,s=(i={...r,outputCount:n},tq(i));if(A.webgpu.validateInputContent&&((e,r)=>{if(!e||5!==e.length)throw Error("BatchNormalization requires 5 inputs");let i=(e,r,i)=>{let a=r.length;if(a!==e.length)throw Error(`${i}: num dimensions != ${a}`);r.forEach((r,a)=>{if(r!==e[a])throw Error(`${i}: dim[${a}] do not match`)})};if(e[0].dims.length>1){let a="NHWC"===r.format?r.spatial?e[0].dims.slice(-1):e[0].dims.slice(-1).concat(e[0].dims.slice(1,e[0].dims.length-1)):e[0].dims.slice(1,r.spatial?2:void 0);i(e[1].dims,a,"Invalid input scale"),i(e[2].dims,a,"Invalid input B"),i(e[3].dims,a,"Invalid input mean"),i(e[4].dims,a,"Invalid input var")}else i(e[1].dims,[1],"Invalid input scale"),i(e[2].dims,[1],"Invalid input B"),i(e[3].dims,[1],"Invalid input mean"),i(e[4].dims,[1],"Invalid input var")})(a,s),r.trainingMode)throw Error("BatchNormalization trainingMode is not supported yet.");e.compute(((e,r)=>{let{epsilon:i,spatial:a,format:n}=r,s=e[0].dims,o=a?tH(s[s.length-1]):1,u="NHWC"===n&&s.length>1?o:1,l=th.size(s)/o,d=a?s.length:s,p=tJ("x",e[0].dataType,e[0].dims,o),c=tJ("scale",e[1].dataType,e[1].dims,u),h=tJ("bias",e[2].dataType,e[2].dims,u),f=tJ("inputMean",e[3].dataType,e[3].dims,u),m=tJ("inputVar",e[4].dataType,e[4].dims,u),g=t0("y",e[0].dataType,d,o);return{name:"BatchNormalization",shaderCache:{hint:`${r.epsilon}_${r.format}_${a}_${o}`,inputDependencies:a?["rank","type","type","type","type"]:void 0},getShaderSource:e=>`
  const epsilon = ${i};
  ...
  }`,getRunData:()=>({outputs:[{dims:e[0].dims,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:a?[{type:12,data:l},...tF(s)]:[{type:12,data:l}]})}})(a,s))}}),nQ=eo(()=>{nD(),nj(),rU=e=>{var r;let i,a,n,s,o,u,l,d;(e=>{if(3!==e[0].dims.length)throw Error("input should have 3 dimensions");if(![320,640,1280].includes(e[0].dims[2]))throw Error("number of channels should be 320, 640 or 1280");if(1!==e[1].dims.length)throw Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw Error("last dimension of input and bias are not the same")})(e.inputs),e.compute((i=(r=e.inputs)[0].dims,a=r[0].dims[2],n=th.size(i)/4,s=r[0].dataType,o=tJ("input",s,i,4),u=tJ("bias",s,[a],4),l=tJ("residual",s,i,4),d=t0("output",s,i,4),{name:"BiasAdd",getRunData:()=>({outputs:[{dims:i,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(n/64)}}),getShaderSource:e=>`
  ...
  }`}))}}),nY=eo(()=>{nR(),nD(),nV(),nj(),rP=(e,r,i,a,n,s=e.dataType,o,u)=>{let l=[{type:12,data:Math.ceil(th.size(e.dims)/4)}];return o&&l.push(...o),{name:r,shaderCache:{hint:n,inputDependencies:["type"]},getShaderSource:r=>{var n,o,l,d,p,c,h;let f,m,g,y,_;return n=r,o=th.size(e.dims),l=e.dataType,d=s,p=i,c=a,h=u,f=Math.ceil(o/4),m="",m="string"==typeof p?`${p}(a)`:p("a"),g=tJ("inputData",l,[f],4),y=t0("outputData",d,[f],4),_=[{name:"vec_size",type:"u32"}],h&&_.push(...h),`
  ...
  }`},getRunData:r=>({outputs:[{dims:e.dims,dataType:s}],dispatchGroup:{x:Math.ceil(th.size(r[0].dims)/64/4)},programUniforms:l})}},rL=e=>{e.compute(rP(e.inputs[0],"Abs","abs"))},rq=e=>{e.compute(rP(e.inputs[0],"Acos","acos"))},rW=e=>{e.compute(rP(e.inputs[0],"Acosh","acosh"))},rV=e=>{e.compute(rP(e.inputs[0],"Asin","asin"))},rj=e=>{e.compute(rP(e.inputs[0],"Asinh","asinh"))},rG=e=>{e.compute(rP(e.inputs[0],"Atan","atan"))},rF=e=>{e.compute(rP(e.inputs[0],"Atanh","atanh"))},rH=e=>tq(e),rK=(e,r)=>{let i;switch(r.to){case 10:i="vec4<f16>";break;case 1:i="vec4<f32>";break;case 12:i="vec4<u32>";break;case 6:i="vec4<i32>";break;case 9:i="vec4<bool>";break;default:throw RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${r.to}`)}e.compute(rP(e.inputs[0],"Cast",i,void 0,r.cacheKey,r.to))},rZ=(e,r)=>{let i=r||(e=>{let r,i,a=e.length>=2&&0!==e[1].data,n=e.length>=3&&0!==e[2].data;switch(e[0].dataType){case 1:r=a?e[1].getFloat32Array()[0]:-34028234663852886e22,i=n?e[2].getFloat32Array()[0]:34028234663852886e22;break;case 10:r=a?e[1].getUint16Array()[0]:64511,i=n?e[2].getUint16Array()[0]:31743;break;default:throw Error("Unsupport data type")}return tq({min:r,max:i})})(e.inputs),a=tG(e.inputs[0].dataType);e.compute(rP(e.inputs[0],"Clip",e=>`clamp(${e}, vec4<${a}>(uniforms.min), vec4<${a}>(uniforms.max))`,void 0,i.cacheKey,void 0,[{type:e.inputs[0].dataType,data:i.min},{type:e.inputs[0].dataType,data:i.max}],[{name:"min",type:a},{name:"max",type:a}]),{inputs:[0]})},rX=e=>{e.compute(rP(e.inputs[0],"Ceil","ceil"))},rQ=e=>{e.compute(rP(e.inputs[0],"Cos","cos"))},rY=e=>{e.compute(rP(e.inputs[0],"Cosh","cosh"))},rJ=e=>tq(e),r0=(e,r)=>{let i=tG(e.inputs[0].dataType);e.compute(rP(e.inputs[0],"Elu",e=>`elu_vf32(${e})`,`
...
}`,r2=e=>{let r=tG(e.inputs[0].dataType);e.compute(rP(e.inputs[0],"Erf",e=>`erf_vf32(${e})`,r1(r)))},r3=e=>{e.compute(rP(e.inputs[0],"Exp","exp"))},r4=e=>{e.compute(rP(e.inputs[0],"Floor","floor"))},r6=e=>{let r=tG(e.inputs[0].dataType);e.compute(rP(e.inputs[0],"Gelu",e=>`0.5 * ${e} * (1.0 + erf_vf32(${e} * 0.7071067811865475))`,r1(r)))},r8=(e,r)=>{let i=tG(e.inputs[0].dataType);e.compute(rP(e.inputs[0],"LeakyRelu",e=>`select(leaky_relu_alpha_ * ${e}, ${e}, ${e} >= vec4<${i}>(0.0))`,`const leaky_relu_alpha_ = ${i}(${r.alpha});`,r.cacheKey))},r5=e=>{e.compute(rP(e.inputs[0],"Not",e=>`!${e}`))},r9=e=>{e.compute(rP(e.inputs[0],"Neg",e=>`-${e}`))},r7=e=>{e.compute(rP(e.inputs[0],"Reciprocal",e=>`1.0/${e}`))},ie=e=>{let r=tG(e.inputs[0].dataType);e.compute(rP(e.inputs[0],"Relu",e=>`select(vec4<${r}>(0.0), ${e}, ${e} > vec4<${r}>(0.0))`))},it=e=>{e.compute(rP(e.inputs[0],"Sigmoid",e=>`(1.0 / (1.0 + exp(-${e})))`))},ir=e=>tq(e),ii=(e,r)=>{let i=tG(e.inputs[0].dataType);e.compute(rP(e.inputs[0],"HardSigmoid",e=>`max(vec4<${i}>(0.0), min(vec4<${i}>(1.0), ${r.alpha} * ${e} + vec4<${i}>(${r.beta})))`,void 0,r.cacheKey))},ia=e=>{e.compute(rP(e.inputs[0],"Sin","sin"))},is=e=>{e.compute(rP(e.inputs[0],"Sinh","sinh"))},io=e=>{e.compute(rP(e.inputs[0],"Sqrt","sqrt"))},iu=e=>{e.compute(rP(e.inputs[0],"Tan","tan"))},il=e=>`sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`,id=e=>{e.compute(rP(e.inputs[0],"Tanh",il))},ip=(e="f32")=>`
...
`,ic=e=>`(fast_gelu_a + fast_gelu_a * tanh_v(${e} * (fast_gelu_c * ${e} * ${e} + fast_gelu_b))) * ${e}`,ih=e=>{let r=tG(e.inputs[0].dataType);e.compute(rP(e.inputs[0],"FastGelu",ic,ip(r),void 0,e.inputs[0].dataType))},im=(e,r)=>{let i=tG(e.inputs[0].dataType);return e.compute(rP(e.inputs[0],"ThresholdedRelu",e=>`select(vec4<${i}>(0.0), ${e}, ${e} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${i}>(${r.alpha});`,r.cacheKey)),0},ig=e=>{e.compute(rP(e.inputs[0],"Log","log"))},iy=e=>`quick_gelu_impl(${e})`,i_=(e,r)=>{let i,a,n=tG(e.inputs[0].dataType);e.compute(rP(e.inputs[0],"QuickGelu",iy,(i=n,a=r.alpha,`
...
`),r.cacheKey,e.inputs[0].dataType))}}),nJ=eo(()=>{nD(),nj(),nY(),ib=e=>{var r;let i,a,n,s,o,u;(e=>{if(3!==e[0].dims.length)throw Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw Error("hidden state should be 2560, 5120 or 10240");if(1!==e[1].dims.length)throw Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw Error("last dimension of input and bias are not the same")})(e.inputs),e.compute(((i=(r=e.inputs)[0].dims.slice())[2]=i[2]/2,a=tJ("input",r[0].dataType,r[0].dims,4),n=tJ("bias",r[0].dataType,[r[0].dims[2]],4),s=t0("output",r[0].dataType,i,4),o=th.size(i)/4,u=tj(r[0].dataType),{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:i,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(o/64)}}),getShaderSource:e=>`
  ...
  ${e.mainStart()}
    ...
    ${s.setByOffset("global_idx","valueLeft * geluRight")}
  }`}))}}),n0=eo(()=>{nR(),nD(),nj(),i$=(e,r,i,a,n,s)=>{e.compute(((e,r,i,a,n,s,o=i.dataType)=>{let u=i.dims.map(Number),l=a.dims.map(Number),d=!th.areEqual(u,l),p=u,c=th.size(u),h=!1,f=!1,m=[d];if(d){let e=tc.calcShape(u,l,!1);if(!e)throw Error("Can't perform binary op on the given tensors");p=e.slice(),c=th.size(p);let r=1===th.size(u),i=1===th.size(l),a=u.length>0&&u[u.length-1]%4==0,n=l.length>0&&l[l.length-1]%4==0;m.push(r),m.push(i),m.push(a),m.push(n);let s=1;for(let e=1;e<p.length;e++){let r=u[u.length-e];if(r===l[l.length-e])s*=r;else break}s%4==0?(f=!0,h=!0):(r||i||a||n)&&(h=!0)}else h=!0;return m.push(h),{name:e,shaderCache:{hint:r+m.map(e=>e.toString()).join("_"),inputDependencies:["rank","rank"]},getShaderSource:e=>((e,r,i,a,n,s,o,u,l,d,p,c)=>{let h,f;"string"==typeof u?h=f=(e,r)=>`${u}((${e}),(${r}))`:"function"==typeof u?h=f=u:(h=u.scalar,f=u.vector);let m=t0("outputData",p,a.length,4),g=tJ("aData",l,r.length,4),y=tJ("bData",d,i.length,4),_;if(n)if(s){let e=1===th.size(r),a=1===th.size(i),n=r.length>0&&r[r.length-1]%4==0,s=i.length>0&&i[i.length-1]%4==0;_=e||a?m.setByOffset("global_idx",f(e?`${g.type.value}(${g.getByOffset("0")}.x)`:g.getByOffset("global_idx"),a?`${y.type.value}(${y.getByOffset("0")}.x)`:y.getByOffset("global_idx"))):`
        ...
        ${_}
      }`})(e,u,l,p,h,d,f,n,i.dataType,a.dataType,o,s),getRunData:()=>({outputs:[{dims:p,dataType:o}],dispatchGroup:{x:Math.ceil(c/64/4)},programUniforms:[{type:12,data:Math.ceil(th.size(p)/4)},...tF(u,l,p)]})}})(r,n??"",e.inputs[0],e.inputs[1],i,a,s))},iv=e=>{i$(e,"Add",(e,r)=>`${e}+${r}`)},iw=e=>{i$(e,"Div",(e,r)=>`${e}/${r}`)},ix=e=>{i$(e,"Equal",{scalar:(e,r)=>`u32(${e}==${r})`,vector:(e,r)=>`vec4<u32>(${e}==${r})`},void 0,void 0,9)},iS=e=>{i$(e,"Mul",(e,r)=>`${e}*${r}`)},ik=e=>{let r=tJ("input",e.inputs[0].dataType,e.inputs[0].dims).type.value;i$(e,"Pow",{scalar:(e,r)=>`pow_custom(${e},${r})`,vector:(e,r)=>`pow_vector_custom(${e},${r})`},`
    ...
    fn pow_vector_custom(a : vec4<${r}>, b : vec4<${r}>) -> vec4<${r}> {
      ...
      `)},iT=e=>{i$(e,"Sub",(e,r)=>`${e}-${r}`)},iI=e=>{i$(e,"Greater",{scalar:(e,r)=>`u32(${e}>${r})`,vector:(e,r)=>`vec4<u32>(${e}>${r})`},void 0,void 0,9)},iC=e=>{i$(e,"Less",{scalar:(e,r)=>`u32(${e}<${r})`,vector:(e,r)=>`vec4<u32>(${e}<${r})`},void 0,void 0,9)},iE=e=>{i$(e,"GreaterOrEqual",{scalar:(e,r)=>`u32(${e}>=${r})`,vector:(e,r)=>`vec4<u32>(${e}>=${r})`},void 0,void 0,9)},iz=e=>{i$(e,"LessOrEqual",{scalar:(e,r)=>`u32(${e}<=${r})`,vector:(e,r)=>`vec4<u32>(${e}<=${r})`},void 0,void 0,9)}}),n1=eo(()=>{nR(),nD(),nV(),nj(),iA=(e,r)=>{let i=e.inputs,a=i[0].dims,n=th.normalizeAxis(r.axis,a.length);var s=i,o=n;if(!s||s.length<1)throw Error("too few inputs");let u=s[0],l=u.dataType,d=u.dims.length;s.forEach((e,r)=>{if(0!==r){if(e.dataType!==l)throw Error("input tensors should be one type");if(e.dims.length!==d)throw Error("input tensors should have the same shape");e.dims.forEach((e,r)=>{if(r!==o&&e!==u.dims[r])throw Error("non concat dimensions must match")})}});let p=a.slice();p[n]=i.reduce((e,r)=>e+(r.dims.length>n?r.dims[n]:0),0);let c=i.filter(e=>th.size(e.dims)>0);e.compute(((e,r,i,a)=>{let n=th.size(i),s=Array(e.length),o=Array(e.length),u=0,l=[],d=[],p=[{type:12,data:n}];for(let i=0;i<e.length;++i)u+=e[i].dims[r],s[i]=u,d.push(e[i].dims.length),o[i]=tJ(`input${i}`,a,d[i]),l.push("rank"),p.push({type:12,data:s[i]});for(let r=0;r<e.length;++r)p.push(...tF(e[r].dims));p.push(...tF(i));let c=t0("output",a,i.length),h=c.indicesGet("indices",r),f=Array.from(Array(s.length).keys()).map(e=>`uniforms.sizeInConcatAxis${e}`).join(",");return{name:"Concat",shaderCache:{hint:`${r}`,inputDependencies:l},getRunData:()=>({outputs:[{dims:i,dataType:a}],dispatchGroup:{x:Math.ceil(n/64)},programUniforms:p}),getShaderSource:r=>{let i,a;return`
...
`)})(o,c)}
  }`}}})(c,n,p,i[0].dataType),{inputs:c})},iO=e=>tq({axis:e.axis})}),n2=eo(()=>{nR(),nD(),iM=(e,r,i="f32")=>{switch(e.activation){case"Relu":return`value = max(value, ${r}(0.0));`;case"Sigmoid":return`value = (${r}(1.0) / (${r}(1.0) + exp(-value)));`;case"Clip":return`value = clamp(value, ${r}(${i}(uniforms.clip_min)), ${r}(${i}(uniforms.clip_max)));`;case"HardSigmoid":return`value = max(${r}(0.0), min(${r}(1.0), ${i}(uniforms.alpha) * value + ${i}(uniforms.beta)));`;case"LeakyRelu":return`value = select(${i}(uniforms.alpha) * value, value, value >= ${r}(0.0));`;case"Tanh":return`let e2x = exp(-2.0 * abs(value));
              value = sign(value) * (1.0 - e2x) / (1.0 + e2x);
        `;case"":return"";default:throw Error(`Unsupported activation ${e.activation}`)}},iR=(e,r)=>{"Clip"===e.activation?r.push({type:1,data:e.clipMax},{type:1,data:e.clipMin}):"HardSigmoid"===e.activation?r.push({type:1,data:e.alpha},{type:1,data:e.beta}):"LeakyRelu"===e.activation&&r.push({type:1,data:e.alpha})},iN=(e,r)=>{"Clip"===e.activation?r.push({name:"clip_max",type:"f32"},{name:"clip_min",type:"f32"}):"HardSigmoid"===e.activation?r.push({name:"alpha",type:"f32"},{name:"beta",type:"f32"}):"LeakyRelu"===e.activation&&r.push({name:"alpha",type:"f32"})},iB=e=>{let r=e?.activation||"";if("HardSigmoid"===r){let[i,a]=e?.activation_params||[.2,.5];return{activation:r,alpha:i,beta:a}}if("Clip"===r){let[i,a]=e?.activation_params||[tg,ty];return{activation:r,clipMax:a,clipMin:i}}if("LeakyRelu"===r){let[i]=e?.activation_params||[.01];return{activation:r,alpha:i}}return{activation:r}}}),n3=eo(()=>{iD=(e,r)=>{switch(e){case 1:return r;case 2:return`vec2<${r}>`;case 3:return`vec3<${r}>`;case 4:return`vec4<${r}>`;default:throw Error(`${e}-component is not supported.`)}},iU=e=>`
...
`}),n6=eo(()=>{nR(),nD(),nj(),n2(),iL=(e,r,i,a,n)=>{let s=a-i;return`
      ${Array.from({length:i}).map((i,o)=>`
      if (${tQ(r.shape,o,r.rank)} != 1) {
        ${r.indicesSet(e,o,tQ(n,o+s,a))}
      } else {
        ${r.indicesSet(e,o,0)}
      }`).join("")}
`},iq=(e,r,i,a,n=!1,s)=>{let o=e[0].dims,u=e[1].dims,l=o[o.length-2],d=u[u.length-1],p=o[o.length-1],c=tH(d),h=tH(p),f=tH(l),m=th.size(i)/c/f,g=e.length>2,y=a?a.slice(0,-2):i.slice(0,-2),_=[th.size(y),l,d],b=[{type:12,data:m},{type:12,data:l},{type:12,data:d},{type:12,data:p}];return iR(r,b),b.push(...tF(y,o,u)),g&&b.push(...tF(e[2].dims)),b.push(...tF(_)),{name:"MatMulNaive",shaderCache:{hint:`${r.activation};${c};${h};${f};${n}`,inputDependencies:g?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:s?s(i):i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(m/64)},programUniforms:b}),getShaderSource:a=>{let s=t2("batch_dims",e[0].dataType,y.length),l=tJ("a",e[0].dataType,o.length,h),d=tJ("b",e[1].dataType,u.length,c),p=t0("output",e[0].dataType,_.length,c),m=tj(p.type.tensor),b=iM(r,p.type.value,m),$=[l,d],v="";if(g){let r=n?c:1;$.push(tJ("bias",e[2].dataType,e[2].dims.length,r)),v=`${n?`value += bias[col / ${r}];`:`value += ${p.type.value}(bias[row + i]);`}`}let w=[{name:"output_size",type:"u32"},{name:"M",type:"u32"},{name:"N",type:"u32"},{name:"K",type:"u32"}];return iN(r,w),`
...
`}return e})()}
  ...
  `}}}}),n8=eo(()=>{nR(),nD(),nj(),n2(),n6(),n3(),iW=(e,r,i="f32",a,n=!1,s=32,o=!1,u=32)=>{let l,d,p,c,h=r[1]*e[1],f=r[0]*e[0],m=n?h:s,g=n?s:h,y=m/r[0],_=s/r[1];if(!((n&&4===y&&4===e[1]||!n&&(3===y||4===y))&&m%r[0]==0&&s%r[1]==0&&4===e[0]))throw Error(`If transposeA ${n} is true, innerElementSize ${y} and workPerThread[1] ${e[1]} must be 4.
...
fn main(@builtin(local_invocation_id) localId : vec3<u32>,
  ...
  for (var innerRow = 0; innerRow < rowPerThread; innerRow = innerRow + 1) {
      mm_write(batch, globalRow + innerRow, globalCol, acc[innerRow]);
            ...
            `,ij=(e,r,i="f32",a,n=!1,s=32,o=!1,u=32,l=!1)=>{let d=e[1]*r[1],p=e[0]*r[0],c=n?d:s,h=n?s:d;if(h%r[1]!=0||c%r[0]!=0||s%r[1]!=0)throw Error(`tileAHight ${h} must be divisible by workgroupSize[1]${r[1]}, tileAWidth ${c} must be divisible by workgroupSize[0]${r[0]}, tileInner ${s} must be divisible by workgroupSize[1]${r[1]}`);let f=h/r[1],m=c/r[0],g=s/r[1],y=l?`
    let localRow = i32(localId.y);
...
`},iG=(e,r,i,a,n=!1,s)=>{let o=e[0].dims,u=e[1].dims,l=o.slice(0,-2),d=u.slice(0,-2),p=a?a.slice(0,-2):i.slice(0,-2),c=th.size(p),h=o[o.length-2],f=o[o.length-1],m=u[u.length-1],g=f%4==0&&m%4==0,y=h<=8?[4,1,1]:[4,4,1],_=[8,8,1],b=[Math.ceil(m/_[0]/y[0]),Math.ceil(h/_[1]/y[1]),Math.ceil(c/_[2]/y[2])],$=g?4:1,v=[...l,h,f/$],w=v.length,x=[...d,f,m/$],S=x.length,k=[c,h,m/$],T=[{type:6,data:h},{type:6,data:m},{type:6,data:f}];iR(r,T),T.push(...tF(p,v,x));let I=["rank","rank"],C=e.length>2;return C&&(T.push(...tF(e[2].dims)),I.push("rank")),T.push(...tF(k)),{name:"MatMul",shaderCache:{hint:`${y};${r.activation};${g};${n}`,inputDependencies:I},getRunData:()=>({outputs:[{dims:s?s(i):i,dataType:e[0].dataType}],dispatchGroup:{x:b[0],y:b[1],z:b[2]},programUniforms:T}),getShaderSource:i=>{let a=p.length,s=t2("batchDims",e[0].dataType,a,1),o=tj(e[0].dataType),u=tJ("a",e[0].dataType,w,$),l=tJ("b",e[1].dataType,S,$),d=t0("result",e[0].dataType,k.length,$),c=[u,l];if(C){let r=n?$:1;c.push(tJ("bias",e[2].dataType,e[2].dims.length,r))}let h=[{name:"dim_a_outer",type:"i32"},{name:"dim_b_outer",type:"i32"},{name:"dim_inner",type:"i32"}];iN(r,h);let f=tj(d.type.tensor),m=((e,r,i,a,n=!1)=>{let[s,o,u,l]=a,d=tj(a[0].type.tensor);return`
    fn mm_readA(batch: i32, row: i32, colIn: i32, batchIndices: ${s.type.indices}) -> ${iD(e,d)} {
      var value = ${iD(e,d)}(0.0);
      let col = colIn * ${e};
      if(row < uniforms.dim_a_outer && col < uniforms.dim_inner)
      {
        var aIndices: ${o.type.indices};
        ${iL("aIndices",o,o.rank-2,s.rank,"batchIndices")}
    ...
    fn mm_readB(batch: i32, row: i32, colIn: i32, batchIndices: ${s.type.indices}) -> ${iD(e,d)} {
      var value = ${iD(e,d)}(0.0);
      let col = colIn * ${e};
      if(row < uniforms.dim_inner && col < uniforms.dim_b_outer)
      {
        var bIndices: ${u.type.indices};
        ${iL("bIndices",u,u.rank-2,s.rank,"batchIndices")}
    ...
    fn mm_write(batch: i32, row: i32, colIn: i32, valueIn: ${iD(e,d)}) {
      let col = colIn * ${e};
      if (row < uniforms.dim_a_outer && col < uniforms.dim_b_outer) {
        var value = valueIn;
        let coords = vec3<i32>(batch, row, colIn);
        ${r?`value = value + ${n?"bias[colIn]":`${iD(e,d)}(bias[row])`};`:""}
        ${i}
        ${l.setByIndices("vec3<u32>(coords)","value")}
      }
    }
    `})($,C,iM(r,d.type.value,f),[s,u,l,d],n);return`
  ${i.registerUniforms(h).registerInternalVariables(s).declareVariables(...c,d)}
  ${m}
  ${g?iW(y,_,o,s):ij(y,_,o,s)}
                   `}}}}),n5=eo(()=>{nR(),nB(),nj(),n2(),n3(),n4(),n8(),iF=(e,r,i,a,n,s,o,u,l)=>{let d="NHWC"===r.format,p=d?e[0].dims[3]:e[0].dims[1],c=i[0],h=d?i[2]:i[3],f=d?i[1]:i[2],m=d?i[3]:i[1],g=d&&(p%4==0||p%3==0)&&m%4==0,y=d?m:h*f,_=d?h*f:m,b=[8,8,1],$=a<=8?[4,1,1]:[4,4,1],v=[Math.ceil(y/b[0]/$[0]),Math.ceil(_/b[1]/$[1]),Math.ceil(c/b[2]/$[2])];td("verbose",()=>`[conv2d_mm_webgpu] dispatch = ${v}`);let w=g?d&&p%4!=0?3:4:1,x=b[1]*$[1],S=b[0]*$[0],k=Math.max(b[0]*w,b[1]),T=a%x==0,I=n%S==0,C=s%k==0,E=g?[w,4,4]:[1,1,1],z=[{type:6,data:a},{type:6,data:n},{type:6,data:s},{type:6,data:[r.pads[0],r.pads[1]]},{type:6,data:r.strides},{type:6,data:r.dilations}];iR(r,z),z.push(...tF(e[0].dims,e[1].dims));let A=["rank","rank"];return o&&(z.push(...tF(e[2].dims)),A.push("rank")),z.push(...tF(i)),{name:"Conv2DMatMul",shaderCache:{hint:`${r.cacheKey};${w};${g};${T};${I};${C};${x};${S};${k}`,inputDependencies:A},getRunData:()=>({outputs:[{dims:l?l(i):i,dataType:e[0].dataType}],dispatchGroup:{x:v[0],y:v[1],z:v[2]},programUniforms:z}),getShaderSource:a=>{let n=[{name:"dim_a_outer",type:"i32"},{name:"dim_b_outer",type:"i32"},{name:"dim_inner",type:"i32"},{name:"pad",type:"i32",length:2},{name:"stride",type:"i32",length:2},{name:"dilation",type:"i32",length:2}];iN(r,n);let s=g?4:1,l=tj(e[0].dataType),p=`
      ...
      }`,c=[tJ("x",e[0].dataType,e[0].dims.length,3===w?1:w),tJ("w",e[1].dataType,e[1].dims.length,s)],h=t0("result",e[0].dataType,i.length,s);if(o){let r=tJ("bias",e[2].dataType,e[2].dims.length,s);c.push(r),p+=`
    ...
    return ${iD(u,d)}(0.0);`,b=iD(l,d),$=e?iD(o,d):iD(u,d),v=e?iD(u,d):iD(o,d),w=iM(s,b,d);return`
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${b}) {
      ...
      setOutputAtCoords(coords[0], coords[1], coords[2], coords[3], value);
        ...
        ${g?iW($,b,l,void 0,!d,k):ij($,b,l,void 0,!d,k,!1,void 0,u)}`}}}}),n9=eo(()=>{nR(),nB(),nD(),nj(),n2(),n3(),iH=e=>"number"==typeof e?[e,e,e]:e,iK=(e,r)=>r<=1?e:e+(e-1)*(r-1),iZ=(e,r,i,a,n)=>{null==n&&(n=((e,r,i,a=1)=>{let n=iK(r,a);return Math.floor((e[0]*(i-1)-i+n)/2)})(e,r[0],a[0]));let s=[0,0,0,i];for(let i=0;i<3;i++)e[i]+2*n>=r[i]&&(s[i]=Math.trunc((e[i]-r[i]+2*n)/a[i]+1));return s},iX=(e,r,i,a,n,s=!1,o="channelsLast")=>{let u,l,d,p,c;if("channelsLast"===o)[u,l,d,p,c]=e;else if("channelsFirst"===o)[u,c,l,d,p]=e;else throw Error(`Unknown dataFormat ${o}`);let[h,,f,m,g]=r,[y,_,b]=iH(i),[$,v,w]=iH(a),x=iK(f,$),S=iK(m,v),k=iK(g,w),{padInfo:T,outDepth:I,outHeight:C,outWidth:E}=((e,r,i,a,n,s,o,u,l,d)=>{let p,c,h,f;if("VALID"===e&&(e=0),"number"==typeof e){p={top:e,bottom:e,left:e,right:e,front:e,back:e};let m=iZ([r,i,a,1],[u,l,d],1,[n,s,o],e);c=m[0],h=m[1],f=m[2]}else if(Array.isArray(e)){if(!e.every((e,r,i)=>e===i[0]))throw Error(`Unsupported padding parameter: ${e}`);p={top:e[0],bottom:e[1],left:e[2],right:e[3],front:e[4],back:e[5]};let m=iZ([r,i,a,1],[u,l,d],1,[n,s,o],e[0]);c=m[0],h=m[1],f=m[2]}else if("SAME_UPPER"===e){c=Math.ceil(r/n),h=Math.ceil(i/s),f=Math.ceil(a/o);let e=(c-1)*n+u-r,m=(h-1)*s+l-i,g=(f-1)*o+d-a,y=Math.floor(e/2),_=Math.floor(m/2),b=Math.floor(g/2);p={top:_,bottom:m-_,left:b,right:g-b,front:y,back:e-y}}else throw Error(`Unknown padding parameter: ${e}`);return{padInfo:p,outDepth:c,outHeight:h,outWidth:f}})(n,l,d,p,y,_,b,x,S,k),z=s?h*c:h,A=[0,0,0,0,0];return"channelsFirst"===o?A=[u,z,I,C,E]:"channelsLast"===o&&(A=[u,I,C,E,z]),{batchSize:u,dataFormat:o,inDepth:l,inHeight:d,inWidth:p,inChannels:c,outDepth:I,outHeight:C,outWidth:E,outChannels:z,padInfo:T,strideDepth:y,strideHeight:_,strideWidth:b,filterDepth:f,filterHeight:m,filterWidth:g,effectiveFilterDepth:x,effectiveFilterHeight:S,effectiveFilterWidth:k,dilationDepth:$,dilationHeight:v,dilationWidth:w,inShape:e,outShape:A,filterShape:r}},iQ=(e,r,i,a,n,s)=>{let o="channelsLast"===s,u=[Math.ceil((e=>{let r=1;for(let i=0;i<e.length;i++)r*=e[i];return r})((o?e[0].dims[3]:e[0].dims[1],{x:i.map((e,r)=>r)}).x.map(e=>i[e]))/64),1,1];td("verbose",()=>`[conv3d_naive_webgpu] dispatch = ${u}`);let l=[{type:12,data:th.size(i)},{type:12,data:a},{type:12,data:n},{type:12,data:r.strides},{type:12,data:r.dilations}];iR(r,l),l.push(...tF(e[0].dims,e[1].dims));let d=["rank","rank"],p=3===e.length;return p&&(l.push(...tF(e[2].dims)),d.push("rank")),l.push(...tF(i)),{name:"Conv3DNaive",shaderCache:{hint:`${r.cacheKey};${o};1;${p}`,inputDependencies:d},getRunData:()=>({outputs:[{dims:i,dataType:e[0].dataType}],dispatchGroup:{x:u[0],y:u[1],z:u[2]},programUniforms:l}),getShaderSource:s=>{let u=[{name:"output_size",type:"u32"},{name:"filter_dims",type:"u32",length:a.length},{name:"pads",type:"u32",length:n.length},{name:"strides",type:"u32",length:r.strides.length},{name:"dilations",type:"u32",length:r.dilations.length}];iN(r,u);let l=tj(e[0].dataType),d=tJ("x",e[0].dataType,e[0].dims.length,1),c=tJ("W",e[1].dataType,e[1].dims.length,1),h=[d,c],f=t0("result",e[0].dataType,i.length,1),m="";if(p){let r=tJ("bias",e[2].dataType,e[2].dims.length,1);h.push(r),m+=`
        fn getBiasByOutputCoords(coords : array<u32, 5>) -> ${l} {
          return bias[${o?tQ("coords",4,5):tQ("coords",1,5)}];
        }`}let g=iD(1,l),y=iM(r,g,l);return`
            ${m}
          ...
          ${s.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
              ...
              let batch = ${tQ("coords",0,d.rank)};
              let d2 = ${o?tQ("coords",d.rank-1,d.rank):tQ("coords",1,d.rank)};
              let xFRCCorner = vec3<u32>(${o?tQ("coords",1,d.rank):tQ("coords",2,d.rank)},
              ${o?tQ("coords",2,d.rank):tQ("coords",3,d.rank)},
              ${o?tQ("coords",3,d.rank):tQ("coords",4,d.rank)}) * uniforms.strides - uniforms.pads;
              let xFCorner = xFRCCorner.x;
              let xRCorner = xFRCCorner.y;
              let xCCorner = xFRCCorner.z;
              let xShapeY = ${o?tQ("uniforms.x_shape",1,d.rank):tQ("uniforms.x_shape",2,d.rank)};
              let xShapeZ = ${o?tQ("uniforms.x_shape",2,d.rank):tQ("uniforms.x_shape",3,d.rank)};
              let xShapeW = ${o?tQ("uniforms.x_shape",3,d.rank):tQ("uniforms.x_shape",4,d.rank)};
              let xShapeU = ${o?tQ("uniforms.x_shape",4,d.rank):tQ("uniforms.x_shape",1,d.rank)};
          ...
          }`}}}}),n7=eo(()=>{nR(),nD(),nj(),n2(),iY=(e,r,i,a)=>{let n=e.length>2,s=n?"value += b[output_channel];":"",o=e[0].dims,u=e[1].dims,l="NHWC"===r.format,d=l?i[3]:i[1],p=d/r.group,c=l&&p>=4?tH(d):1,h=th.size(i)/c,f=[{type:12,data:h},{type:12,data:r.dilations},{type:12,data:[r.strides[0],r.strides[1]]},{type:12,data:[r.pads[0],r.pads[1]]},{type:12,data:p}];return iR(r,f),f.push(...tF(o,[u[0],u[1],u[2],u[3]/c])),f.push(...tF([i[0],i[1],i[2],i[3]/c])),{name:"GroupedConv",shaderCache:{hint:`${r.cacheKey}_${c}`,inputDependencies:n?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:a?a(i):i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(h/64)},programUniforms:f}),getShaderSource:a=>{let d=t0("output",e[0].dataType,i.length,c),p=tj(d.type.tensor),h=iM(r,d.type.value,p),f=tJ("x",e[0].dataType,o.length),m=tJ("w",e[1].dataType,u.length,c),g=[f,m];n&&g.push(tJ("b",e[2].dataType,e[2].dims,c));let y=[{name:"output_size",type:"u32"},{name:"dilations",type:"u32",length:r.dilations.length},{name:"strides",type:"u32",length:2},{name:"pads",type:"u32",length:2},{name:"output_channels_per_group",type:"u32"}];iN(r,y);let _=l?`
  ...
  ${a.mainStart()}
    ...
    ${h}
    ${d.setByOffset("global_idx","value")}
  }`}}},iJ=(e,r,i,a)=>{let n=e.length>2,s=tH(i[3]),o=tH(i[2]),u=th.size(i)/s/o,l=[e[0].dims[0],e[0].dims[1],e[0].dims[2],e[0].dims[3]/s],d=[e[1].dims[0],e[1].dims[1],e[1].dims[2],e[1].dims[3]/s],p=[i[0],i[1],i[2],i[3]/s],c=[{type:12,data:u},{type:6,data:[r.strides[0],r.strides[1]]},{type:6,data:[r.pads[0],r.pads[1]]}];iR(r,c),c.push(...tF(l,d,p));let h=(o-1)*r.strides[1]+d[1];return{name:"GroupedConv-Vectorize",shaderCache:{hint:`${r.cacheKey};${s};${o};${h};${d[0]};${d[1]}`,inputDependencies:n?["rank","rank","type"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:a?a(i):i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:c}),getShaderSource:i=>{let a=t0("output",e[0].dataType,p.length,s),u=tj(a.type.tensor),c=iM(r,a.type.value,u),f=tJ("x",e[0].dataType,l.length,s),m=tJ("w",e[1].dataType,d.length,s),g=[f,m];n&&g.push(tJ("b",e[2].dataType,e[2].dims,s));let y=[{name:"output_size",type:"u32"},{name:"strides",type:"i32",length:2},{name:"pads",type:"i32",length:2}];return iN(r,y),`
  ...
  ${i.mainStart()}
  ...
  }`}}}}),se=eo(()=>{nD(),n5(),n9(),n8(),n7(),n2(),n6(),nG(),i0=[2,3,1,0],i1=(e,r)=>{let i=e.kernelShape.slice();i.length<r[1].dims.length-2&&i.push(...Array(r[1].dims.length-2-i.length).fill(0));for(let e=2;e<r[1].dims.length;++e)0===i[e-2]&&(i[e-2]=r[1].dims[e]);let a=e.pads.slice();tf.adjustPadsBasedOnAutoPad(r[0].dims,e.strides,e.dilations,i,a,"NHWC"===e.format,e.autoPad);let n=Object.assign({},e);return Object.assign(n,{kernelShape:i,pads:a}),n},i2=e=>{let r=iB(e),i=e.format;return{autoPad:["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],format:i,dilations:e.dilations,group:e.group,kernelShape:e.kernel_shape,pads:e.pads,strides:e.strides,wIsConst:e.w_is_const(),...r,cacheKey:`${e.format};${r.activation};`}},i3=(e,r,i,a)=>{var n,s,o,u,l,d;let p,c,h,f,m,g,y="NHWC"===i.format,_=(n=r[0].dims,s=r[1].dims,o=i.dilations,u=i.pads,l=i.strides,d=y,p=n[0],h=(c=n.slice(d?1:2,d?3:4)).length,f=s[0],m=s.slice(2).map((e,r)=>e+(e-1)*(o[r]-1)),(g=c.map((e,r)=>e+u[r]+u[r+h]).map((e,r)=>Math.floor((e-m[r]+l[r])/l[r]))).splice(0,0,p),g.splice(d?3:1,0,f),g);if(1!==i.group){let n=[r[0]];if(y){let a=e.kernelCustomData.wT??e.compute(t8(r[1],i0),{inputs:[1],outputs:[i.wIsConst?-2:-1]})[0];i.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=a),n.push(a)}else n.push(r[1]);3===r.length&&n.push(r[2]),!e.adapterInfo.isArchitecture("ampere")&&y&&r[1].dims[0]===i.group&&1===r[1].dims[1]&&1===i.dilations[0]&&1===i.dilations[1]?e.compute(iJ(n,i,_,a),{inputs:n}):e.compute(iY(n,i,_,a),{inputs:n});return}let b=3===r.length,$=r[0].dims[y?1:2],v=r[0].dims[y?2:3],w=r[0].dims[y?3:1],x=r[1].dims[2],S=r[1].dims[3],k=_[y?1:2],T=_[y?2:3],I=_[y?3:1],C=y&&x===$&&S===v&&0===i.pads[0]&&0===i.pads[1];if(C||1===x&&1===S&&1===i.dilations[0]&&1===i.dilations[1]&&1===i.strides[0]&&1===i.strides[1]&&0===i.pads[0]&&0===i.pads[1]){let n=_[0],s,o,u,l=[];if(y){let a=e.kernelCustomData.wT??e.compute(t8(r[1],i0),{inputs:[1],outputs:[i.wIsConst?-2:-1]})[0];if(i.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=a),C){let e=$*v*w;s=r[0].reshape([1,n,e]),o=a.reshape([1,e,I]),u=[1,n,I]}else s=r[0].reshape([n,$*v,w]),o=a.reshape([1,w,I]),u=[n,k*T,I];l.push(s),l.push(o)}else s=r[0].reshape([n,w,$*v]),o=r[1].reshape([1,I,w]),u=[n,I,k*T],l.push(o),l.push(s);b&&l.push(r[2]);let d=u[2],p=l[0].dims[l[0].dims.length-1];d<8&&p<8?e.compute(iq(l,i,_,u,y,a),{inputs:l}):e.compute(iG(l,i,_,u,y,a),{inputs:l});return}let E=e.kernelCustomData.wT??e.compute(t8(r[1],i0),{inputs:[1],outputs:[i.wIsConst?-2:-1]})[0];i.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=E);let z=[r[0],E];b&&z.push(r[2]);let A=y?k*T:I,O=y?I:k*T,M=x*S*w;e.compute(iF(z,i,_,A,O,M,b,!0,a),{inputs:z})},i4=(e,r)=>{var i,a,n,s,o;if(((e,r)=>{if(!e||2!==e.length&&3!==e.length)throw Error("Conv requires 2 or 3 inputs");if(e[0].dims.length>5)throw Error("greater than 5D is not supported");if(e[0].dims.length!==e[1].dims.length)throw Error("filter does not have same dimension as input");if(e[0].dims["NHWC"===r.format?e[0].dims.length-1:1]!==e[1].dims[1]*r.group)throw Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");if(3===e.length&&(1!==e[2].dims.length||e[1].dims[0]!==e[2].dims[0]))throw Error("invalid bias");let i=e[0].dims.length-2;if(r.dilations.length!==i)throw Error(`dilations should be ${i}D`);if(r.strides.length!==i)throw Error(`strides should be ${i}D`);if(r.pads.length!==2*i)throw Error(`pads should be ${2*i}D`);if(0!==r.kernelShape.length&&r.kernelShape.length!==e[1].dims.length-2)throw Error("invalid kernel shape")})(e.inputs,r),3===e.inputs[0].dims.length){let n,s,o,u,l,d,p;i=e,n="NHWC"===(a=r).format,s=[i.inputs[0].reshape(n?[i.inputs[0].dims[0],1,i.inputs[0].dims[1],i.inputs[0].dims[2]]:[i.inputs[0].dims[0],i.inputs[0].dims[1],1,i.inputs[0].dims[2]]),i.inputs[1].reshape([i.inputs[1].dims[0],i.inputs[1].dims[1],1,i.inputs[1].dims[2]])],3===i.inputs.length&&s.push(i.inputs[2]),o=[0,a.pads[0],0,a.pads[1]],u=[1].concat(a.strides),l=[1].concat(a.dilations),d=[1].concat(a.kernelShape),p=i1({...a,pads:o,strides:u,dilations:l,kernelShape:d},s),i3(i,s,p,e=>n?[e[0],e[2],e[3]]:[e[0],e[1],e[3]])}else if(5===e.inputs[0].dims.length){let i,a,u,l;n=e,s=e.inputs,i="NHWC"===(o=r).format?"channelsLast":"channelsFirst",a=i1(o,s),u="NOTSET"===o.autoPad?o.pads:o.autoPad,l=iX(s[0].dims,s[1].dims,o.strides,o.dilations,u,!1,i),n.compute(iQ(s,a,l.outShape,[l.filterDepth,l.filterHeight,l.filterWidth],[l.padInfo.front,l.padInfo.top,l.padInfo.left],i))}else{let i=i1(r,e.inputs);i3(e,e.inputs,i)}}}),st=eo(()=>{nR(),nB(),nD(),nj(),i6=(e,r,i)=>{let a=e.length>2,n=r.outputShape,s="NHWC"===r.format,o=r.group,u=e[1].dims,l=u[2]/o,d=u[3],p=s?tH(l):1,c=s&&1===d&&l>=4,h=c?4*Math.floor(l/4):Math.floor(l/p)*p,f=l-h,m=s?tH(d):1,g=s?1===d?p:m:1,y=th.size(n)/m,_=[Math.ceil(y/64),1,1];td("verbose",()=>`[conv2d_backprop_webgpu] dispatch = ${_}`);let b=["rank","rank"],$=[r.strides[0],r.strides[1]],v=[r.kernelShape[s?1:2],r.kernelShape[s?2:3]],w=[r.dilations[0],r.dilations[1]],x=[v[0]+(r.dilations[0]<=1?0:(r.kernelShape[s?1:2]-1)*(r.dilations[0]-1)),v[1]+(r.dilations[1]<=1?0:(r.kernelShape[s?2:3]-1)*(r.dilations[1]-1))],S=[x[0]-1-Math.floor((r.pads[0]+r.pads[2])/2),x[1]-1-Math.floor((r.pads[1]+r.pads[3])/2)],k=[{type:12,data:y},{type:12,data:$},{type:12,data:v},{type:12,data:w},{type:12,data:x},{type:6,data:S},{type:12,data:h},{type:12,data:l},{type:12,data:d},...tF(e[0].dims,e[1].dims)];return a&&(k.push(...tF(e[2].dims)),b.push("rank")),k.push(...tF(n)),{name:"ConvTranspose2D",shaderCache:{hint:`${r.cacheKey};${p}${g}${m}${c}${f}`,inputDependencies:b},getRunData:()=>({dispatchGroup:{x:_[0],y:_[1],z:_[2]},outputs:[{dims:i?i(n):n,dataType:e[0].dataType}],programUniforms:k}),getShaderSource:r=>{let i=[{name:"output_size",type:"u32"},{name:"strides",type:"u32",length:$.length},{name:"filter_dims",type:"u32",length:v.length},{name:"dilations",type:"u32",length:v.length},{name:"effective_filter_dims",type:"u32",length:x.length},{name:"pads",type:"i32",length:S.length},{name:"input_channels_per_group_int",type:"u32"},{name:"input_channels_per_group",type:"u32"},{name:"output_channels_per_group",type:"u32"}],o=tj(e[0].dataType),u=s?1:2,l=s?2:3,d=s?3:1,h=tJ("W",e[1].dataType,e[1].dims.length,g),y=tJ("Dy",e[0].dataType,e[0].dims.length,p),_=[y,h];a&&_.push(tJ("bias",e[2].dataType,[n[d]].length,m));let b=t0("result",e[0].dataType,n.length,m),w=`
    ...
    ${w}}`}}}}),sr=eo(()=>{st(),n2(),nG(),i8=(e,r,i,a,n,s)=>(e-1)*r+i+(a-1)*n+1-s,i5=(e,r,i,a,n)=>{let s=Math.floor(e/2);"SAME_UPPER"===r?(i[a]=s,i[n]=e-s):"SAME_LOWER"===r&&(i[a]=e-s,i[n]=s)},i9=(e,r)=>{let i=e.kernelShape.slice();if(0===e.kernelShape.length||0===e.kernelShape.reduce((e,r)=>e*r,1)){i.length=0;for(let e=2;e<r[1].dims.length;++e)i.push(r[1].dims[e])}let a="NHWC"===e.format;i.splice(0,0,r[1].dims[0]),i.splice(a?3:1,0,r[1].dims[1]);let n=e.pads.slice(),s=e.outputShape.slice(),o=e.outputPadding.slice(),u=r[0].dims,l=e.dilations.slice();0===l.reduce((e,r)=>e+r,0)&&(l=Array(r[0].dims.length-2).fill(1));let d=e.strides.slice();0===d.reduce((e,r)=>e+r,0)&&(d=Array(r[0].dims.length-2).fill(1)),((e,r,i,a,n,s,o,u,l,d)=>{let p=e.length-2,c=0===d.length;l.length<p&&l.push(...Array(p-l.length).fill(0));let h=e[0],f=r[u?3:1]*n;for(let n=0,h=e.length-p-!!u;n<p;++n,++h){let u=e[h],f=c?u*o[n]:d[n];i5(i8(u,o[n],s[n],r[h],i[n],f),a,s,n,n+p),c&&d.push(o[n]*(u-1)+l[n]+(r[h]-1)*i[n]+1-s[n]-s[n+p])}d.splice(0,0,h),d.splice(u?3:1,0,f)})(u,i,l,e.autoPad,e.group,n,d,a,o,s);let p=Object.assign({},e);return Object.assign(p,{kernelShape:i,pads:n,outputPadding:o,outputShape:s,dilations:l,strides:d}),p},i7=e=>{let r=iB(e),i=e.format,a=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][typeof e.autoPad>"u"?0:e.autoPad],n=e.dilations,s=e.group??1,o=e.kernelShape,u=e.pads,l=e.strides,d=e.wIsConst();return{autoPad:a,format:i,dilations:n,group:s,kernelShape:o,outputPadding:e.outputPadding,outputShape:e.outputShape,pads:u,strides:l,wIsConst:d,...r,cacheKey:`${e.format};${r.activation};`}},ae=(e,r,i,a)=>{let n=e.kernelCustomData.wT??e.compute(t8(r[1],[2,3,0,1]),{inputs:[1],outputs:[i.wIsConst?-2:-1]})[0];i.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=n);let s=[r[0],n];3===r.length&&s.push(r[2]),e.compute(i6(s,i,a),{inputs:s})},at=(e,r)=>{if(((e,r)=>{if(!e||2!==e.length&&3!==e.length)throw Error("Conv requires 2 or 3 inputs");if(4!==e[0].dims.length&&3!==e[0].dims.length)throw Error("currently only support 2-dimensional conv");if(e[0].dims.length!==e[1].dims.length)throw Error("filter does not have same dimension as input");if(e[0].dims["NHWC"===r.format?e[0].dims.length-1:1]!==e[1].dims[0])throw Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");let i=e[1].dims[1]*r.group;if(3===e.length&&(1!==e[2].dims.length||e[2].dims[0]!==i))throw Error("invalid bias");let a=e[0].dims.length-2;if(r.dilations.reduce((e,r)=>e+r,0)>0&&r.dilations.length!==a)throw Error(`dilations should be ${a}D`);if(r.strides.reduce((e,r)=>e+r,0)>0&&r.strides.length!==a)throw Error(`strides should be ${a}D`);if(r.pads.reduce((e,r)=>e+r,0)>0&&r.pads.length!==2*a)throw Error(`pads should be ${2*a}D`);if(r.outputPadding.length!==a&&0!==r.outputPadding.length)throw Error(`output_padding should be ${a}D`);if(r.kernelShape.reduce((e,r)=>e+r,0)>0&&0!==r.kernelShape.length&&r.kernelShape.length!==e[1].dims.length-2)throw Error("invalid kernel shape");if(0!==r.outputShape.length&&r.outputShape.length!==e[0].dims.length-2)throw Error("invalid output shape")})(e.inputs,r),3===e.inputs[0].dims.length){var i,a;let n,s,o,u,l,d,p,c;i=e,n="NHWC"===(a=r).format,s=[i.inputs[0].reshape(n?[i.inputs[0].dims[0],1,i.inputs[0].dims[1],i.inputs[0].dims[2]]:[i.inputs[0].dims[0],i.inputs[0].dims[1],1,i.inputs[0].dims[2]]),i.inputs[1].reshape([i.inputs[1].dims[0],i.inputs[1].dims[1],1,i.inputs[1].dims[2]])],3===i.inputs.length&&s.push(i.inputs[2]),(0===(o=a.kernelShape).length||0===o[0])&&(o=[i.inputs[1].dims[2]]),(0===(u=a.dilations).length||0===u[0])&&(u=[1]),(0===(l=a.strides).length||0===l[0])&&(l=[1]),0===(d=a.pads).length&&(d=[0,0]),d=[0,d[0],0,d[1]],l=[1].concat(l),u=[1].concat(u),o=[1].concat(o),p=[0].concat(p=a.outputPadding),c=i9({...a,pads:d,strides:l,dilations:u,kernelShape:o,outputPadding:p},s),ae(i,s,c,e=>n?[e[0],e[2],e[3]]:[e[0],e[1],e[3]])}else{let i=i9(r,e.inputs);ae(e,e.inputs,i)}}}),si=eo(()=>{nR(),nD(),nV(),nj(),ar=(e,r)=>{var i,a,n,s;let o,u,l,d,p,c,h=e.inputs[0].dims,f=e.inputs[0].dataType,m=e.inputs[1];e.compute((i=f,a=h,n=m,s=r,o=th.size(a),u=a.length,l=tJ("input",i,u),d=t0("output",i,u),p=6===n.dataType?n.getInt32Array()[0]:Number(n.getBigInt64Array()[0]),c=th.normalizeAxis(p,u),{name:"CumSum",shaderCache:{hint:s.cacheKey,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:a,dataType:i}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:[{type:12,data:o},{type:12,data:c},...tF(a,a)]}),getShaderSource:e=>{let r=` i32(${l.indicesGet("inputIndices","uniforms.axis")}) `,i=tQ("uniforms.input_shape","uniforms.axis",u),a=s.reverse?r+(s.exclusive?" + 1":""):"0",n=s.reverse?i:r+(s.exclusive?"":" + 1");return`
                ...
                }`}}),{inputs:[0]})},ai=e=>{let r=1===e.exclusive,i=1===e.reverse;return tq({exclusive:r,reverse:i})}}),sa=eo(()=>{nR(),nD(),nV(),nj(),aa=(e,r)=>{var i,a;let n,s,o,u,l,d,p,c,h,f,m,g,y,_;(e=>{if(!e||1!==e.length)throw Error("DepthToSpace requires 1 input.");if(4!==e[0].dims.length)throw Error("DepthToSpace requires 4D input.")})(e.inputs),e.compute((i=e.inputs[0],p="NHWC"===(a=r).format,c=a.blocksize,h="DCR"===a.mode,p?([n,s,o,u]=i.dims,l=h?[n,s,o,c,c,u/c**2]:[n,s,o,u/c**2,c,c],d=h?[0,1,3,2,4,5]:[0,1,4,2,5,3]):([n,s,o,u]=[i.dims[0],i.dims[2],i.dims[3],i.dims[1]],l=h?[n,c,c,u/c**2,s,o]:[n,u/c**2,c,c,s,o],d=h?[0,3,4,1,5,2]:[0,1,4,2,5,3]),m=(f=i.reshape(l)).dims.length,g=i.dataType,y=tJ("a",g,m),_=t0("output",g,m),{name:"DepthToSpace",shaderCache:{hint:`${i.dims};${a.blocksize};${a.mode}`,inputDependencies:["rank"]},getRunData:e=>{let r=p?[n,s*c,o*c,u/c**2]:[n,u/c**2,s*c,o*c],i=th.size(r),a=f.dims,l=th.sortBasedOnPerm(a,d);return{outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:[{type:12,data:i},...tF(a,l)]}},getShaderSource:e=>`
...
`)};
          ...
          }`}}))},ah=e=>{let r=e.equation.replace(/\s+/g,"");return tq({equation:r})}}),ss=eo(()=>{nR(),nD(),nj(),af=(e,r)=>{let i=e.length-r.length,a=[];for(let r=0;r<i;++r)a.push(e[r]);for(let n=0;n<r.length;++n)a.push(1===r[n]?e[n+i]:r[n]);return a},am=e=>{var r;let i,a,n,s,o,u,l,d,p,c;(e=>{if(!e||2!==e.length)throw Error("Expand requires 2 input.");let r=e[0].dims,i=Array.from(e[1].getBigInt64Array(),Number),a=i.length<r.length?0:i.length-r.length,n=r.length<i.length?0:r.length-i.length;for(;a<i.length&&n<r.length;++a,++n)if(i[a]!==r[n]&&1!==i[a]&&1!==r[n])throw Error("Expand requires shape to be broadcastable to input")})(e.inputs),e.compute((s=(i=n=(r=e.inputs)[0].dims,a=Array.from(r[1].getBigInt64Array(),Number),i.length>a.length?af(i,a):af(a,i)),u=9===(o=r[0].dataType)||1===th.size(n),l=9===o||n.length>0&&n[n.length-1]%4==0?4:1,d=u||s.length>0&&s[s.length-1]%4==0?4:1,c=[{type:12,data:p=Math.ceil(th.size(s)/d)},...tF(n,s)],{name:"Expand",shaderCache:{hint:`${s.length};${l}${d}`,inputDependencies:["rank"]},getShaderSource:e=>{let r=tJ("input",o,n.length,l),i=t0("output",o,s.length,d),a;if(9===o){let e=(e,a,n="")=>`
    ...
    ${e.mainStart()}
    ${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.vec_size")}
    ${a}`},getRunData:()=>({outputs:[{dims:s,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:c})}),{inputs:[0]})}}),so=eo(()=>{nR(),nD(),nj(),nY(),ag=e=>{var r;let i,a,n,s;e.inputs.length<2||0===th.size(e.inputs[1].dims)?ih(e):e.compute((i=(r=e.inputs)[0].dataType,a=th.size(r[0].dims),s=(n=th.size(r[1].dims))%4==0,{name:"FastGeluWithBias",shaderCache:{hint:`${s}`,inputDependencies:["type","type"]},getShaderSource:e=>{let r=tJ("x",i,[1],4),a=tJ("bias",i,[1],4),n=t0("y",i,[1],4),o=e=>`
    ...
    ${e.mainStart(tW)}
      ...
      ${u}
      let x_in = x + bias;
      ${n.setByOffset("global_idx",ic("x_in"))}
    }`},getRunData:e=>({outputs:[{dims:e[0].dims,dataType:e[0].dataType}],programUniforms:[{type:12,data:Math.ceil(a/4)},{type:12,data:n}],dispatchGroup:{x:Math.ceil(a/tW/4)}})}))}}),su=eo(()=>{nR(),nD(),nV(),nj(),ay=e=>tq({axis:e.axis}),a_=(e,r)=>{var i,a;let n,s,o,u,l,d,p,c,h;(e=>{if(!e||2!==e.length)throw Error("Gather requires 2 inputs.")})(e.inputs),e.compute((i=e.inputs,a=r,n=i[0].dims,s=i[1].dims,o=n.length,u=th.normalizeAxis(a.axis,o),(l=n.slice(0)).splice(u,1,...s),d=n[u],p=9===i[0].dataType?4:1,h=[{type:12,data:c=Math.ceil(th.size(l)/p)},{type:6,data:d},{type:12,data:u},...tF(i[0].dims,i[1].dims,l)],{name:"Gather",shaderCache:{hint:a.cacheKey,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:l,dataType:i[0].dataType}],dispatchGroup:{x:Math.ceil(c/64)},programUniforms:h}),getShaderSource:e=>{let r=tJ("data",i[0].dataType,i[0].dims.length,p),a=tJ("inputIndices",i[1].dataType,i[1].dims.length),n=t0("output",i[0].dataType,l.length,p),d=e=>{let i=s.length,n=`var indicesIndices${e}  = ${a.type.indices}(0);`;for(let r=0;r<i;r++)n+=`${i>1?`indicesIndices${e}[${r}]`:`indicesIndices${e}`} = ${l.length>1?`outputIndices${e}[uniforms.axis + ${r}]`:`outputIndices${e}`};`;n+=`
      ...
      ${e.mainStart()}
        ${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
        ${c}
      }`}}))}}),sl=eo(()=>{nR(),nD(),nj(),ab=(e,r)=>{var i,a,n,s,o,u;let l,d,p=e.inputs,c=p[0].dims,h=p[0].dataType,f=p[1].dims,m=f[f.length-1],g=th.sizeToDimension(f,f.length-1),y=th.sizeFromDimension(c,r.batchDims+m),_=th.sizeToDimension(c,r.batchDims),b=th.sizeFromDimension(c,r.batchDims),$=Array(m),v=y;for(let e=0;e<m;++e)$[m-1-e]=v,v*=c[r.batchDims+m-1-e];let w=(i=e,a=p[1],n=$,s=r.batchDims,o=c,l=[{type:12,data:u=g},{type:12,data:s},{type:12,data:o},{type:12,data:n},{type:12,data:g/_},{type:12,data:b},{type:12,data:m}],d=[u],l.push(...tF(a.dims,d)),i.compute({name:"computeSliceOffsets",shaderCache:{hint:`${o.length}_${n.length}`,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:d,dataType:i.inputs[1].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:l}),getShaderSource:e=>{let r=tJ("indices_data",a.dataType,a.dims.length),i=t0("input_slice_offsets_data",12,1,1),s=[{name:"output_size",type:"u32"},{name:"batch_dims",type:"u32"},{name:"input_dims",type:"u32",length:o.length},{name:"sizes_from_slice_dims_data",type:"u32",length:n.length},{name:"num_slices_per_batch",type:"u32"},{name:"input_batch_stride",type:"u32"},{name:"num_slice_dims",type:"u32"}];return`
  ...
  ${e.mainStart()}
    ...
    input_slice_offsets_data[global_idx] =  base_offset + u32(relative_slice_offset);
  }`}},{inputs:[a],outputs:[-1]})[0]),x=r.batchDims+m;if(x>c.length)throw Error("last dimension of indices must not be larger than rank of input tensor");let S=f.slice(0,-1).concat(c.slice(x)),k=th.size(S),T=[{type:12,data:k},{type:12,data:y},...tF(p[0].dims,w.dims,S)];e.compute({name:"GatherND",shaderCache:{hint:r.cacheKey,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:S,dataType:h}],dispatchGroup:{x:Math.ceil(k/64)},programUniforms:T}),getShaderSource:e=>{let r=tJ("data",p[0].dataType,p[0].dims.length),i=tJ("slice_offsets",12,w.dims.length),a=t0("output",p[0].dataType,S.length);return`
          ${e.registerUniform("output_size","u32").registerUniform("slice_size","u32").declareVariables(r,i,a)}
            ${e.mainStart()}
            ${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
          let slice_offset = slice_offsets[global_idx / uniforms.slice_size];
          output[global_idx] = data[u32(slice_offset) + global_idx % uniforms.slice_size];
        }`}},{inputs:[p[0],w]})},a$=e=>({batchDims:e.batch_dims,cacheKey:""})}),sd=eo(()=>{nR(),nD(),nV(),nj(),av=(e,r)=>{var i,a;let n,s,o,u,l,d,p,c,h,f;((e,r)=>{if(e.length<3||e.length>4)throw Error("GatherBlockQuantized requires 3 or 4 inputs.");let i=th.normalizeAxis(r.quantizeAxis,e[0].dims.length),a=r.blockSize,n=e[0],s=e[2],o=4===e.length?e[3]:void 0;if(s.dims.length!==n.dims.length||!n.dims.map((e,r)=>r===i?Math.ceil(e/a)===s.dims[r]:e===s.dims[r]).reduce((e,r)=>e&&r,!0))throw Error("Scales must have the same rank as the input tensor and the dims should match except on gatherAxis.");if(o){if(o.dataType!==n.dataType)throw Error("Zero point must have the same data type as the input tensor.");if(o.dims.length!==s.dims.length||!o.dims.map((e,r)=>e===s.dims[r]).reduce((e,r)=>e&&r,!0))throw Error("Zero point must have the same rank as the input tensor and the dims should match except on quantizeAxis.")}})(e.inputs,r),e.compute((i=e.inputs,a=r,n=i[0].dims,s=i[1].dims,o=n.length,u=th.normalizeAxis(a.gatherAxis,o),l=th.normalizeAxis(a.quantizeAxis,o),(d=n.slice(0)).splice(u,1,...s),p=th.size(d),c=i[2].dataType,h=22===i[0].dataType,f=[{type:12,data:p},{type:12,data:l},{type:12,data:u},{type:12,data:a.blockSize},...tF(...i.map((e,r)=>e.dims),d)],{name:"GatherBlockQuantized",shaderCache:{hint:`${a.cacheKey};${i.filter((e,r)=>1!==r).map(e=>e.dims.join("_")).join(";")}`,inputDependencies:Array.from({length:i.length},(e,r)=>"rank")},getRunData:()=>({outputs:[{dims:d,dataType:c}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:f}),getShaderSource:e=>{let r=tJ("data",i[0].dataType,i[0].dims.length),a=tJ("inputIndices",i[1].dataType,i[1].dims.length),o=tJ("scales",i[2].dataType,i[2].dims.length),l=i.length>3?tJ("zeroPoint",i[3].dataType,i[3].dims.length):void 0,p=t0("output",c,d.length),f=[r,a,o];return l&&f.push(l),`
        ...
        let dequantized_data = ${tG(c)}(quantized_data - zero_point) * scale;
        ${p.setByOffset("global_idx","dequantized_data")};
    }`}}))},aw=e=>tq({blockSize:e.blockSize,gatherAxis:e.gatherAxis,quantizeAxis:e.quantizeAxis})}),sp=eo(()=>{nR(),nD(),nV(),nj(),ax=e=>tq({axis:e.axis}),aS=(e,r)=>{var i,a;let n,s,o,u,l,d,p,c,h,f,m,g,y;(e=>{if(!e||2!==e.length)throw Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw Error(`GatherElements requires that the data input and
                     indices input tensors be of same rank.`)})(e.inputs),e.compute((i=e.inputs,a=r,n=i[0].dims,s=i[0].dataType,o=n.length,u=i[1].dims,l=i[1].dataType,p=n[d=th.normalizeAxis(a.axis,o)],c=u.slice(0),h=th.size(c),f=tJ("input",s,o),m=tJ("indicesInput",l,u.length),g=t0("output",s,c.length),(y=[{type:12,data:h},{type:6,data:p},{type:12,data:d}]).push(...tF(n,u,c)),{name:"GatherElements",shaderCache:{inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:c,dataType:i[0].dataType}],dispatchGroup:{x:Math.ceil(h/64)},programUniforms:y}),getShaderSource:e=>`
      ...
      ${g.setByOffset("global_idx","value")};
  }`}))}}),sc=eo(()=>{nR(),nD(),nj(),ak=e=>({transA:e.transA,transB:e.transB,alpha:e.alpha,beta:e.beta,cacheKey:`${e.transA};${e.transB};${1===e.alpha}`}),aT=(e,r)=>{(e=>{if(!e)throw Error("Input is missing");if(e.length<2||e.length>3)throw Error("Invaid input number.");if(3===e.length&&e[2].dims.length>2)throw Error("Invalid input shape of C");if(e[0].dataType!==e[1].dataType||3===e.length&&e[0].dataType!==e[2].dataType)throw Error("Input types are mismatched")})(e.inputs),e.compute(((e,r)=>{let i=e[0].dims.slice(),a=e[1].dims.slice(),[n,s,o]=tm.getShapeOfGemmResult(i,r.transA,a,r.transB,3===e.length?e[2].dims:void 0),u=[n,s],l=Math.ceil(s/16),d=Math.ceil(n/16),p=(th.size(u),[{type:12,data:l},{type:12,data:n},{type:12,data:s},{type:12,data:o},{type:1,data:r.alpha},{type:1,data:r.beta}]),c=["type","type"];return 3===e.length&&(p.push(...tF(e[2].dims)),c.push("rank")),p.push(...tF(u)),{name:"GemmShared",shaderCache:{hint:`${r.cacheKey}`,inputDependencies:c},getRunData:()=>({outputs:[{dims:u,dataType:e[0].dataType}],dispatchGroup:{x:l*d},programUniforms:p}),getShaderSource:i=>{let a=tJ("a",e[0].dataType,e[0].dims),n=tJ("b",e[1].dataType,e[1].dims),s=null,o=[a,n];3===e.length&&(s=tJ("c",e[2].dataType,e[2].dims.length),o.push(s));let l=t0("output",e[0].dataType,u.length);o.push(l);let d="",p="";r.transA&&r.transB?(p=`
  ...
  }`}}})(e.inputs,r))}}),sh=eo(()=>{nR(),nD(),nV(),nj(),[aI,aC,aE,az]=[0,1,2,3],aA=`
...
`,aO=(e,r)=>{var i,a;let n,s,o,u,l,d,p;(e=>{if(4!==e[0].dims.length)throw Error("only 4-D tensor is supported.");if(e[0].dims.length!==e[1].dims.length)throw Error("input dimensions must be equal to grid dimensions");if(e[0].dims.length-2!==e[1].dims[e[1].dims.length-1])throw Error(`last dimension of grid must be equal to ${e[0].dims.length-2}`);if(e[0].dims[0]!==e[1].dims[0])throw Error("grid batch size must match input batch size")})(e.inputs),e.compute((i=e.inputs,a=r,n=tJ("x",i[0].dataType,i[0].dims.length),s=[i[1].dims[0],i[1].dims[1],i[1].dims[2]],o=tJ("grid",i[1].dataType,s.length,2),u=[i[0].dims[0],i[0].dims[1],i[1].dims[1],i[1].dims[2]],"NHWC"===a.format&&(u=[i[0].dims[0],i[1].dims[1],i[1].dims[2],i[0].dims[3]],[aI,aC,aE,az]=[0,3,1,2]),l=t0("output",i[0].dataType,u.length),d=n.type.value,p=[{type:12,data:th.size(u)},...tF(i[0].dims,s,u)],{name:"GridSample",shaderCache:{hint:`${a.cacheKey}`,inputDependencies:["type","type"]},getRunData:e=>{let r=th.size(u);return{outputs:[{dims:u,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(r/64)},programUniforms:p}},getShaderSource:e=>{let r,i,s,u,p,c,h,f,m;return`
...
`}
  ...
  fn pixel_at_grid(r: i32, c: i32, H: i32, W: i32, batch: u32, channel: u32, border: vec4<f32>) -> ${p} {
     ...
     indices[${aI}] = batch;
     indices[${aC}] = channel;`+(()=>{switch(c.paddingMode){case"zeros":return`
          if (r >= 0 && r < H && c >=0 && c < W) {
            indices[${aE}] = u32(r);
            indices[${az}] = u32(c);
          } else {
        ...
        `;case"border":return`
          indices[${aE}] = u32(clamp(r, 0, H - 1));
          indices[${az}] = u32(clamp(c, 0, W - 1));
        `;case"reflection":return`
          indices[${aE}] = gs_reflect(r, border[1], border[3]);
          indices[${az}] = gs_reflect(c, border[0], border[2]);
...
`}
  ...
  ${e.mainStart()}
    ${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
      let H_in = i32(uniforms.x_shape[${aE}]);
      let W_in = i32(uniforms.x_shape[${az}]);
      ...
      var grid_indices = vec3<u32>(indices[${aI}], indices[${aE}], indices[${az}]);
      let nxy = ${o.getByIndices("grid_indices")};
      var x = gs_denormalize(f32(nxy[0]), W_in);
      var y = gs_denormalize(f32(nxy[1]), H_in);

      ${h=l,f=d,m=a,(()=>{switch(m.mode){case"nearest":return`
          let result = pixel_at_grid(i32(round(y)), i32(round(x)), H_in, W_in, indices[${aI}], indices[${aC}], border);
        `;case"bilinear":return`
          ...
          let p11 = pixel_at_grid(y1, x1, H_in, W_in, indices[${aI}], indices[${aC}], border);
          let p12 = pixel_at_grid(y1, x2, H_in, W_in, indices[${aI}], indices[${aC}], border);
          let p21 = pixel_at_grid(y2, x1, H_in, W_in, indices[${aI}], indices[${aC}], border);
          let p22 = pixel_at_grid(y2, x2, H_in, W_in, indices[${aI}], indices[${aC}], border);
        ...
        `;case"bicubic":return`
          ...
          for (var h = 0; h < 4; h++) {
            for (var w = 0; w < 4; w++) {
              p[h][w] = pixel_at_grid(h + y0, w + x0, H_in, W_in, indices[${aI}], indices[${aC}], border);
            }
          }
  ...
  }`}}))},aM=e=>tq({alignCorners:e.align_corners,mode:e.mode,paddingMode:e.padding_mode,format:e.format})}),sf=eo(()=>{nR(),nD(),nV(),nq(),nZ(),nj(),nG(),aR=(e,r)=>e.length>r&&e[r].dims.length>0?e[r]:void 0,aN=e=>tq({...e}),aB=tq({perm:[0,2,1,3]}),aD=(e,r,i,a,n,s,o,u)=>{var l,d,p,c,h,f,m;let g,y,_,b=s;if(!(o&&th.size(o.dims)>0))return 3===s.dims.length&&(b=s.reshape([r,a,i,n])),1===i||1===a?b:e.compute(t8(b,aB.perm),{inputs:[b],outputs:[-1]})[0];if(1===a)throw Error("AddBiasReshape is not implemented. Please export your model with packed QKV or KV");return b=(l=e,d=s,p=o,c=r,h=a,f=i*n,m=u,g=[c,h,f],_=[{type:12,data:y=th.size(g)},{type:12,data:m},{type:12,data:f}],b=l.compute({name:"MultiHeadAttentionAddBias",shaderCache:{inputDependencies:["type","type"]},getRunData:()=>({outputs:[{dims:g,dataType:d.dataType,gpuDataType:0}],dispatchGroup:{x:Math.ceil(y/64)},programUniforms:_}),getShaderSource:e=>{let r=t0("qkv_with_bias",d.dataType,g),i=tJ("qkv",d.dataType,g),a=tJ("bias",p.dataType,g);return`
...
`)}
  ...
  ${e.mainStart()}
    ...
    if (output_number != 0) {
      index -= ${tQ("uniforms.size_in_split_axis","output_number - 1u",l.length)};
      ${u.indicesSet("indices",s,"index")};
    }
    writeBufferData(output_number, indices, global_idx);
  }`},getRunData:()=>({outputs:d,dispatchGroup:{x:Math.ceil(a/64)},programUniforms:h})}},aL=(e,r)=>{let i,a;var n,s,o=e.inputs;if(!o||o.length<1)throw Error("too few inputs");let u=1===e.inputs.length?r:(n=e.inputs,i=[],a=(s=r).numOutputs,n[1].dims[0]>0&&(n[1].getBigInt64Array().forEach(e=>i.push(Number(e))),a=i.length),tq({numOutputs:a,axis:s.axis,splitSizes:i}));e.compute(aP(e.inputs,u),{inputs:[0]})},aq=e=>{let r=e.axis,i=e.splitSizes,a=e.numOutputs<0?i.length:e.numOutputs;if(a!==i.length)throw Error("numOutputs and splitSizes length must be equal");return tq({axis:r,numOutputs:a,splitSizes:i})}}),sg=eo(()=>{nR(),nD(),nV(),nj(),aW=(e,r)=>{let{interleaved:i,numHeads:a,rotaryEmbeddingDim:n,scale:s}=r,o=e[0].dims[0],u=th.sizeFromDimension(e[0].dims,1),l=e[0].dims[e[0].dims.length-2],d=u/l,p=e[2].dims[1],c=0===n?2*p:d/a,h=[o,l,d/c,c-p],f=th.computeStrides(h),m=[{type:1,data:s},{type:12,data:h},{type:12,data:f},...3===e[0].dims.length?Array({type:12,data:[u,d,c,1]}):[],...4===e[0].dims.length?Array({type:12,data:[u,c,l*c,1]}):[],...tF(e[0].dims,e[1].dims,e[2].dims,e[3].dims,e[0].dims)];return{name:"RotaryEmbedding",shaderCache:{hint:tq({interleaved:i}).cacheKey,inputDependencies:["rank","rank","rank","rank"]},getShaderSource:r=>{let a=tJ("input",e[0].dataType,e[0].dims.length),n=tJ("position_ids",e[1].dataType,e[1].dims.length),s=tJ("cos_cache",e[2].dataType,e[2].dims.length),o=tJ("sin_cache",e[3].dataType,e[3].dims.length),u=t0("output",e[0].dataType,e[0].dims.length);return r.registerUniforms([{name:"scale",type:"f32"},{name:"global_shape",type:"u32",length:h.length},{name:"global_strides",type:"u32",length:f.length},{name:"input_output_strides",type:"u32",length:f.length}]),`
        ...
        ${r.mainStart(tW)}
          ...
          if (bsnh[3] < half_rotary_emb_dim) {
            let position_ids_idx =
                ${n.broadcastedIndicesToOffset("bsnh.xy",t0("",n.type.tensor,2))};
            let position_id =
  ...
  `}}),{inputs:[l,d],outputs:[-1]})[0],u=e.inputs[7],p=e.inputs[8],c=tq({interleaved:0!==r.rotaryInterleaved,numHeads:i.numHeads,rotaryEmbeddingDim:0,scale:r.scale}),m=[h,o,u,p],w=[-1];g=e.compute(aW(m,c),{inputs:m,outputs:w})[0],m.splice(0,1,f);let x=tq({interleaved:0!==r.rotaryInterleaved,numHeads:i.kvNumHeads,rotaryEmbeddingDim:0,scale:r.scale});y=e.compute(aW(m,x),{inputs:m,outputs:w})[0]}let w=aD(e,i.batchSize,i.numHeads,i.sequenceLength,i.headSize,r.doRotary?g:h,void 0,0),x=aG(e,r.doRotary?y:f,i),S=aG(e,m,i);rN(e,w,x,S,void 0,void 0,o,u,void 0,i,l,d)}}),s_=eo(()=>{nR(),nD(),nG(),nj(),aH=(e,r,i,a,n,s,o,u)=>{let l=tH(s),d=1===l?"f32":`vec${l}f`,p=1===l?"vec2f":`mat2x${l}f`,c=n*o,h=64;1===c&&(h=256);let f=[n,o,s/l],m=[n,o,2],g=[];return g.push(...tF(f,m)),e.compute({name:"InstanceNormComputeChannelScaleShift",shaderCache:{hint:`${l};${u};${h}`,inputDependencies:["rank","type","type"]},getRunData:()=>({outputs:[{dims:m,dataType:1}],dispatchGroup:{x:c},programUniforms:g}),getShaderSource:e=>{let n=tJ("x",r.dataType,3,l),s=[n,tJ("scale",i.dataType,i.dims),tJ("bias",a.dataType,a.dims),t0("output",1,3,2)];return`
  ...
  ${e.mainStart(h)}
    ...
    if (local_idx == 0) {
      let sum_final = ${tX("workgroup_shared[0][0]",l)} / f32(hight * ${l});
      let squared_sum_final = ${tX("workgroup_shared[0][1]",l)} / f32(hight * ${l});
  ...
  }`}},{inputs:[r,i,a],outputs:[-1]})[0]},aK=(e,r)=>{var i,a,n;let s,o,u,l,d,p,c,h,f;"NHWC"===r.format?((e,r,i)=>{let a=r[0].dims,n=a[0],s=a[a.length-1],o=th.sizeFromDimension(a,1)/s,u=tH(s),l=th.size(a)/u,d=[{type:12,data:o},{type:12,data:Math.floor(s/u)}],p=!1,c=[0,a.length-1];for(let e=0;e<a.length-2;e++)p=p||1!==a[e+1],c.push(e+1);let h=(p=p&&1!==a[a.length-1])?e.compute(t8(e.inputs[0],c),{inputs:[e.inputs[0]],outputs:[-1]})[0]:e.inputs[0].reshape(Array.from({length:a.length},(e,r)=>a[c[r]])),f=aH(e,h,r[1],r[2],n,o,s,i.epsilon);e.compute({name:"InstanceNormalizationNHWC",shaderCache:{hint:`${u}`,inputDependencies:["type","type"]},getRunData:()=>({outputs:[{dims:a,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:d}),getShaderSource:e=>{let i=tj(r[0].dataType),n=1===u?"vec2f":`mat${u}x2f`,s=e=>{let r=0===e?"x":"y",a=1===u?"f32":`vec${u}f`;switch(u){case 1:return`${i}(${a}(scale.${r}))`;case 2:return`vec2<${i}>(${a}(scale[0].${r}, scale[1].${r}))`;case 4:return`vec4<${i}>(${a}(scale[0].${r}, scale[1].${r}, scale[2].${r}, scale[3].${r}))`;default:throw Error(`Not supported compoents ${u}`)}},o=tJ("input",r[0].dataType,r[0].dims,u),l=t0("output",r[0].dataType,a,u);return`
  ...
  }`}},{inputs:[r[0],f]})})(e,e.inputs,r):(i=e,a=e.inputs,n=r,o=(s=a[0].dims)[0],u=s[1],l=th.sizeFromDimension(s,2),d=tH(l),p=th.size(s)/d,c=aH(i,a[0],a[1],a[2],o,l,u,n.epsilon),h=[o,u,l/d],f=[o,u],i.compute({name:"InstanceNormalization",shaderCache:{hint:`${d}`,inputDependencies:["type","none"]},getRunData:()=>({outputs:[{dims:s,dataType:a[0].dataType}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:[{type:12,data:p},...tF(h,f,h)]}),getShaderSource:e=>{let r=tJ("x",a[0].dataType,h.length,d),i=tJ("scale_shift",1,f.length,2),n=t0("output",a[0].dataType,h.length,d),s=[r,i,n];return`
  ...
  ${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
      ...
      ${n.setByOffset("global_idx","value")};
  }`}},{inputs:[a[0],c]}))}}),sb=eo(()=>{nR(),nD(),nj(),aZ=(e,r)=>{(e=>{if(!e||e.length<2)throw Error("layerNorm requires at least 2 inputs.")})(e.inputs),e.compute(((e,r,i)=>{let a=r.simplified,n=e[0].dims,s=e[1],o=!a&&e[2],u=th.normalizeAxis(r.axis,n.length),l=th.sizeToDimension(n,u),d=th.sizeFromDimension(n,u),p=th.size(s.dims),c=o?th.size(o.dims):0;if(p!==d||o&&c!==d)throw Error(`Size of X.shape()[axis:] == ${d}.
       Size of scale and bias (if provided) must match this.
       Got scale size of ${p} and bias size of ${c}`);let h=[];for(let e=0;e<n.length;++e)e<u?h.push(n[e]):h.push(1);let f=tH(d),m=["type","type"],g=[{type:12,data:l},{type:1,data:d},{type:12,data:Math.floor(d/f)},{type:1,data:r.epsilon}];o&&m.push("type");let y=i>1,_=i>2,b=[{dims:n,dataType:e[0].dataType}];return y&&b.push({dims:h,dataType:1}),_&&b.push({dims:h,dataType:1}),{name:"LayerNormalization",shaderCache:{hint:`${f};${i};${a}`,inputDependencies:m},getRunData:()=>({outputs:b,dispatchGroup:{x:Math.ceil(l/64)},programUniforms:g}),getShaderSource:r=>{let i=tj(e[0].dataType),u=[tJ("x",e[0].dataType,e[0].dims,f),tJ("scale",s.dataType,s.dims,f)];return o&&u.push(tJ("bias",o.dataType,o.dims,f)),u.push(t0("output",e[0].dataType,n,f)),y&&u.push(t0("mean_data_output",1,h)),_&&u.push(t0("inv_std_output",1,h)),`
  ...
  ${r.mainStart()}
    ...
    let mean = ${tX("mean_vector",f)} / uniforms.norm_size;
    let inv_std_dev = inverseSqrt(${tX("mean_square_vector",f)} / uniforms.norm_size ${a?"":"- mean * mean"} + uniforms.epsilon);
    ...
    ${_?"inv_std_output[global_idx] = inv_std_dev":""};
  }`}}})(e.inputs,r,e.outputCount))}}),s$=eo(()=>{nD(),n6(),n8(),aX=e=>{var r=e.inputs;if(!r||2!==r.length)throw Error("MatMul requires 2 inputs.");if(r[0].dims[r[0].dims.length-1]!==r[1].dims[r[1].dims.length-2])throw Error("shared dimension does not match.");let i=tc.calcShape(e.inputs[0].dims,e.inputs[1].dims,!0);if(!i)throw Error("Can't use matmul on the given tensors");let a=i[i.length-1],n=e.inputs[0].dims[e.inputs[0].dims.length-1];if(a<8&&n<8)e.compute(iq(e.inputs,{activation:""},i));else{let r=i[i.length-2],s=th.size(e.inputs[0].dims.slice(0,-2)),o=th.size(e.inputs[1].dims.slice(0,-2));if(1!==s&&1===r&&1===o){let r=e.inputs[0].reshape([1,s,n]),o=e.inputs[1].reshape([1,n,a]),u=[1,s,a],l=[r,o];e.compute(iG(l,{activation:""},i,u),{inputs:l})}else e.compute(iG(e.inputs,{activation:""},i))}}}),sv=eo(()=>{nR(),nD(),nV(),nj(),aQ=(e,r)=>{var i,a,n,s;let o,u,l,d,p,c,h,f,m,g,y,_,b,$,v,w,x,S,k,T,I,C,E,z,A,O,M,R,N,B,D,U,P,L,q,W,V,j,G,F,H,K;((e,r)=>{if(e.length<3||e.length>4)throw Error("MatMulNBits requires 3 or 4 inputs");let i=e[0],a=i.dims.length;if(i.dims[a-1]!==r.k)throw Error("The last dim of input shape does not match the k value");let n=Math.floor((r.k+r.blockSize-1)/r.blockSize),s=r.blockSize/8*r.bits,o=e[1];if(!th.areEqual(o.dims,[r.n,n,s]))throw Error("The second inputs must be 3D tensor with shape N X nBlocksPerCol X blobSize");let u=e[2].dims;if(th.size(u)!==r.n*n)throw Error("scales input size error.");if(4===e.length){let i=e[3].dims,a=r.n*(8===r.bits?n:Math.floor((n*r.bits+7)/8));if(th.size(i)!==a)throw Error("zeroPoints input size error.")}})(e.inputs,r),32===r.blockSize&&e.adapterInfo.isVendor("intel")&&e.adapterInfo.isArchitecture("gen-12lp")?e.compute((i=e.inputs,a=r,u=(o=i[0].dims).length,l=o[u-2],d=a.k,p=a.n,c=o.slice(0,u-2),h=th.size(c),f=i[1].dims[2]/4,m=i[0].dataType,g=tH(a.k),y=tH(f),_=c.concat([l,p]),$=128/(b=p%8==0?8:p%4==0?4:1),x=(w=$*y*(v=Math.floor(32/a.bits)))/g,S=w/a.blockSize,k=th.size(_)/b,T=[],I=[h,l,d/g],(C=th.convertShape(i[1].dims).slice()).splice(-1,1,f/y),T.push(...tF(I)),T.push(...tF(C)),T.push(...tF(i[2].dims)),4===i.length&&T.push(...tF(th.convertShape(i[3].dims))),E=[h,l,p],T.push(...tF(E)),{name:"BlockwiseMatMulNBits32",shaderCache:{hint:`${a.blockSize};${g};${y};${$};${b}`,inputDependencies:Array(i.length).fill("rank")},getRunData:()=>({outputs:[{dims:_,dataType:m}],dispatchGroup:{x:k},programUniforms:T}),getShaderSource:e=>{let r=I.length,n=tJ("a",i[0].dataType,r,g),s=tJ("b",12,C.length,y),o=tJ("scales",i[2].dataType,i[2].dims.length),u=[n,s,o],l=4===i.length?tJ("zero_points",12,i[3].dims.length):void 0;l&&u.push(l);let d=E.length,p=t0("output",i[0].dataType,d),c=tj(i[0].dataType),h=()=>{switch(g){case 1:return`
        ...
        }`}})):e.compute((n=e.inputs,s=r,A=(z=n[0].dims).length,O=z[A-2],M=s.k,R=s.n,N=z.slice(0,A-2),B=th.size(N),D=n[1].dims[2]/4,U=n[0].dataType,P=tH(s.k),L=tH(D),q=tH(R),W=N.concat([O,R]),V=O>1&&R/q%2==0?2:1,j=th.size(W)/q/V,G=[],F=[B,O,M/P],(H=th.convertShape(n[1].dims).slice()).splice(-1,1,D/L),G.push(...tF(F)),G.push(...tF(H)),G.push(...tF(n[2].dims)),4===n.length&&G.push(...tF(th.convertShape(n[3].dims))),K=[B,O,R/q],G.push(...tF(K)),{name:"MatMulNBits",shaderCache:{hint:`${s.blockSize};${s.bits};${P};${L};${q};${V};64`,inputDependencies:Array(n.length).fill("rank")},getRunData:()=>({outputs:[{dims:W,dataType:U}],dispatchGroup:{x:j},programUniforms:G}),getShaderSource:e=>{let r=F.length,i=tJ("a",n[0].dataType,r,P),a=tJ("b",12,H.length,L),o=tJ("scales",n[2].dataType,n[2].dims.length),u=[i,a,o],l=4===n.length?tJ("zero_points",12,n[3].dims.length):void 0;l&&u.push(l);let d=K.length,p=t0("output",n[0].dataType,d,q),c=tj(n[0].dataType),h=(()=>{switch(P){case 1:return`array<${c}, 8>`;case 2:return`mat4x2<${c}>`;case 4:return`mat2x4<${c}>`;default:throw Error(`${P}-component is not supported.`)}})(),f=Math.floor(32/s.bits),m=Math.floor(f/8);return`
        ...
        }`}}))},aY=e=>tq(e)}),sw=eo(()=>{nR(),nD(),nj(),aJ=(e,r)=>{let i,a,n,s;var o,u,l=e.inputs;if(!l||l.length<1)throw Error("Too few inputs");if(1!==l[0].dataType&&10!==l[0].dataType)throw Error("Input type must be float or float16.");if(l.length>=2){let e=2*l[0].dims.length===l[1].dims[0];if(4===l.length&&(e=2*l[3].dims[0]===l[1].dims[0]),!e)throw Error("The pads should be a 1D tensor of shape [2 * input_rank] or [2 * num_axes].")}let d=((e,r)=>{if(!(e.length>1))return r;{let i=e[1].getBigInt64Array(),a=e.length>=3&&e[2].data?10===e[2].dataType?e[2].getUint16Array()[0]:e[2].getFloat32Array()[0]:0,n=e[0].dims.length,s=new Int32Array(2*n).fill(0);if(e.length>=4){let r=e[3].getBigInt64Array();for(let e=0;e<r.length;e++)s[Number(r[e])]=Number(i[e]),s[Number(r[e])+n]=Number(i[e+r.length])}else i.forEach((e,r)=>s[Number(r)]=Number(e));let o=[];return s.forEach(e=>o.push(e)),{mode:r.mode,value:a,pads:o}}})(e.inputs,r);e.compute((o=e.inputs,u=d,i=th.padShape(o[0].dims.slice(),u.pads),a=o[0].dims,n=[{type:12,data:th.size(i)},{type:6,data:u.pads}],s=o.length>=3&&o[2].data,0===u.mode&&n.push({type:s?o[2].dataType:1,data:u.value}),n.push(...tF(o[0].dims,i)),{name:"Pad",shaderCache:{hint:`${u.mode}${s}`,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:i,dataType:o[0].dataType}],dispatchGroup:{x:Math.ceil(th.size(i)/64)},programUniforms:n}),getShaderSource:e=>{let r=t0("output",o[0].dataType,i.length),n=tJ("x",o[0].dataType,a.length),l=n.type.value,d=((e,r,i)=>{switch(i.mode){case 0:var a=e,n=r,s=i.pads.length;let o="";for(let e=n-1;e>=0;--e)o+=`
            k = i32(${a.indicesGet("indices",e)}) - ${tQ("uniforms.pads",e,s)};
            if (k < 0) {
              break;
            }
            if (k >= i32(${tQ("uniforms.x_shape",e,n)})) {
              break;
            }
            offset += k * i32(${tQ("uniforms.x_strides",e,n)});
        `;return`
      ...
      `;case 1:var u=e,l=r,d=i.pads.length;let p="";for(let e=l-1;e>=0;--e)p+=`
                k = i32(${u.indicesGet("indices",e)}) - ${tQ("uniforms.pads",e,d)};
                if (k < 0) {
                  k = -k;
                }
                {
                  let _2n_1 = 2 * (i32(${tQ("uniforms.x_shape",e,l)}) - 1);
                  k = k % _2n_1;
                  if(k >= i32(${tQ("uniforms.x_shape",e,l)})) {
                    k = _2n_1 - k;
                  }
                }
                offset += k * i32(${tQ("uniforms.x_strides",e,l)});
            `;return`
              var offset = 0;
              var k = 0;
              ${p}
          ...
          `;case 2:var c=e,h=r,f=i.pads.length;let m="";for(let e=h-1;e>=0;--e)m+=`
                k = i32(${c.indicesGet("indices",e)}) - ${tQ("uniforms.pads",e,f)};
                if (k < 0) {
                  k = 0;
                }
                if (k >= i32(${tQ("uniforms.x_shape",e,h)})) {
                  k = i32(${tQ("uniforms.x_shape",e,h)}) - 1;
                }
                offset += k * i32(${tQ("uniforms.x_strides",e,h)});
            `;return`
              var offset = 0;
              var k = 0;
              ${m}
          ...
          `;case 3:var g=e,y=r,_=i.pads.length;let b="";for(let e=y-1;e>=0;--e)b+=`
                k = i32(${g.indicesGet("indices",e)}) - ${tQ("uniforms.pads",e,_)};
                if (k < 0)  {
                  k += i32(${tQ("uniforms.x_shape",e,y)}]);
                }
                if (k >= i32(${tQ("uniforms.x_shape",e,y)})) {
                  k -= i32(${tQ("uniforms.x_shape",e,y)});
                }
                offset += k * i32(${tQ("uniforms.x_strides",e,y)});
            `;return`
              var offset = 0;
              var k = 0;
              ${b}
            ...
            ${e.mainStart()}
              ...
              for (var i: u32 = 0u; i < uniforms.kernelSize; i++) {
                ...
                for (var j = 0u; j < ${a-1}u; j++) {
                  offsets[j] = offset / ${tQ("uniforms.kernelStrides","j",a)};
                  offset -= offsets[j] * ${tQ("uniforms.kernelStrides","j",a)};
                }
                offsets[${a-1}] = offset;

                isPad = false;
                for (var j = ${i-a}u; j < ${i}u; j++) {
                  xIndices[j] = indices[j] * ${tQ("uniforms.strides",`j - ${i-a}u`,a)}
                    + offsets[j - ${i-a}u] - ${tQ("uniforms.pads","j - 2u",p)};
                  ${c}
              }
              ${o}

              output[global_idx] = value;
            }`}},a4=e=>`${e.format};${e.ceilMode};${e.autoPad};${e.kernelShape.length}`,a6=e=>({format:e.format,autoPad:["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],ceilMode:e.ceil_mode,kernelShape:e.kernel_shape,strides:e.strides,pads:e.pads}),a8=(e,r,i,a)=>{let[n,s]=a1(r,a,i),o=tJ("x",r.dataType,r.dims.length),u=o.type.value,l="";n.countIncludePad?l+=`value /= ${u}(uniforms.kernelSize);`:l+=`value /= ${u}(i32(uniforms.kernelSize) - pad);`;let[d,p,c,h,f]=a2(s,n);return d.push(...tF(r.dims,s)),{name:e,shaderCache:{hint:`${a.cacheKey};${c};${h};${f}`,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:s,dataType:r.dataType}],dispatchGroup:{x:Math.ceil(th.size(s)/64)},programUniforms:d}),getShaderSource:e=>a3(e,o,r.dims.length,s.length,n,"value += x_val;",l,0,p,c,h,f)}},a5=e=>{let r,i=0!==e.count_include_pad,a=a6(e);if(0!==a.ceilMode)throw Error("using ceil() in shape computation is not yet supported for AveragePool");let n={countIncludePad:i,...a,cacheKey:""};return{...n,cacheKey:(r=n,`${a4(r)};${r.countIncludePad}`)}},a9=(e,r)=>{a0(e.inputs),e.compute(a8("AveragePool",e.inputs[0],!1,r))},a7={autoPad:"",ceilMode:0,countIncludePad:!1,kernelShape:[],strides:[],pads:[],storageOrder:0,dilations:[]},ne=e=>{let r=e.format;return{format:r,...a7,cacheKey:r}},nt=(e,r)=>{a0(e.inputs),e.compute(a8("GlobalAveragePool",e.inputs[0],!0,r))},nr=(e,r,i,a)=>{let[n,s]=a1(r,a,i),o=`
      value = max(x_val, value);
    `,u=tJ("x",r.dataType,r.dims.length),[l,d,p,c,h]=a2(s,n);return l.push(...tF(r.dims,s)),{name:e,shaderCache:{hint:`${a.cacheKey};${p};${c};${h}`,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:s,dataType:r.dataType}],dispatchGroup:{x:Math.ceil(th.size(s)/64)},programUniforms:l}),getShaderSource:e=>a3(e,u,r.dims.length,s.length,n,o,"",10===r.dataType?-65504:-1e5,d,p,c,h)}},ni=(e,r)=>{a0(e.inputs),e.compute(nr("MaxPool",e.inputs[0],!1,r))},na=e=>{let r,i=e.storage_order,a=e.dilations,n=a6(e);if(0!==i)throw Error("column major storage order is not yet supported for MaxPool");if(0!==n.ceilMode)throw Error("using ceil() in shape computation is not yet supported for MaxPool");let s={storageOrder:i,dilations:a,...n,cacheKey:""};return{...s,cacheKey:(r=s,`${a4(r)};${r.storageOrder};${r.dilations}`)}},nn=e=>{let r=e.format;return{format:r,...a7,cacheKey:r}},ns=(e,r)=>{a0(e.inputs),e.compute(nr("GlobalMaxPool",e.inputs[0],!0,r))}}),sS=eo(()=>{nR(),nD(),nV(),nj(),no=(e,r)=>{var i,a;let n,s,o,u,l,d,p,c,h,f,m,g,y,_,b,$,v,w,x,S,k,T,I;((e,r)=>{if(e.length<2||e.length>3)throw Error("DequantizeLinear requires 2 or 3 inputs.");if(3===e.length&&e[1].dims===e[2].dims)throw Error("x-scale and x-zero-point must have the same shape.");if(3===e.length&&e[0].dataType!==e[2].dataType)throw Error("x and x-zero-point must have the same data type.");if(0!==e[1].dims.length&&1!==e[1].dims.length&&e[1].dims.length!==e[0].dims.length)throw Error("scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.");if(e.length>2){if(e[0].dataType!==e[2].dataType)throw Error("x and x-zero-point must have the same data type.");if(e[1].dims.length!==e[2].dims.length)throw Error("scale and zero-point inputs must have the same rank.");if(!e[1].dims.map((r,i)=>r===e[2].dims[i]).reduce((e,r)=>e&&r,!0))throw Error("scale and zero-point inputs must have the same shape.")}if(r.blockSize>0){if(0===e[1].dims.length||1===e[1].dims.length&&1===e[1].dims[0])throw Error("blockSize must be set only for block quantization.");if(!e[1].dims.map((i,a)=>a===r.axis||i===e[0].dims[a]).reduce((e,r)=>e&&r,!0))throw Error("For block qunatization, scale input shape to match the input shape except for the axis");if(e[1].dims.length!==e[0].dims.length)throw Error("For block qunatization the scale input rank must be the same as the x rank.");let i=e[0].dims[r.axis],a=e[1].dims[r.axis];if(r.blockSize<Math.ceil(i/a)||r.blockSize>Math.ceil(i/(a-1)-1))throw Error("blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].")}})(e.inputs,r),e.compute((i=e.inputs,a=r,n=th.normalizeAxis(a.axis,i[0].dims.length),o=3===(s=i[0].dataType),u=i[0].dims,l=i[1].dataType,d=th.size(u),c=(p=3===s||2===s)?[Math.ceil(th.size(i[0].dims)/4)]:i[0].dims,h=i[1].dims,m=(f=i.length>2?i[2]:void 0)?p?[Math.ceil(th.size(f.dims)/4)]:f.dims:void 0,y=!1==(g=0===h.length||1===h.length&&1===h[0])&&1===h.length,_=tH(d),$=(b=g&&(!p||4===_))?_:1,v=tJ("input",p?12:s,c.length,b&&!p?_:1),w=tJ("scale",l,h.length),x=f?tJ("zero_point",p?12:s,m.length):void 0,S=t0("output",l,u.length,$),k=[v,w],x&&k.push(x),T=[c,h],f&&T.push(m),I=[{type:12,data:d/$},{type:12,data:n},{type:12,data:a.blockSize},...tF(...T,u)],{name:"DequantizeLinear",shaderCache:{hint:a.cacheKey,inputDependencies:x?["rank","rank","rank"]:["rank","rank"]},getShaderSource:e=>`
      ...
      }`,getRunData:()=>({outputs:[{dims:u,dataType:l}],dispatchGroup:{x:Math.ceil(d/$/64),y:1,z:1},programUniforms:I})}))},nu=e=>tq({axis:e.axis,blockSize:e.blockSize})}),sk=eo(()=>{eC(),nR(),nj(),nl=e=>{var r,i,a,n;let s,o,u,l=0,d=0,p=0;6===e.inputs[0].dataType?(l=e.inputs[0].getInt32Array()[0],d=e.inputs[1].getInt32Array()[0],p=e.inputs[2].getInt32Array()[0]):1===e.inputs[0].dataType&&(l=e.inputs[0].getFloat32Array()[0],d=e.inputs[1].getFloat32Array()[0],p=e.inputs[2].getFloat32Array()[0]),A.webgpu.validateInputContent&&((e,r,i)=>{if(e===r||e<r&&i<0||e>r&&i>0)throw Error("Range these inputs' contents are invalid.")})(l,d,p),e.compute((r=l,i=d,a=p,n=e.inputs[0].dataType,o=[s=Math.abs(Math.ceil((i-r)/a))],u=[{type:12,data:s},{type:n,data:r},{type:n,data:a},...tF(o)],{name:"Range",shaderCache:{hint:`${n}`},getShaderSource:e=>{let r=t0("output",n,o.length),i=r.type.value;return`
      ...
      }`},getRunData:()=>({outputs:[{dims:o,dataType:n}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:u})}),{inputs:[]})}}),sT=eo(()=>{nR(),nD(),nV(),nj(),nd=e=>tq({reduction:e.reduction}),np=(e,r)=>{var i,a;let n,s,o,u,l,d;e.compute((i=e.inputs,a=r,n=i[0].dims,s=i[1].dims,o=Math.ceil(th.sizeToDimension(s,s.length-1)/1),u=s[s.length-1],l=th.sizeFromDimension(n,u),d=[{type:12,data:o},{type:12,data:u},{type:12,data:l},...tF(i[1].dims,i[2].dims,n)],{name:"ScatterND",shaderCache:{hint:`${a.cacheKey}_${a.reduction}`,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:n,dataType:i[0].dataType}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:d}),getShaderSource:e=>{let r=tJ("indices",i[1].dataType,i[1].dims.length),s=tJ("updates",i[2].dataType,i[2].dims.length,1),o="none"!==a.reduction&&""!==a.reduction?t1("output",i[0].dataType,n.length):t0("output",i[0].dataType,n.length,1);return`
  ...
  for (var i = 0u; i < uniforms.num_updates_elements; i++) {
    ...
    ${((e,r,i,a)=>{if("none"!==e&&"i32"!==a&&"u32"!==a&&"f32"!==a)throw Error(`Input ${a} is not supported with reduction ${e}.`);let n=`{
      ...
      }`}}),{inputs:[e.inputs[1],e.inputs[2]],outputs:[]})}}),sI=eo(()=>{nR(),nD(),nV(),nj(),nc=(e,r,i,a)=>`
...
`:"",nf=(e,r)=>{var i,a,n,s,o,u,l,d,p,c,h,f;let m,g,y,_,b,$,v,w,x,S,k,T,I,C,E,z,A=[],O=[],M=[],R=new Uint32Array(m=e.customDataBuffer,m.byteOffset,1)[0];if(0!==r.antialias)throw Error("Only default value (0) for Antialias attribute is supported");((e,r,i,a,n,s)=>{let[o,u,l]=i>10?[1,2,3]:[-1,e.length>1?1:-1,-1],d=e[0].dims.length;if(o>0&&e.length>o&&e[o].dims.length>0)e[o].getFloat32Array().forEach(e=>s.push(e));else if("tf_crop_and_resize"===r.coordinateTransformMode)throw Error("Resize requires RoI input to be specified when coordinateTransformMode is tfCropAndResize");if(u>0&&e.length>u&&1===e[u].dims.length&&e[u].dims[0]>0){var p,c,h;let n;if(e[u].getFloat32Array().forEach(e=>a.push(e)),0!==a.length&&a.length!==d&&i>=18&&a.length!==r.axes.length)throw Error("Resize requires scales input size to be same as input rank or axes size for opset 18 and up");((e,r)=>{if(e.every(e=>e>0||(()=>{throw Error("Resize requires scales input values to be positive")})),e.length>0){if("linear"===r.mode){if(2!==e.length&&3!==e.length&&(4!==e.length||1!==e[0]||1!==e[1])&&(4!==e.length||1!==e[0]||1!==e[3])&&(5!==e.length||1!==e[0]||1!==e[1]))throw Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
     ...
     lengthOriginal: u32, roiStart: f32, roiEnd: f32) -> ${i} { `+(()=>{switch(r){case"asymmetric":return`
          if (xScale < 1.0 || floor(xScale) != xScale) {
            ...
            ${nc("xResized","lengthOriginal","lengthResized",i)}
          }
        `;case"pytorch_half_pixel":return`if (lengthResized > 1) {
                    ...
                    ${nc("xResized","lengthOriginal - 1","lengthResized - 1",i)}
    ...
    fn checkInputIndices(input_indices: ${e.type.indices}) -> bool {
      for (var i:u32 = 0; i < ${r.length}; i++) {
        ...
        if (input_index < 0 || input_index >= ${tQ("uniforms.input_shape","i",r.length)}) {
          return false;
        }
      }
      return true;
    ...
    fn calculateInputIndicesFromOutputIndices(output_indices: ${l.type.indices}) -> ${u.type.indices} {
      ...
      for (var i:u32 = 0; i < ${p.length}; i++) {
        ...
        var input_index: u32;
        var scale = ${tQ("uniforms.scales","i",c)};
        if (scale == 1.0) {
          input_index = output_index;
        } else {
          var roi_low = ${tQ("uniforms.roi","i",h)};
          var roi_hi = ${tQ("uniforms.roi",`i + ${d.length}`,h)};
          var input_shape_i = ${tQ("uniforms.input_shape","i",d.length)};
          var output_shape_i = ${tQ("uniforms.output_shape","i",p.length)};
    ...
    fn calculateOriginalIndicesFromOutputIndices(output_indices: ${m.type.indices}) -> array<${m.type.value}, ${y.length}> {
      ...
      for (var i:u32 = 0; i < ${y.length}; i++) {
        ...
        var scale = ${tQ("uniforms.scales","i",w)};
        var roi_low = ${tQ("uniforms.roi","i",x)};
        var roi_hi = ${tQ("uniforms.roi",`i + ${g.length}`,x)};
        if (scale == 1.0) {
          original_indices[i] = ${m.type.value}(output_index);
        } else {
          var input_shape_i = ${tQ("uniforms.input_shape","i",g.length)};
          var output_shape_i = ${tQ("uniforms.output_shape","i",y.length)};
...
`}
      }`},getRunData:()=>({outputs:[{dims:$,dataType:i.dataType}],dispatchGroup:{x:Math.ceil(T/64)},programUniforms:[{type:12,data:T},{type:1,data:v},{type:1,data:b},...tF(_,$)]})}),{inputs:[0]})},nm=e=>{let r=e.antialias,i=e.axes,a=e.coordinateTransformMode,n=e.cubicCoeffA,s=0!==e.excludeOutside,o=e.extrapolationValue,u=e.keepAspectRatioPolicy,l=e.mode,d=""===e.nearestMode?"simple":e.nearestMode;return tq({antialias:r,axes:i,coordinateTransformMode:a,cubicCoeffA:n,excludeOutside:s,extrapolationValue:o,keepAspectRatioPolicy:u,mode:l,nearestMode:d})}}),sC=eo(()=>{nR(),nD(),nj(),ng=(e,r)=>{var i,a,n,s;let o,u,l,d,p,c,h,f,m,g,y,_,b;(e=>{if(!e||e.length<3)throw Error("layerNorm requires at least 3 inputs.");let r=e[0],i=e[1],a=e[2];if(r.dataType!==i.dataType||r.dataType!==a.dataType)throw Error("All inputs must have the same data type");if(3!==r.dims.length&&2!==r.dims.length)throw Error("Input must be 2D or 3D");if(3!==i.dims.length&&2!==i.dims.length)throw Error("Skip must be 2D or 3D");let n=r.dims[r.dims.length-1],s=r.dims[r.dims.length-2];if(i.dims[i.dims.length-1]!==n)throw Error("Skip must have the same hidden size as input");if(i.dims[i.dims.length-2]!==s)throw Error("Skip must have the same sequence length as input");if(1!==a.dims.length)throw Error("Gamma must be 1D");if(a.dims[a.dims.length-1]!==n)throw Error("Gamma must have the same hidden size as input");if(e.length>3){let r=e[3];if(1!==r.dims.length)throw Error("Beta must be 1D");if(r.dims[r.dims.length-1]!==n)throw Error("Beta must have the same hidden size as input")}if(e.length>4){let r=e[4];if(1!==r.dims.length)throw Error("Bias must be 1D");if(r.dims[r.dims.length-1]!==n)throw Error("Bias must have the same hidden size as input")}})(e.inputs);let $=[0];e.outputCount>1&&$.push(-3),e.outputCount>2&&$.push(-3),e.outputCount>3&&$.push(3),e.compute((i=e.inputs,a=r,n=e.outputCount,s=!1,o=a.simplified,u=i[0].dims,l=th.size(u),d=u.slice(-1)[0],p=s?u.slice(0,-1).concat(1):[],c=!o&&i.length>3,h=i.length>4,f=s&&n>1,m=s&&n>2,g=n>3,_=[{type:12,data:l},{type:12,data:y=tH(d)},{type:12,data:d},{type:1,data:a.epsilon}],b=[{dims:u,dataType:i[0].dataType}],n>1&&b.push({dims:p,dataType:1}),n>2&&b.push({dims:p,dataType:1}),n>3&&b.push({dims:u,dataType:i[0].dataType}),{name:"SkipLayerNormalization",shaderCache:{hint:`${y};${f};${m};${g}`,inputDependencies:i.map((e,r)=>"type")},getShaderSource:e=>{let r=[tJ("x",i[0].dataType,i[0].dims,y),tJ("skip",i[1].dataType,i[1].dims,y),tJ("gamma",i[2].dataType,i[2].dims,y)];c&&r.push(tJ("beta",i[3].dataType,i[3].dims,y)),h&&r.push(tJ("bias",i[4].dataType,i[4].dims,y)),r.push(t0("output",i[0].dataType,u,y)),f&&r.push(t0("mean_output",1,p)),m&&r.push(t0("inv_std_output",1,p)),g&&r.push(t0("input_skip_bias_sum",i[0].dataType,u,y));let a=tj(i[0].dataType),n=tj(1,y);return`
      ...
      ${e.mainStart([64,1,1])}
        ...
        let mean = ${tX("sum",y)} / f32(uniforms.hidden_size);
        let inv_std_dev = inverseSqrt(${tX("square_sum",y)} / f32(uniforms.hidden_size) ${o?"":"- mean * mean"} + uniforms.epsilon);
      ...
      }`},getRunData:()=>({outputs:b,dispatchGroup:{x:Math.ceil(l/d)},programUniforms:_})}),{outputs:$})}}),sE=eo(()=>{nR(),nD(),nV(),nj(),ny=(e,r)=>{let i=[];if(e.length>r)if(7===e[r].dataType)e[r].getBigInt64Array().forEach(e=>i.push(Number(e)));else if(6===e[r].dataType)e[r].getInt32Array().forEach(e=>i.push(Number(e)));else throw Error(`Input ${r} must be an array of int32 or int64`);return i},n_=(e,r,i,a,n)=>{let s=e;return e<0&&(s+=i[a[r]]),n[r]<0?Math.max(0,Math.min(s,i[a[r]]-1)):Math.max(0,Math.min(s,i[a[r]]))},nb=(e,r)=>{var i=e.inputs,a=r;if(!i||i.length<1)throw Error("too few inputs");if(0!==a.axes.length){if(a.axes.length!==a.starts.length||a.axes.length!==a.ends.length)throw Error("axes, starts and ends must have the same length")}else if(a.starts.length!==a.ends.length)throw Error("starts and ends must have the same length");i.slice(1).forEach((e,r)=>{if(6!==i[r+1].dataType&&7!==i[r+1].dataType)throw Error(`Input ${r} must be an array of int32 or int64`)});let n=((e,r)=>{if(!(e.length>1))return r;{let r=ny(e,1),i=ny(e,2),a=ny(e,3);return 0===a.length&&(a=[...Array(e[0].dims.length).keys()]),tq({starts:r,ends:i,axes:a})}})(e.inputs,r);e.compute(((e,r)=>{let i=e[0].dims,a=th.size(i),n=r.axes.length>0?th.normalizeAxes(r.axes,i.length):[...Array(i.length).keys()],s=ny(e,4);s.forEach(e=>0!==e||(()=>{throw Error("step cannot be 0")})),0===s.length&&(s=Array(n.length).fill(1));let o=r.starts.map((e,r)=>n_(e,r,i,n,s)),u=r.ends.map((e,r)=>n_(e,r,i,n,s));if(n.length!==o.length||n.length!==u.length)throw Error("start, ends and axes should have the same number of elements");if(n.length!==i.length)for(let e=0;e<i.length;++e)n.includes(e)||(o.splice(e,0,0),u.splice(e,0,i[e]),s.splice(e,0,1));let l=s.map(e=>Math.sign(e));s.forEach((e,r,i)=>{if(e<0){let a=(u[r]-o[r])/e,n=o[r],l=n+a*s[r];o[r]=l,u[r]=n,i[r]=-e}});let d=i.slice(0);n.forEach((e,r)=>{d[e]=Math.ceil((u[e]-o[e])/s[e])});let p={dims:d,dataType:e[0].dataType},c=t0("output",e[0].dataType,d.length),h=tJ("input",e[0].dataType,e[0].dims.length),f=th.size(d),m=[{name:"outputSize",type:"u32"},{name:"starts",type:"u32",length:o.length},{name:"signs",type:"i32",length:l.length},{name:"steps",type:"u32",length:s.length}],g=[{type:12,data:f},{type:12,data:o},{type:6,data:l},{type:12,data:s},...tF(e[0].dims,d)];return{name:"Slice",shaderCache:{hint:`${l.length}_${o.length}_${s.length}`,inputDependencies:["rank"]},getShaderSource:e=>{let r,a,n;return`
      ${e.registerUniforms(m).declareVariables(h,c)}
        ${r=h,a=c,n=i,`fn calculateInputIndices(output_indices: ${a.type.indices}) -> ${r.type.indices} {
          ...
          for (var i = ${n.length-1}; i >= 0; i--) {
            let input_shape_i = ${tQ("uniforms.input_shape","i",n.length)};
            let steps_i = ${tQ("uniforms.steps","i",n.length)};
            let signs_i = ${tQ("uniforms.signs","i",n.length)};
            let starts_i = ${tQ("uniforms.starts","i",n.length)};
      ...
      }`},getRunData:()=>({outputs:[p],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:g})}})(e.inputs,n),{inputs:[0]})},n$=e=>{let r=e.starts,i=e.ends,a=e.axes;return tq({starts:r,ends:i,axes:a})}}),sz=eo(()=>{nR(),nD(),nV(),nG(),nj(),nv=(e,r)=>{var i,a;let n,s,o,u,l,d,p,c,h,f,m,g,y,_,b,$,v,w,x;(e=>{if(!e||1!==e.length)throw Error("Softmax op requires 1 input.")})(e.inputs),i=e,a=r,s=(n=i.inputs[0]).dims,o=th.size(s),u=s.length,d=(l=th.normalizeAxis(a.axis,u))<s.length-1,c=[],d?((c=Array.from({length:u},(e,r)=>r))[l]=u-1,c[u-1]=l,p=i.compute(t8(n,c),{inputs:[n],outputs:[-1]})[0]):p=n,m=o/(f=(h=p.dims)[u-1]),g=tH(f),y=f/g,_=64,1===m&&(_=256),b=tJ("x",p.dataType,p.dims,g),$=t0("result",p.dataType,p.dims,g),v=b.type.value,w="f32"===tj(p.dataType)?`var threadMax = ${v}(-3.4028234663852886e+38f);`:`var threadMax = ${v}(-65504.0h);`,x=i.compute({name:"Softmax",shaderCache:{hint:`${g};${_}`,inputDependencies:["type"]},getRunData:()=>({outputs:[{dims:h,dataType:p.dataType}],dispatchGroup:{x:m},programUniforms:[{type:6,data:y}]}),getShaderSource:e=>{let r;return`
      ...
      ${e.mainStart(_)}
        ...
        if (lindex == 0) {
          rowSumShared = ${v}(${tX("threadShared[0]",g)});
        }
        workgroupBarrier();
      ...
      }`}},{inputs:[p],outputs:[d?-1:0]})[0],d&&i.compute(t8(x,c),{inputs:[x]})},nw=e=>tq({axis:e.axis})}),sA=eo(()=>{nR(),nD(),nj(),nx=e=>Array.from(e.getBigInt64Array(),Number),nS=e=>{var r,i;let a,n,s,o,u,l,d;(e=>{if(!e||2!==e.length)throw Error("Tile requires 2 inputs.");if(1!==e[0].dataType&&10!==e[0].dataType&&6!==e[0].dataType&&12!==e[0].dataType)throw Error("Tile only support float, float16, int32, and uint32 data types");if(7!==e[1].dataType)throw Error("Tile `repeats` input should be of int64 data type");if(1!==e[1].dims.length)throw Error("Tile `repeats` input should be 1-D");if(nx(e[1]).length!==e[0].dims.length)throw Error("Tile `repeats` input should have same number of elements as rank of input data tensor")})(e.inputs),e.compute((a=(r=e.inputs)[0].dims,s=((e,r)=>{let i=[];for(let a=0;a<e.length;++a)i.push(e[a]*r[a]);return i})(a,n=i??nx(r[1])),o=th.size(s),u=r[0].dataType,l=tJ("input",u,a.length),d=t0("output",u,s.length),{name:"Tile",shaderCache:{hint:`${n}`,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:s,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:[{type:12,data:o},...tF(r[0].dims,s)]}),getShaderSource:e=>`
      ...
      ${d.setByOffset("global_idx",l.getByIndices("input_indices"))}
    }`}),{inputs:[0]})}}),sO=eo(()=>{nR(),nD(),nj(),nk=e=>{e.compute((e=>{let r=e[1].dims,i=e[2].dims,a=e[0].dims,n=e[1].dataType,s=!(th.areEqual(r,i)&&th.areEqual(i,a)),o=r,u=th.size(r);if(s){let e=tc.calcShape(tc.calcShape(r,i,!1),a,!1);if(!e)throw Error("Can't perform where op on the given tensors");o=e,u=th.size(o)}let l=Math.ceil(u/4);return{name:"Where",shaderCache:{inputDependencies:["rank","rank","rank"]},getShaderSource:r=>((e,r,i,a,n)=>{let s=t0("output_data",n,i.length,4),o=tJ("a_data",r[1].dataType,r[1].dims.length,4),u=tJ("b_data",r[2].dataType,r[2].dims.length,4),l=tJ("c_data",r[0].dataType,r[0].dims.length,4),d,p=(e,r,i)=>`select(${r}, ${e}, ${i})`;if(a){let e=(e,r,i="")=>{let a=`a_data[index_a${r}][component_a${r}]`,n=`b_data[index_b${r}][component_b${r}]`,d=`bool(c_data[index_c${r}] & (0xffu << (component_c${r} * 8)))`;return`
        ...
        ${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.vec_size")}
        ${d}
      }`})(r,e,o,s,n),getRunData:()=>({outputs:[{dims:o,dataType:n}],dispatchGroup:{x:Math.ceil(u/64/4)},programUniforms:[{type:12,data:l},...tF(a,r,i,o)]})}})(e.inputs))}}),sM=eo(()=>{nK(),nZ(),nX(),nQ(),nJ(),n0(),n1(),se(),sr(),si(),sa(),sn(),ss(),so(),su(),sl(),sd(),sp(),sc(),sh(),sy(),s_(),sb(),s$(),sv(),sf(),sw(),sx(),sS(),sk(),sT(),nH(),sI(),sg(),sC(),sE(),sz(),sm(),sA(),nG(),nY(),sO(),nT=new Map([["Abs",[rL]],["Acos",[rq]],["Acosh",[rW]],["Add",[iv]],["ArgMax",[rO,rM]],["ArgMin",[rA,rM]],["Asin",[rV]],["Asinh",[rj]],["Atan",[rG]],["Atanh",[rF]],["Attention",[rB]],["AveragePool",[a9,a5]],["BatchNormalization",[rD]],["BiasAdd",[rU]],["BiasSplitGelu",[ib]],["Cast",[rK,rH]],["Ceil",[rX]],["Clip",[rZ]],["Concat",[iA,iO]],["Conv",[i4,i2]],["ConvTranspose",[at,i7]],["Cos",[rQ]],["Cosh",[rY]],["CumSum",[ar,ai]],["DepthToSpace",[aa,an]],["DequantizeLinear",[no,nu]],["Div",[iw]],["Einsum",[ac,ah]],["Elu",[r0,rJ]],["Equal",[ix]],["Erf",[r2]],["Exp",[r3]],["Expand",[am]],["FastGelu",[ag]],["Floor",[r4]],["FusedConv",[i4,i2]],["Gather",[a_,ay]],["GatherElements",[aS,ax]],["GatherBlockQuantized",[av,aw]],["GatherND",[ab,a$]],["Gelu",[r6]],["Gemm",[aT,ak]],["GlobalAveragePool",[nt,ne]],["GlobalMaxPool",[ns,nn]],["Greater",[iI]],["GreaterOrEqual",[iE]],["GridSample",[aO,aM]],["GroupQueryAttention",[aF]],["HardSigmoid",[ii,ir]],["InstanceNormalization",[aK]],["LayerNormalization",[aZ]],["LeakyRelu",[r8,rJ]],["Less",[iC]],["LessOrEqual",[iz]],["Log",[ig]],["MatMul",[aX]],["MatMulNBits",[aQ,aY]],["MaxPool",[ni,na]],["Mul",[iS]],["MultiHeadAttention",[aU,aN]],["Neg",[r9]],["Not",[r5]],["Pad",[aJ]],["Pow",[ik]],["QuickGelu",[i_,rJ]],["Range",[nl]],["Reciprocal",[r7]],["ReduceMin",[rk]],["ReduceMean",[r$]],["ReduceMax",[rS]],["ReduceSum",[rI]],["ReduceProd",[rT]],["ReduceL1",[rv]],["ReduceL2",[rw]],["ReduceLogSum",[rE]],["ReduceLogSumExp",[rx]],["ReduceSumSquare",[rC]],["Relu",[ie]],["Resize",[nf,nm]],["RotaryEmbedding",[aV]],["ScatterND",[np,nd]],["Sigmoid",[it]],["Sin",[ia]],["Sinh",[is]],["Slice",[nb,n$]],["SkipLayerNormalization",[ng]],["Split",[aL,aq]],["Sqrt",[io]],["Softmax",[nv,nw]],["Sub",[iT]],["Tan",[iu]],["Tanh",[id]],["ThresholdedRelu",[im,rJ]],["Tile",[nS]],["Transpose",[t5,t9]],["Where",[nk]]])}),sR=eo(()=>{eC(),nB(),nj(),nI=class{constructor(e){this.backend=e,this.repo=new Map,this.attributesBound=!1}getArtifact(e){return this.repo.get(e)}setArtifact(e,r){this.repo.set(e,r)}run(e,r,i,a,n){X(e.programInfo.name);let s=this.backend.device,o=this.backend.getComputePassEncoder();this.backend.writeTimestamp(2*this.backend.pendingDispatchNumber);let u=[];for(let e of r)u.push({binding:u.length,resource:{buffer:e.buffer}});for(let e of i)u.push({binding:u.length,resource:{buffer:e.buffer}});n&&u.push({binding:u.length,resource:n});let l=s.createBindGroup({layout:e.computePipeline.getBindGroupLayout(0),entries:u,label:e.programInfo.name});if("capturing"===this.backend.sessionStatus){let r={kernelId:this.backend.currentKernelId,computePipeline:e.computePipeline,bindGroup:l,dispatchGroup:a};this.backend.capturedCommandList.get(this.backend.currentSessionId).push(r)}o.setPipeline(e.computePipeline),o.setBindGroup(0,l),o.dispatchWorkgroups(...a),this.backend.writeTimestamp(2*this.backend.pendingDispatchNumber+1),this.backend.pendingDispatchNumber++,(this.backend.pendingDispatchNumber>=this.backend.maxDispatchNumber||"at-passes"===this.backend.queryType)&&this.backend.endComputePass(),this.backend.pendingDispatchNumber>=this.backend.maxDispatchNumber&&this.backend.flush(),Q(e.programInfo.name)}dispose(){}build(e,r){X(e.name);let i=this.backend.device,a=[];[{feature:"shader-f16",extension:"f16"},{feature:"subgroups",extension:"subgroups"}].forEach(e=>{i.features.has(e.feature)&&a.push(`enable ${e.extension};`)});let n=t4(r,this.backend.device.limits),s=e.getShaderSource(n),o=`${a.join(`
`)}
${n.additionalImplementations}
${s}`,u=i.createShaderModule({code:o,label:e.name});td("verbose",()=>`[WebGPU] ${e.name} shader code: ${o}`);let l=i.createComputePipeline({compute:{module:u,entryPoint:"main"},layout:"auto",label:e.name});return Q(e.name),{programInfo:e,computePipeline:l,uniformVariablesInfo:n.variablesInfo}}normalizeDispatchGroupSize(e){let r="number"==typeof e?e:e.x,i="number"==typeof e?1:e.y||1,a="number"==typeof e?1:e.z||1,n=this.backend.device.limits.maxComputeWorkgroupsPerDimension;if(r<=n&&i<=n&&a<=n)return[r,i,a];let s=r*i*a,o=Math.ceil(Math.sqrt(s));if(!(o>n))return[o,o,1];if((o=Math.ceil(Math.cbrt(s)))>n)throw Error("Total dispatch size exceeds WebGPU maximum.");return[o,o,o]}}}),sN={};eu(sN,{WebGpuBackend:()=>sD});var sB,sD,sU=eo(()=>{eC(),nR(),nB(),nU(),nW(),sM(),sR(),sB=class{constructor(e){e&&(this.architecture=e.architecture,this.vendor=e.vendor)}isArchitecture(e){return this.architecture===e}isVendor(e){return this.vendor===e}},sD=class{constructor(){this.currentSessionId=null,this.currentKernelId=null,this.commandEncoder=null,this.computePassEncoder=null,this.maxDispatchNumber=16,this.pendingDispatchNumber=0,this.pendingKernels=[],this.pendingQueries=new Map,this.sessionStatus="default",this.capturedCommandList=new Map,this.capturedPendingKernels=new Map,this.sessionExternalDataMapping=new Map}get currentKernelCustomData(){if(null===this.currentKernelId)throw Error("currentKernelCustomData(): currentKernelId is null. (should not happen)");let e=this.kernelCustomData.get(this.currentKernelId);return e||(e={},this.kernelCustomData.set(this.currentKernelId,e)),e}async initialize(e,r){this.env=e;let i=[],a={requiredLimits:{maxComputeWorkgroupStorageSize:r.limits.maxComputeWorkgroupStorageSize,maxComputeWorkgroupsPerDimension:r.limits.maxComputeWorkgroupsPerDimension,maxStorageBufferBindingSize:r.limits.maxStorageBufferBindingSize,maxBufferSize:r.limits.maxBufferSize,maxComputeInvocationsPerWorkgroup:r.limits.maxComputeInvocationsPerWorkgroup,maxComputeWorkgroupSizeX:r.limits.maxComputeWorkgroupSizeX,maxComputeWorkgroupSizeY:r.limits.maxComputeWorkgroupSizeY,maxComputeWorkgroupSizeZ:r.limits.maxComputeWorkgroupSizeZ},requiredFeatures:i},n=e=>r.features.has(e)&&i.push(e)&&!0;n("chromium-experimental-timestamp-query-inside-passes")||n("timestamp-query"),n("shader-f16"),n("subgroups"),this.device=await r.requestDevice(a),this.adapterInfo=new sB(r.info||await r.requestAdapterInfo()),this.gpuDataManager=tP(this),this.programManager=new nI(this),this.kernels=new Map,this.kernelPersistentData=new Map,this.kernelCustomData=new Map,tl(e.logLevel,!!e.debug),this.device.onuncapturederror=e=>{e.error instanceof GPUValidationError&&console.error(`An uncaught WebGPU validation error was raised: ${e.error.message}`)},Object.defineProperty(this.env.webgpu,"device",{value:this.device,writable:!1,enumerable:!0,configurable:!0}),Object.defineProperty(this.env.webgpu,"adapter",{value:r,writable:!1,enumerable:!0,configurable:!1}),this.setQueryType()}dispose(){"u">typeof this.querySet&&this.querySet.destroy(),this.gpuDataManager.dispose(),this.device&&this.env?.webgpu&&this.device.lost.then(()=>{delete this.env.webgpu.device})}getCommandEncoder(){return this.commandEncoder||(this.commandEncoder=this.device.createCommandEncoder()),this.commandEncoder}getComputePassEncoder(){if(!this.computePassEncoder){let e=this.getCommandEncoder(),r={};"at-passes"===this.queryType&&(r.timestampWrites={querySet:this.querySet,beginningOfPassWriteIndex:2*this.pendingDispatchNumber,endOfPassWriteIndex:2*this.pendingDispatchNumber+1}),this.computePassEncoder=e.beginComputePass(r)}return this.computePassEncoder}endComputePass(){this.computePassEncoder&&(this.computePassEncoder.end(),this.computePassEncoder=null)}flush(){let e;this.commandEncoder&&(X(),this.endComputePass(),"none"!==this.queryType&&(this.commandEncoder.resolveQuerySet(this.querySet,0,2*this.pendingDispatchNumber,this.queryResolveBuffer,0),e=this.device.createBuffer({size:2*this.pendingDispatchNumber*8,usage:GPUBufferUsage.MAP_READ|GPUBufferUsage.COPY_DST}),this.pendingQueries.set(e,this.pendingKernels),this.pendingKernels=[],this.commandEncoder.copyBufferToBuffer(this.queryResolveBuffer,0,e,0,2*this.pendingDispatchNumber*8)),this.device.queue.submit([this.commandEncoder.finish()]),this.gpuDataManager.refreshPendingBuffers(),this.commandEncoder=null,this.pendingDispatchNumber=0,"none"!==this.queryType&&e.mapAsync(GPUMapMode.READ).then(()=>{let r=new BigUint64Array(e.getMappedRange()),i=this.pendingQueries.get(e);for(let e=0;e<r.length/2;e++){let a=i[e],n=a.kernelId,s=this.kernels.get(n),o=s.kernelType,u=s.kernelName,l=a.programName,d=a.inputTensorViews,p=a.outputTensorViews,c=r[2*e],h=r[2*e+1];typeof this.queryTimeBase>"u"&&(this.queryTimeBase=c);let f=Number(c-this.queryTimeBase),m=Number(h-this.queryTimeBase);if(!Number.isSafeInteger(f)||!Number.isSafeInteger(m))throw RangeError("incorrect timestamp range");if(this.env.webgpu.profiling?.ondata)this.env.webgpu.profiling.ondata({version:1,inputsMetadata:d.map(e=>({dims:e.dims,dataType:e9(e.dataType)})),outputsMetadata:p.map(e=>({dims:e.dims,dataType:e9(e.dataType)})),kernelId:n,kernelType:o,kernelName:u,programName:l,startTime:f,endTime:m});else{let e="";d.forEach((r,i)=>{e+=`input[${i}]: [${r.dims}] | ${e9(r.dataType)}, `});let r="";p.forEach((e,i)=>{r+=`output[${i}]: [${e.dims}] | ${e9(e.dataType)}, `}),console.log(`[profiling] kernel "${n}|${o}|${u}|${l}" ${e}${r}start time: ${f} ns, execution time: ${m-f} ns`)}K("GPU",`${l}::${c}::${h}`)}e.unmap(),this.pendingQueries.delete(e)}),Q())}run(e,r,i,a,n,s){var o,u,l;let d,p;X(e.name);let c=[];for(let e=0;e<r.length;++e){let i=r[e].data;if(0===i)continue;let a=this.gpuDataManager.get(i);if(!a)throw Error(`no GPU data for input: ${i}`);c.push(a)}let{outputs:h,dispatchGroup:f,programUniforms:m}=e.getRunData(r),g=0===i.length?h.map((e,r)=>r):i;if(g.length!==h.length)throw Error(`Output size ${g.length} must be equal to ${h.length}.`);let y=[],_=[];for(let e=0;e<h.length;++e){if(!Number.isInteger(g[e])||g[e]<-3||g[e]>=s)throw Error(`Invalid output index: ${g[e]}`);if(-3===g[e])continue;let r=-1===g[e],i=-2===g[e],o=r||i?n(h[e].dataType,h[e].dims):a(g[e],h[e].dataType,h[e].dims);if(y.push(o),0===o.data)continue;let u=this.gpuDataManager.get(o.data);if(!u)throw Error(`no GPU data for output: ${o.data}`);if(r&&this.temporaryData.push(u),i){let e=this.kernelPersistentData.get(this.currentKernelId);e||(e=[],this.kernelPersistentData.set(this.currentKernelId,e)),e.push(u)}_.push(u)}if(c.length!==r.length||_.length!==y.length){if(0===_.length)return Q(e.name),y;throw Error(`Program ${e.name} has zero-sized tensor(s) in inputs or outputs. This is not supported now.`)}if(m){let e=0,r=[];m.forEach(i=>{let a="number"==typeof i.data?[i.data]:i.data;if(0===a.length)return;let n=10===i.type?2:4,s,o;10===i.type?(o=a.length>4?16:a.length>2?8:a.length*n,s=a.length>4?16:n*a.length):(o=a.length<=2?a.length*n:16,s=16),e=Math.ceil(e/o)*o,r.push(e);let u=10===i.type?8:4;e+=a.length>4?Math.ceil(a.length/u)*s:a.length*n});let i=new ArrayBuffer(e=16*Math.ceil(e/16));m.forEach((e,a)=>{let n=r[a],s="number"==typeof e.data?[e.data]:e.data;if(6===e.type)new Int32Array(i,n,s.length).set(s);else if(12===e.type)new Uint32Array(i,n,s.length).set(s);else if(10===e.type)new Uint16Array(i,n,s.length).set(s);else if(1===e.type)new Float32Array(i,n,s.length).set(s);else throw Error(`Unsupported uniform type: ${e9(e.type)}`)});let a=this.gpuDataManager.create(e,GPUBufferUsage.COPY_DST|GPUBufferUsage.UNIFORM);this.device.queue.writeBuffer(a.buffer,0,i,0,e),this.gpuDataManager.release(a.id),d={offset:0,size:e,buffer:a.buffer}}let b=this.programManager.normalizeDispatchGroupSize(f),$=(o=e,u=r,l=1===b[1]&&1===b[2],p=o.name,o.shaderCache?.hint&&(p+="["+o.shaderCache.hint+"]"),p+=":"+l+`:${((e,r)=>{if(r.length!==e.length)throw Error(`inputDependencies length ${r.length} is not equal to inputTensors length ${e.length}.`);let i=[];for(let a=0;a<e.length;++a){let n=e[a].dataType;switch(r[a]){case"none":i.push("");break;case"type":i.push(`${n}`);break;case"rank":{let r=e[a].dims.length;i.push(`${n};${r}`);break}case"dims":{let r=e[a].dims.join(",");i.push(`${n};${r}`);break}default:throw Error(`unsupported input dependency: ${r[a]}`)}}return i.join("|")})(u,o.shaderCache?.inputDependencies??Array(u.length).fill("dims"))}`),v=this.programManager.getArtifact($);if(v||(v=this.programManager.build(e,b),this.programManager.setArtifact($,v),td("info",()=>`[artifact] key: ${$}, programName: ${e.name}`)),m&&v.uniformVariablesInfo){if(m.length!==v.uniformVariablesInfo.length)throw Error(`Uniform variables count mismatch: expect ${v.uniformVariablesInfo.length}, got ${m.length} in program "${v.programInfo.name}".`);for(let e=0;e<m.length;e++){let r=m[e],i=r.type,a="number"==typeof r.data?1:r.data.length,[n,s]=v.uniformVariablesInfo[e];if(i!==n||a!==s)throw Error(`Uniform variable ${e} mismatch: expect type ${n} with size ${s}, got type ${i} with size ${a} in program "${v.programInfo.name}".`)}}if(td("info",()=>`[ProgramManager] run "${e.name}" (key=${$}) with ${b[0]}x${b[1]}x${b[2]}`),"none"!==this.queryType||"capturing"===this.sessionStatus){let e={kernelId:this.currentKernelId,programName:v.programInfo.name,inputTensorViews:r,outputTensorViews:y};this.pendingKernels.push(e),"capturing"===this.sessionStatus&&this.capturedPendingKernels.get(this.currentSessionId).push(e)}return this.programManager.run(v,c,_,b,d),Q(e.name),y}upload(e,r){this.gpuDataManager.upload(e,r)}memcpy(e,r){this.gpuDataManager.memcpy(e,r)}async download(e,r){await this.gpuDataManager.download(e,r)}alloc(e){return this.gpuDataManager.create(e).id}free(e){return this.gpuDataManager.release(e)}createKernel(e,r,i,a){let n=nT.get(e);if(!n)throw Error(`kernel not implemented: ${e}`);let s={kernelType:e,kernelName:a,kernelEntry:n[0],attributes:[n[1],i]};this.kernels.set(r,s)}releaseKernel(e){let r=this.kernelPersistentData.get(e);if(r){for(let e of r)this.gpuDataManager.release(e.id);this.kernelPersistentData.delete(e)}this.kernelCustomData.delete(e),this.kernels.delete(e)}computeKernel(e,r,i){let a=this.kernels.get(e);if(!a)throw Error(`kernel not created: ${e}`);let n=a.kernelType,s=a.kernelName,o=a.kernelEntry,u=a.attributes;if(null!==this.currentKernelId)throw Error(`kernel "[${n}] ${s}" is not allowed to be called recursively`);this.currentKernelId=e,u[0]&&(u[1]=u[0](u[1]),u[0]=void 0),td("info",()=>`[WebGPU] Start to run kernel "[${n}] ${s}"...`);let l=this.env.debug;this.temporaryData=[];try{return l&&this.device.pushErrorScope("validation"),o(r,u[1]),0}catch(e){return i.push(Promise.resolve(`[WebGPU] Kernel "[${n}] ${s}" failed. ${e}`)),1}finally{for(let e of(l&&i.push(this.device.popErrorScope().then(e=>e?`GPU validation error for kernel "[${n}] ${s}": ${e.message}`:null)),this.temporaryData))this.gpuDataManager.release(e.id);this.temporaryData=[],this.currentKernelId=null}}registerBuffer(e,r,i,a){let n=this.sessionExternalDataMapping.get(e);n||(n=new Map,this.sessionExternalDataMapping.set(e,n));let s=n.get(r),o=this.gpuDataManager.registerExternalBuffer(i,a,s);return n.set(r,[o,i]),o}unregisterBuffers(e){let r=this.sessionExternalDataMapping.get(e);r&&(r.forEach(e=>this.gpuDataManager.unregisterExternalBuffer(e[0])),this.sessionExternalDataMapping.delete(e))}getBuffer(e){let r=this.gpuDataManager.get(e);if(!r)throw Error(`no GPU data for buffer: ${e}`);return r.buffer}createDownloader(e,r,i){return async()=>{let a=await tD(this,e,r);return t_(a.buffer,i)}}writeTimestamp(e){"inside-passes"===this.queryType&&this.computePassEncoder.writeTimestamp(this.querySet,e)}setQueryType(){this.queryType="none",(this.env.webgpu.profiling?.mode==="default"||(typeof this.env.trace>"u"?this.env.wasm.trace:this.env.trace))&&(this.device.features.has("chromium-experimental-timestamp-query-inside-passes")?this.queryType="inside-passes":this.device.features.has("timestamp-query")&&(this.queryType="at-passes"),"none"!==this.queryType&&typeof this.querySet>"u"&&(this.querySet=this.device.createQuerySet({type:"timestamp",count:2*this.maxDispatchNumber}),this.queryResolveBuffer=this.device.createBuffer({size:2*this.maxDispatchNumber*8,usage:GPUBufferUsage.COPY_SRC|GPUBufferUsage.QUERY_RESOLVE})))}captureBegin(){td("info","captureBegin"),this.capturedCommandList.get(this.currentSessionId)||this.capturedCommandList.set(this.currentSessionId,[]),this.capturedPendingKernels.get(this.currentSessionId)||this.capturedPendingKernels.set(this.currentSessionId,[]),this.flush(),this.sessionStatus="capturing"}captureEnd(){td("info","captureEnd"),this.flush(),this.sessionStatus="default"}replay(){td("info","replay"),this.sessionStatus="replaying";let e=this.capturedCommandList.get(this.currentSessionId),r=this.capturedPendingKernels.get(this.currentSessionId),i=e.length;this.pendingKernels=[];for(let a=0;a<i;a++){let i=this.getComputePassEncoder(),n=e[a];this.writeTimestamp(2*this.pendingDispatchNumber),i.setPipeline(n.computePipeline),i.setBindGroup(0,n.bindGroup),i.dispatchWorkgroups(...n.dispatchGroup),this.writeTimestamp(2*this.pendingDispatchNumber+1),this.pendingDispatchNumber++,"none"!==this.queryType&&this.pendingKernels.push(r[a]),(this.pendingDispatchNumber>=this.maxDispatchNumber||"at-passes"===this.queryType)&&this.endComputePass(),this.pendingDispatchNumber>=this.maxDispatchNumber&&this.flush()}this.flush(),this.sessionStatus="default"}onCreateSession(){this.gpuDataManager.onCreateSession()}onReleaseSession(e){this.unregisterBuffers(e),this.capturedCommandList.has(e)&&this.capturedCommandList.delete(e),this.capturedPendingKernels.has(e)&&this.capturedPendingKernels.delete(e),this.gpuDataManager.onReleaseSession(e)}onRunStart(e){this.currentSessionId=e,this.setQueryType()}}}),sP={};eu(sP,{init:()=>sW});var sL,sq,sW,sV,sj,sG,sF,sH,sK,sZ,sX,sQ,sY,sJ,s0,s1,s2,s3,s4,s6,s8,s5,s9,s7,oe,ot,or,oi,oa,on,os,oo,ou,ol,od,op=eo(()=>{nR(),nB(),nD(),nL(),sL=class e{constructor(e,r,i,a){this.module=e,this.dataType=r,this.data=i,this.dims=a}getFloat32Array(){if(1!==this.dataType)throw Error("Invalid data type");let e=th.size(this.dims);return 0===e?new Float32Array:new Float32Array(this.module.HEAP8.buffer,this.data,e)}getBigInt64Array(){if(7!==this.dataType)throw Error("Invalid data type");let e=th.size(this.dims);return 0===e?new BigInt64Array:new BigInt64Array(this.module.HEAP8.buffer,this.data,e)}getInt32Array(){if(6!==this.dataType)throw Error("Invalid data type");let e=th.size(this.dims);return 0===e?new Int32Array:new Int32Array(this.module.HEAP8.buffer,this.data,e)}getUint16Array(){if(10!==this.dataType&&4!==this.dataType)throw Error("Invalid data type");let e=th.size(this.dims);return 0===e?new Uint16Array:new Uint16Array(this.module.HEAP8.buffer,this.data,e)}reshape(r){if(th.size(r)!==th.size(this.dims))throw Error("Invalid new shape");return new e(this.module,this.dataType,this.data,r)}},sq=class{constructor(e,r,i){this.module=e,this.backend=r,this.customDataOffset=0,this.customDataSize=0,this.adapterInfo=r.adapterInfo;let a=e.PTR_SIZE,n=i/e.PTR_SIZE,s=4===a?"i32":"i64";this.opKernelContext=Number(e.getValue(a*n++,s));let o=Number(e.getValue(a*n++,s));this.outputCount=Number(e.getValue(a*n++,s)),this.customDataOffset=Number(e.getValue(a*n++,"*")),this.customDataSize=Number(e.getValue(a*n++,s));let u=[];for(let r=0;r<o;r++){let r=Number(e.getValue(a*n++,s)),i=Number(e.getValue(a*n++,"*")),o=Number(e.getValue(a*n++,s)),l=[];for(let r=0;r<o;r++)l.push(Number(e.getValue(a*n++,s)));u.push(new sL(e,r,i,l))}this.inputs=u}get kernelCustomData(){return this.backend.currentKernelCustomData}get customDataBuffer(){return this.module.HEAPU8.subarray(this.customDataOffset,this.customDataOffset+this.customDataSize)}compute(e,r){let i=r?.inputs?.map(e=>"number"==typeof e?this.inputs[e]:e)??this.inputs,a=r?.outputs??[],n=(e,r,i)=>new sL(this.module,r,this.output(e,i),i),s=(e,r)=>{let i=e7(e,r);if(!i)throw Error(`Unsupported data type: ${e}`);let a=i>0?this.backend.gpuDataManager.create(i).id:0;return new sL(this.module,e,a,r)};return this.backend.run(e,i,a,n,s,this.outputCount)}output(e,r){let i=this.module.stackSave();try{let i=this.module.PTR_SIZE,a=4===i?"i32":"i64",n=this.module.stackAlloc((1+r.length)*i);this.module.setValue(n,r.length,a);for(let e=0;e<r.length;e++)this.module.setValue(n+i*(e+1),r[e],a);return this.module._JsepOutput(this.opKernelContext,e,n)}catch(i){throw Error(`Failed to generate kernel's output[${e}] with dims [${r}]. If you are running with pre-allocated output, please make sure the output type/dims are correct. Error: ${i}`)}finally{this.module.stackRestore(i)}}},sW=async(e,r,i,a)=>{let n=r.jsepInit;if(!n)throw Error("Failed to initialize JSEP. The WebAssembly module is not built with JSEP support.");if("webgpu"===e){let e=new(sU(),el(sN)).WebGpuBackend;await e.initialize(i,a),n("webgpu",[e,r=>e.alloc(Number(r)),r=>e.free(r),(i,a,n,s=!1)=>{if(s)td("verbose",()=>`[WebGPU] jsepCopyGpuToGpu: src=${Number(i)}, dst=${Number(a)}, size=${Number(n)}`),e.memcpy(Number(i),Number(a));else{td("verbose",()=>`[WebGPU] jsepCopyCpuToGpu: dataOffset=${Number(i)}, gpuDataId=${Number(a)}, size=${Number(n)}`);let s=r.HEAPU8.subarray(Number(i>>>0),Number(i>>>0)+Number(n));e.upload(Number(a),s)}},async(i,a,n)=>{td("verbose",()=>`[WebGPU] jsepCopyGpuToCpu: gpuDataId=${i}, dataOffset=${a}, size=${n}`),await e.download(Number(i),()=>r.HEAPU8.subarray(Number(a)>>>0,Number(a+n)>>>0))},(i,a,n)=>e.createKernel(i,Number(a),n,r.UTF8ToString(r._JsepGetNodeName(Number(a)))),r=>e.releaseKernel(r),(i,a,n,s)=>{td("verbose",()=>`[WebGPU] jsepRun: sessionHandle=${n}, kernel=${i}, contextDataOffset=${a}`);let o=new sq(r,e,Number(a));return e.computeKernel(Number(i),o,s)},()=>e.captureBegin(),()=>e.captureEnd(),()=>e.replay()])}else{let e=new tA(i);n("webnn",[e,()=>e.reserveTensorId(),r=>e.releaseTensorId(r),async(r,i,a,n,s)=>e.ensureTensor(r,i,a,n,s),(r,i)=>{e.uploadTensor(r,i)},async(r,i)=>e.downloadTensor(r,i),(r,i)=>e.registerMLContext(r,i),!!i.trace])}}}),oc=eo(()=>{eC(),nO(),nM(),nR(),nz(),nA(),nN(),sV=async e=>{var r,i;r=e.wasm.numThreads,i=tt(e.logLevel),0!==eJ()._OrtInit(r,i)&&e2("Can't initialize onnxruntime.")},sj=async(e,r)=>{eJ().asyncInit?.();let i=e.webgpu.adapter;if("webgpu"===r){if(typeof navigator>"u"||!navigator.gpu)throw Error("WebGPU is not supported in current environment");if(i){if("object"!=typeof i.limits||"object"!=typeof i.features||"function"!=typeof i.requestDevice)throw Error("Invalid GPU adapter set in `env.webgpu.adapter`. It must be a GPUAdapter object.")}else{let r=e.webgpu.powerPreference;if(void 0!==r&&"low-power"!==r&&"high-performance"!==r)throw Error(`Invalid powerPreference setting: "${r}"`);let a=e.webgpu.forceFallbackAdapter;if(void 0!==a&&"boolean"!=typeof a)throw Error(`Invalid forceFallbackAdapter setting: "${a}"`);if(!(i=await navigator.gpu.requestAdapter({powerPreference:r,forceFallbackAdapter:a})))throw Error('Failed to get GPU adapter. You may need to enable flag "--enable-unsafe-webgpu" if you are using Chrome.')}}if("webnn"===r&&(typeof navigator>"u"||!navigator.ml))throw Error("WebNN is not supported in current environment");{let a=(op(),el(sP)).init;"webgpu"===r&&await a("webgpu",eJ(),e,i),"webnn"===r&&await a("webnn",eJ(),e)}},sG=new Map,sF=(e,r)=>{let i=eJ(),a=i.stackSave(),n=0;try{let a=i.PTR_SIZE,s=i.stackAlloc(2*a);0!==i._OrtGetInputOutputMetadata(e,r,s,s+a)&&e2("Can't get session input/output metadata.");let o=Number(i.getValue(s,"*"));n=Number(i.getValue(s+a,"*"));let u=i.HEAP32[n/4];if(0===u)return[o,0];let l=i.HEAPU32[n/4+1],d=[];for(let e=0;e<l;e++){let r=Number(i.getValue(n+8+e*a,"*"));d.push(0!==r?i.UTF8ToString(r):Number(i.getValue(n+8+(e+l)*a,"*")))}return[o,u,d]}finally{i.stackRestore(a),0!==n&&i._OrtFree(n)}},sH=e=>{let r=eJ(),i=r._malloc(e.byteLength);if(0===i)throw Error(`Can't create a session. failed to allocate a buffer of size ${e.byteLength}.`);return r.HEAPU8.set(e,i),[i,e.byteLength]},sK=async(e,r)=>{let i,a,n=eJ();Array.isArray(e)?[i,a]=e:e.buffer===n.HEAPU8.buffer?[i,a]=[e.byteOffset,e.byteLength]:[i,a]=sH(e);let s=0,o=0,u=0,l=[],d=[],p=[];try{if([o,l]=await e8(r),r?.externalData&&n.mountExternalData){let e=[];for(let i of r.externalData){let r="string"==typeof i?i:i.path;e.push(tn("string"==typeof i?i:i.data).then(e=>{n.mountExternalData(r,e)}))}await Promise.all(e)}for(let e of r?.executionProviders??[])if(("string"==typeof e?e:e.name)==="webnn"){if(n.shouldTransferToMLTensor=!1,"string"!=typeof e){let r=e?.context,i=e?.gpuDevice,a=e?.deviceType,s=e?.powerPreference;r?n.currentContext=r:i?n.currentContext=await n.webnnCreateMLContext(i):n.currentContext=await n.webnnCreateMLContext({deviceType:a,powerPreference:s})}else n.currentContext=await n.webnnCreateMLContext();break}s=await n._OrtCreateSession(i,a,o),n.webgpuOnCreateSession?.(s),0===s&&e2("Can't create a session."),n.jsepOnCreateSession?.(),n.currentContext&&(n.webnnRegisterMLContext(s,n.currentContext),n.currentContext=void 0,n.shouldTransferToMLTensor=!0);let[e,c]=(e=>{let r=eJ(),i=r.stackSave();try{let i=r.PTR_SIZE,a=r.stackAlloc(2*i);0!==r._OrtGetInputOutputCount(e,a,a+i)&&e2("Can't get session input/output count.");let n=4===i?"i32":"i64";return[Number(r.getValue(a,n)),Number(r.getValue(a+i,n))]}finally{r.stackRestore(i)}})(s),h=!!r?.enableGraphCapture,f=[],m=[],g=[],y=[],_=[];for(let r=0;r<e;r++){let[e,i,a]=sF(s,r);0===e&&e2("Can't get an input name."),d.push(e);let o=n.UTF8ToString(e);f.push(o),g.push(0===i?{name:o,isTensor:!1}:{name:o,isTensor:!0,type:e9(i),shape:a})}for(let i=0;i<c;i++){let[a,o,u]=sF(s,i+e);0===a&&e2("Can't get an output name."),p.push(a);let l=n.UTF8ToString(a);m.push(l),y.push(0===o?{name:l,isTensor:!1}:{name:l,isTensor:!0,type:e9(o),shape:u});{if(h&&r?.preferredOutputLocation===void 0){_.push("gpu-buffer");continue}let e="string"==typeof r?.preferredOutputLocation?r.preferredOutputLocation:r?.preferredOutputLocation?.[l]??"cpu",i=n.webnnIsGraphOutput;if("cpu"===e&&i&&i(s,l)){_.push("ml-tensor-cpu-output");continue}if("cpu"!==e&&"cpu-pinned"!==e&&"gpu-buffer"!==e&&"ml-tensor"!==e)throw Error(`Not supported preferred output location: ${e}.`);if(h&&"gpu-buffer"!==e)throw Error(`Not supported preferred output location: ${e}. Only 'gpu-buffer' location is supported when enableGraphCapture is true.`);_.push(e)}}let b=null;return _.some(e=>"gpu-buffer"===e||"ml-tensor"===e||"ml-tensor-cpu-output"===e)&&(u=n._OrtCreateBinding(s),0===u&&e2("Can't create IO binding."),b={handle:u,outputPreferredLocations:_,outputPreferredLocationsEncoded:_.map(e=>"ml-tensor-cpu-output"===e?"ml-tensor":e).map(e=>ta(e))}),sG.set(s,[s,d,p,b,h,!1]),[s,f,m,g,y]}catch(e){throw d.forEach(e=>n._OrtFree(e)),p.forEach(e=>n._OrtFree(e)),0!==u&&0!==n._OrtReleaseBinding(u)&&e2("Can't release IO binding."),0!==s&&0!==n._OrtReleaseSession(s)&&e2("Can't release session."),e}finally{n._free(i),0!==o&&0!==n._OrtReleaseSessionOptions(o)&&e2("Can't release session options."),l.forEach(e=>n._free(e)),n.unmountExternalData?.()}},sZ=e=>{let r=eJ(),i=sG.get(e);if(!i)throw Error(`cannot release session. invalid session id: ${e}`);let[a,n,s,o,u]=i;o&&(u&&0!==r._OrtClearBoundOutputs(o.handle)&&e2("Can't clear bound outputs."),0!==r._OrtReleaseBinding(o.handle)&&e2("Can't release IO binding.")),r.jsepOnReleaseSession?.(e),r.webnnOnReleaseSession?.(e),r.webgpuOnReleaseSession?.(e),n.forEach(e=>r._OrtFree(e)),s.forEach(e=>r._OrtFree(e)),0!==r._OrtReleaseSession(a)&&e2("Can't release session."),sG.delete(e)},sX=async(e,r,i,a,n,s,o=!1)=>{if(!e)return void r.push(0);let u=eJ(),l=u.PTR_SIZE,d=e[0],p=e[1],c=e[3],h=c,f,m;if("string"===d&&("gpu-buffer"===c||"ml-tensor"===c))throw Error("String tensor is not supported on GPU.");if(o&&"gpu-buffer"!==c)throw Error(`External buffer must be provided for input/output index ${s} when enableGraphCapture is true.`);if("gpu-buffer"===c){let r=e[2].gpuBuffer;m=e7(e5(d),p);{let e=u.jsepRegisterBuffer;if(!e)throw Error('Tensor location "gpu-buffer" is not supported without using WebGPU.');f=e(a,s,r,m)}}else if("ml-tensor"===c){let r=e[2].mlTensor;m=e7(e5(d),p);let i=u.webnnRegisterMLTensor;if(!i)throw Error('Tensor location "ml-tensor" is not supported without using WebNN.');f=i(a,r,e5(d),p)}else{let r=e[2];if(Array.isArray(r)){m=l*r.length,f=u._malloc(m),i.push(f);for(let e=0;e<r.length;e++){if("string"!=typeof r[e])throw TypeError(`tensor data at index ${e} is not a string`);u.setValue(f+e*l,e0(r[e],i),"*")}}else{let e=u.webnnIsGraphInput,s=u.webnnIsGraphOutput;if("string"!==d&&e&&s){let o=u.UTF8ToString(n);if(e(a,o)||s(a,o)){let e=e5(d);m=e7(e,p),h="ml-tensor";let i=u.webnnCreateTemporaryTensor,n=u.webnnUploadTensor;if(!i||!n)throw Error('Tensor location "ml-tensor" is not supported without using WebNN.');let s=await i(a,e,p);n(s,new Uint8Array(r.buffer,r.byteOffset,r.byteLength)),f=s}else m=r.byteLength,f=u._malloc(m),i.push(f),u.HEAPU8.set(new Uint8Array(r.buffer,r.byteOffset,m),f)}else m=r.byteLength,f=u._malloc(m),i.push(f),u.HEAPU8.set(new Uint8Array(r.buffer,r.byteOffset,m),f)}}let g=u.stackSave(),y=u.stackAlloc(4*p.length);try{p.forEach((e,r)=>u.setValue(y+r*l,e,4===l?"i32":"i64"));let e=u._OrtCreateTensor(e5(d),f,m,y,p.length,ta(h));0===e&&e2(`Can't create tensor for input/output. session=${a}, index=${s}.`),r.push(e)}finally{u.stackRestore(g)}},sQ=async(e,r,i,a,n,s)=>{let o=eJ(),u=o.PTR_SIZE,l=sG.get(e);if(!l)throw Error(`cannot run inference. invalid session id: ${e}`);let d=l[0],p=l[1],c=l[2],h=l[3],f=l[4],m=l[5],g=r.length,y=a.length,_=0,b=[],$=[],v=[],w=[],x=[],S=o.stackSave(),k=o.stackAlloc(g*u),T=o.stackAlloc(g*u),I=o.stackAlloc(y*u),C=o.stackAlloc(y*u);try{let l;[_,b]=e3(s),Y("wasm prepareInputOutputTensor");for(let a=0;a<g;a++)await sX(i[a],$,w,e,p[r[a]],r[a],f);for(let r=0;r<y;r++)await sX(n[r],v,w,e,c[a[r]],g+a[r],f);J("wasm prepareInputOutputTensor");for(let e=0;e<g;e++)o.setValue(k+e*u,$[e],"*"),o.setValue(T+e*u,p[r[e]],"*");for(let e=0;e<y;e++)o.setValue(I+e*u,v[e],"*"),o.setValue(C+e*u,c[a[e]],"*");if(h&&!m){let{handle:i,outputPreferredLocations:s,outputPreferredLocationsEncoded:u}=h;if(p.length!==g)throw Error(`input count from feeds (${g}) is expected to be always equal to model's input count (${p.length}).`);Y("wasm bindInputsOutputs");for(let a=0;a<g;a++){let n=r[a];await o._OrtBindInput(i,p[n],$[a])!==0&&e2(`Can't bind input[${a}] for session=${e}.`)}for(let r=0;r<y;r++){let l=a[r];n[r]?.[3]?(x.push(v[r]),0!==o._OrtBindOutput(i,c[l],v[r],0)&&e2(`Can't bind pre-allocated output[${r}] for session=${e}.`)):0!==o._OrtBindOutput(i,c[l],0,u[l])&&e2(`Can't bind output[${r}] to ${s[r]} for session=${e}.`)}J("wasm bindInputsOutputs"),sG.set(e,[d,p,c,h,f,!0])}o.jsepOnRunStart?.(d),o.webnnOnRunStart?.(d),l=h?await o._OrtRunWithBinding(d,h.handle,y,I,_):await o._OrtRun(d,T,k,g,C,y,I,_),0!==l&&e2("failed to call OrtRun().");let S=[],E=[];Y("wasm ProcessOutputTensor");for(let r=0;r<y;r++){let i=Number(o.getValue(I+r*u,"*"));if(i===v[r]||x.includes(v[r])){S.push(n[r]),i!==v[r]&&0!==o._OrtReleaseTensor(i)&&e2("Can't release tensor.");continue}let s=o.stackSave(),l=o.stackAlloc(4*u),d=!1,p,c=0;try{0!==o._OrtGetTensorData(i,l,l+u,l+2*u,l+3*u)&&e2(`Can't access output tensor data on index ${r}.`);let n=4===u?"i32":"i64",s=Number(o.getValue(l,n));c=o.getValue(l+u,"*");let f=o.getValue(l+2*u,"*"),m=Number(o.getValue(l+3*u,n)),g=[];for(let e=0;e<m;e++)g.push(Number(o.getValue(f+e*u,n)));0!==o._OrtFree(f)&&e2("Can't free memory for tensor dims.");let y=g.reduce((e,r)=>e*r,1);p=e9(s);let _=h?.outputPreferredLocations[a[r]];if("string"===p){if("gpu-buffer"===_||"ml-tensor"===_)throw Error("String tensor is not supported on GPU.");let e=[];for(let r=0;r<y;r++){let i=o.getValue(c+r*u,"*"),a=o.getValue(c+(r+1)*u,"*"),n=r===y-1?void 0:a-i;e.push(o.UTF8ToString(i,n))}S.push([p,g,e,"cpu"])}else if("gpu-buffer"===_&&y>0){let e=o.jsepGetBuffer;if(!e)throw Error('preferredLocation "gpu-buffer" is not supported without using WebGPU.');let r=e(c),a=e7(s,y);if(void 0===a||!tr(p))throw Error(`Unsupported data type: ${p}`);d=!0,S.push([p,g,{gpuBuffer:r,download:o.jsepCreateDownloader(r,a,p),dispose:()=>{0!==o._OrtReleaseTensor(i)&&e2("Can't release tensor.")}},"gpu-buffer"])}else if("ml-tensor"===_&&y>0){let r=o.webnnEnsureTensor,a=o.webnnIsGraphInputOutputTypeSupported;if(!r||!a)throw Error('preferredLocation "ml-tensor" is not supported without using WebNN.');if(void 0===e7(s,y)||!ti(p))throw Error(`Unsupported data type: ${p}`);if(!a(e,p,!1))throw Error(`preferredLocation "ml-tensor" for ${p} output is not supported by current WebNN Context.`);let n=await r(e,c,s,g,!1);d=!0,S.push([p,g,{mlTensor:n,download:o.webnnCreateMLTensorDownloader(c,p),dispose:()=>{o.webnnReleaseTensorId(c),o._OrtReleaseTensor(i)}},"ml-tensor"])}else if("ml-tensor-cpu-output"===_&&y>0){let e=o.webnnCreateMLTensorDownloader(c,p)(),r=S.length;d=!0,E.push((async()=>{let a=[r,await e];return o.webnnReleaseTensorId(c),o._OrtReleaseTensor(i),a})()),S.push([p,g,[],"cpu"])}else{let e=new(te(p))(y);new Uint8Array(e.buffer,e.byteOffset,e.byteLength).set(o.HEAPU8.subarray(c,c+e.byteLength)),S.push([p,g,e,"cpu"])}}finally{o.stackRestore(s),"string"===p&&c&&o._free(c),d||o._OrtReleaseTensor(i)}}for(let[r,i]of(h&&!f&&(0!==o._OrtClearBoundOutputs(h.handle)&&e2("Can't clear bound outputs."),sG.set(e,[d,p,c,h,f,!1])),await Promise.all(E)))S[r][2]=i;return J("wasm ProcessOutputTensor"),S}finally{o.webnnOnRunEnd?.(d),o.stackRestore(S),$.forEach(e=>o._OrtReleaseTensor(e)),v.forEach(e=>o._OrtReleaseTensor(e)),w.forEach(e=>o._free(e)),0!==_&&o._OrtReleaseRunOptions(_),b.forEach(e=>o._free(e))}},sY=e=>{let r=eJ(),i=sG.get(e);if(!i)throw Error("invalid session id");let a=i[0],n=r._OrtEndProfiling(a);0===n&&e2("Can't get an profile file name."),r._OrtFree(n)},sJ=e=>{let r=[];for(let i of e){let e=i[2];!Array.isArray(e)&&"buffer"in e&&r.push(e.buffer)}return r}}),oh=eo(()=>{eC(),oc(),nz(),nE(),s0=()=>!!A.wasm.proxy&&"u">typeof document,s2=!1,s3=!1,s4=!1,s5=new Map,s9=(e,r)=>{let i=s5.get(e);i?i.push(r):s5.set(e,[r])},s7=()=>{if(s2||!s3||s4||!s1)throw Error("worker not ready")},oe=e=>{switch(e.data.type){case"init-wasm":s2=!1,e.data.err?(s4=!0,s8[1](e.data.err)):(s3=!0,s8[0]()),s6&&(URL.revokeObjectURL(s6),s6=void 0);break;case"init-ep":case"copy-from":case"create":case"release":case"run":case"end-profiling":{let r=s5.get(e.data.type);e.data.err?r.shift()[1](e.data.err):r.shift()[0](e.data.out)}}},ot=async()=>{if(!s3){if(s2)throw Error("multiple calls to 'initWasm()' detected.");if(s4)throw Error("previous call to 'initWasm()' failed.");if(s2=!0,s0())return new Promise((r,i)=>{s1?.terminate(),eG().then(([a,n])=>{try{(s1=n).onerror=e=>i(e),s1.onmessage=oe,s8=[r,i];let s={type:"init-wasm",in:A};!s.in.wasm.wasmPaths&&(a||eU)&&(s.in.wasm.wasmPaths={wasm:new e.U(e.r(3789)).href}),s1.postMessage(s),s6=a}catch(e){i(e)}},i)});try{await eY(A.wasm),await sV(A),s3=!0}catch(e){throw s4=!0,e}finally{s2=!1}}},or=async e=>{if(s0())return s7(),new Promise((r,i)=>{s9("init-ep",[r,i]);let a={type:"init-ep",in:{epName:e,env:A}};s1.postMessage(a)});await sj(A,e)},oi=async e=>s0()?(s7(),new Promise((r,i)=>{s9("copy-from",[r,i]),s1.postMessage({type:"copy-from",in:{buffer:e}},[e.buffer])})):sH(e),oa=async(e,r)=>{if(!s0())return sK(e,r);if(r?.preferredOutputLocation)throw Error('session option "preferredOutputLocation" is not supported for proxy.');return s7(),new Promise((i,a)=>{s9("create",[i,a]);let n={type:"create",in:{model:e,options:{...r}}},s=[];e instanceof Uint8Array&&s.push(e.buffer),s1.postMessage(n,s)})},on=async e=>{if(s0())return s7(),new Promise((r,i)=>{s9("release",[r,i]),s1.postMessage({type:"release",in:e})});sZ(e)},os=async(e,r,i,a,n,s)=>{if(!s0())return sQ(e,r,i,a,n,s);if(i.some(e=>"cpu"!==e[3]))throw Error("input tensor on GPU is not supported for proxy.");if(n.some(e=>e))throw Error("pre-allocated output tensor is not supported for proxy.");return s7(),new Promise((n,o)=>{s9("run",[n,o]),s1.postMessage({type:"run",in:{sessionId:e,inputIndices:r,inputs:i,outputIndices:a,options:s}},sJ(i))})},oo=async e=>{if(s0())return s7(),new Promise((r,i)=>{s9("end-profiling",[r,i]),s1.postMessage({type:"end-profiling",in:e})});sY(e)}}),of=eo(()=>{eC(),oh(),nR(),eE(),nN(),ou=(e,r)=>{switch(e.location){case"cpu":return[e.type,e.dims,e.data,"cpu"];case"gpu-buffer":return[e.type,e.dims,{gpuBuffer:e.gpuBuffer},"gpu-buffer"];case"ml-tensor":return[e.type,e.dims,{mlTensor:e.mlTensor},"ml-tensor"];default:throw Error(`invalid data location: ${e.location} for ${r()}`)}},ol=e=>{switch(e[3]){case"cpu":return new H(e[0],e[2],e[1]);case"gpu-buffer":{let r=e[0];if(!tr(r))throw Error(`not supported data type: ${r} for deserializing GPU tensor`);let{gpuBuffer:i,download:a,dispose:n}=e[2];return H.fromGpuBuffer(i,{dataType:r,dims:e[1],download:a,dispose:n})}case"ml-tensor":{let r=e[0];if(!ti(r))throw Error(`not supported data type: ${r} for deserializing MLTensor tensor`);let{mlTensor:i,download:a,dispose:n}=e[2];return H.fromMLTensor(i,{dataType:r,dims:e[1],download:a,dispose:n})}default:throw Error(`invalid data location: ${e[3]}`)}},od=class{async fetchModelAndCopyToWasmMemory(e){return oi(await tn(e))}async loadModel(e,r){let i;X(),i="string"==typeof e?await this.fetchModelAndCopyToWasmMemory(e):e,[this.sessionId,this.inputNames,this.outputNames,this.inputMetadata,this.outputMetadata]=await oa(i,r),Q()}async dispose(){return on(this.sessionId)}async run(e,r,i){X();let a=[],n=[];Object.entries(e).forEach(e=>{let r=e[0],i=e[1],s=this.inputNames.indexOf(r);if(-1===s)throw Error(`invalid input '${r}'`);a.push(i),n.push(s)});let s=[],o=[];Object.entries(r).forEach(e=>{let r=e[0],i=e[1],a=this.outputNames.indexOf(r);if(-1===a)throw Error(`invalid output '${r}'`);s.push(i),o.push(a)});let u=a.map((e,r)=>ou(e,()=>`input "${this.inputNames[n[r]]}"`)),l=s.map((e,r)=>e?ou(e,()=>`output "${this.outputNames[o[r]]}"`):null),d=await os(this.sessionId,n,u,o,l,i),p={};for(let e=0;e<d.length;e++)p[this.outputNames[o[e]]]=s[e]??ol(d[e]);return Q(),p}startProfiling(){}endProfiling(){oo(this.sessionId)}}}),om={};eu(om,{OnnxruntimeWebAssemblyBackend:()=>oy,initializeFlags:()=>og,wasmBackend:()=>o_});var og,oy,o_,ob=eo(()=>{eC(),oh(),of(),og=()=>{("number"!=typeof A.wasm.initTimeout||A.wasm.initTimeout<0)&&(A.wasm.initTimeout=0);let e=A.wasm.simd;if("boolean"!=typeof e&&void 0!==e&&"fixed"!==e&&"relaxed"!==e&&(console.warn(`Property "env.wasm.simd" is set to unknown value "${e}". Reset it to \`false\` and ignore SIMD feature checking.`),A.wasm.simd=!1),"boolean"!=typeof A.wasm.proxy&&(A.wasm.proxy=!1),"boolean"!=typeof A.wasm.trace&&(A.wasm.trace=!1),"number"!=typeof A.wasm.numThreads||!Number.isInteger(A.wasm.numThreads)||A.wasm.numThreads<=0)if("u">typeof self&&!self.crossOriginIsolated)A.wasm.numThreads=1;else{let e=typeof navigator>"u"?es("node:os").cpus().length:navigator.hardwareConcurrency;A.wasm.numThreads=Math.min(4,Math.ceil((e||1)/2))}},o_=new(oy=class{async init(e){og(),await ot(),await or(e)}async createInferenceSessionHandler(e,r){let i=new od;return await i.loadModel(e,r),i}})});eC(),eC(),eC();{let e=(ob(),el(om)).wasmBackend;k("webgpu",e,5),k("webnn",e,5),k("cpu",e,10),k("wasm",e,10)}Object.defineProperty(A.versions,"web",{value:"1.26.0",enumerable:!0});let o$=[.1,.2],ov=!1;class ow{retinaFaceSession=null;miniFASSession=null;anchors=[];stabilityCounter=0;async loadModels({includeLiveness:e=!0}={}){ov||(A.logLevel="fatal",A.wasm.wasmPaths="/ort/",A.wasm.numThreads=1,ov=!0),this.anchors=this.generateAnchors(640);let r={executionProviders:["wasm"],graphOptimizationLevel:"all"};this.retinaFaceSession=await et.create("/models/liveness/Widerface-RetinaFace.onnx",r),e&&(this.miniFASSession=await et.create("/models/liveness/2.7_80x80_MiniFASNetV2_Fixed.onnx",r))}async processFaceFrame(e){if(!this.retinaFaceSession)throw Error("Face detection model is not loaded.");let r=await this.detectFaces(e);return 0===r.length?null:{bbox:r.reduce((e,r)=>this.boxArea(r)>this.boxArea(e)?r:e)}}async processFrame(e){if(!this.retinaFaceSession||!this.miniFASSession)throw Error("Face liveness models are not loaded.");let r=await this.processFaceFrame(e);if(!r)return this.stabilityCounter=0,null;let i=r.bbox,a=await this.checkLivenessRaw(e,i),n="FAKE",s=!1;return a.isRealRaw?(this.stabilityCounter++,this.stabilityCounter>=4?(n="REAL",s=!0,this.stabilityCounter=5):n="VERIFYING..."):this.stabilityCounter=0,{bbox:i,liveness:{isRealRaw:a.isRealRaw,isReal:s,label:n,confidence:a.confidence,stabilityScore:Math.min(this.stabilityCounter,4),probabilities:a.probabilities}}}boxArea(e){return Math.max(0,e[2]-e[0])*Math.max(0,e[3]-e[1])}async detectFaces(e){if(!this.retinaFaceSession)return[];let r=this.preprocessRetinaFace(e),i={[this.retinaFaceSession.inputNames[0]]:r},a=await this.retinaFaceSession.run(i),{loc:n,conf:s}=this.extractRetinaFaceOutput(a);return n&&s?this.postProcessRetinaFace(n,s,this.anchors,e.videoWidth,e.videoHeight):[]}async checkLivenessRaw(e,r){if(!this.miniFASSession)throw Error("MiniFASNet session is not loaded.");let i=this.cropFace(e,r,80),a=this.preprocessMiniFASNet(i),n={[this.miniFASSession.inputNames[0]]:a},s=(await this.miniFASSession.run(n))[this.miniFASSession.outputNames[0]].data,o=s[0]??-999,u=s[1]??-999,l=s[2]??-999,d=Math.max(o,u,l),p=Math.exp(o-d),c=Math.exp(u-d),h=Math.exp(l-d),f=p+c+h,m=p/f,g=c/f,y=h/f,_=0,b=m;return g>b&&(_=1,b=g),y>b&&(_=2,b=y),{isRealRaw:1===_&&b>.62,rawLabel:1===_?"REAL":"FAKE",confidence:b,probabilities:{fakePrint:m,real:g,fakeScreen:y}}}preprocessMiniFASNet(e){let{data:r}=e,i=6400,a=new Float32Array(19200);for(let e=0;e<i;e++){let n=r[4*e],s=r[4*e+1],o=r[4*e+2];a[e]=o,a[e+i]=s,a[e+2*i]=n}return new H("float32",a,[1,3,80,80])}preprocessRetinaFace(e){let r=document.createElement("canvas");r.width=640,r.height=640;let i=r.getContext("2d");if(!i)throw Error("Unable to create canvas context.");i.drawImage(e,0,0,640,640);let{data:a}=i.getImageData(0,0,640,640),n=new Float32Array(1228800);for(let e=0;e<409600;e++){let r=a[4*e],i=a[4*e+1],s=a[4*e+2];n[e]=s-104,n[e+409600]=i-117,n[e+819200]=r-123}return new H("float32",n,[1,3,640,640])}cropFace(e,r,i){let[a,n,s,o]=r,u=s-a,l=o-n,d=1.5*u,p=1.5*l,c=a+u/2-d/2,h=n+l/2-p/2,f=Math.max(0,c),m=Math.max(0,h),g=Math.min(e.videoWidth-f,d-(f-c)),y=Math.min(e.videoHeight-m,p-(m-h));if(g<=0||y<=0)return new ImageData(i,i);let _=document.createElement("canvas");_.width=g,_.height=y;let b=_.getContext("2d");if(!b)return new ImageData(i,i);b.translate(g,0),b.scale(-1,1),b.drawImage(e,f,m,g,y,0,0,g,y);let $=g,v=y;for(;$>2*i;){let e=Math.floor(.5*$),r=Math.floor(.5*v),i=document.createElement("canvas");i.width=e,i.height=r;let a=i.getContext("2d");if(!a)break;a.drawImage(_,0,0,$,v,0,0,e,r),_=i,$=e,v=r}let w=document.createElement("canvas");w.width=i,w.height=i;let x=w.getContext("2d");return x?(x.filter="blur(0.5px)",x.fillStyle="black",x.fillRect(0,0,i,i),x.drawImage(_,0,0,$,v,0,0,i,i),x.getImageData(0,0,i,i)):new ImageData(i,i)}generateAnchors(e){let r=[[16,32],[64,128],[256,512]],i=[8,16,32],a=[];return[[Math.ceil(e/8),Math.ceil(e/8)],[Math.ceil(e/16),Math.ceil(e/16)],[Math.ceil(e/32),Math.ceil(e/32)]].forEach((n,s)=>{let o=i[s];for(let i=0;i<n[0];i++)for(let u=0;u<n[1];u++)for(let n of r[s])a.push([(u+.5)*o/e,(i+.5)*o/e,n/e,n/e])}),a}extractRetinaFaceOutput(e){let r=new Float32Array(67200),i=new Float32Array(33600),a=0;for(let n of[8,16,32]){let s=640/n,o=s*s*2,u=null,l=null;for(let r in e){let i=e[r];if(!("dims"in i)||!("data"in i))continue;let a=i.dims;a[2]===s&&a[3]===s&&(8===a[1]&&(u=i.data),4===a[1]&&(l=i.data))}if(!u||!l){a+=o;continue}for(let e=0;e<s;e++)for(let n=0;n<s;n++)for(let o=0;o<2;o++){let d=a+(e*s+n)*2+o;for(let i=0;i<4;i++){let a=4*o+i;r[4*d+i]=u[s*s*a+e*s+n]}for(let r=0;r<2;r++){let a=2*o+r;i[2*d+r]=l[s*s*a+e*s+n]}}a+=o}return{loc:r,conf:i}}postProcessRetinaFace(e,r,i,a,n){let s=[],[o,u]=o$;for(let l=0;l<i.length;l++){let d=r[2*l+1];if(d<=.45)continue;let p=i[l],c=e[4*l],h=e[4*l+1],f=e[4*l+2],m=e[4*l+3],g=p[0]+c*o*p[2],y=p[1]+h*o*p[3],_=p[2]*Math.exp(f*u),b=p[3]*Math.exp(m*u),$=(g-_/2)*a,v=(y-b/2)*n,w=(g+_/2)*a,x=(y+b/2)*n;s.push([$,v,w,x,d])}return this.nms(s,.4)}nms(e,r){if(0===e.length)return[];e.sort((e,r)=>r[4]-e[4]);let i=[],a=Array(e.length).fill(!0);for(let n=0;n<e.length;n++){if(!a[n])continue;let s=e[n];i.push(s);for(let i=n+1;i<e.length;i++){if(!a[i])continue;let n=e[i],o=Math.max(s[0],n[0]),u=Math.max(s[1],n[1]),l=Math.max(0,Math.min(s[2],n[2])-o)*Math.max(0,Math.min(s[3],n[3])-u),d=this.boxArea(s)+this.boxArea(n)-l;d>0&&l/d>r&&(a[i]=!1)}}return i}}var ox=e.i(27140),oS=e.i(86392),ok=e.i(59538),oT=e.i(20617);let oI={cx:640,cy:300,rx:190,ry:225,minFace:.15,maxScale:1.8,centerTolerance:1.05,shoulderWidth:1.35},oC={cx:640,cy:330,rx:250,ry:300,minFace:.13,maxScale:2.75,centerTolerance:1.22,shoulderWidth:1.75};function oE(){let[e,a]=(0,i.useState)("verifying"),[n,l]=(0,i.useState)(!1),[p,c]=(0,i.useState)(!1),[f,m]=(0,i.useState)(!1),[g,y]=(0,i.useState)(null),[$,w]=(0,i.useState)(!1);(0,i.useEffect)(()=>{let e=()=>m(window.innerWidth<768);return e(),window.addEventListener("resize",e),()=>window.removeEventListener("resize",e)},[]);let x=(0,i.useRef)(null),S=(0,i.useRef)(null),k=(0,_.useRouter)(),{faceBlob:T,kodeTiket:I,clearVerification:C,setFaceBlob:E,setStep:z}=(0,b.useVerification)(),A=(0,b.useVerificationGuard)("face"),O=(0,i.useCallback)(()=>{if(!x.current)return;let e=x.current.video,r=e?.videoWidth||1920,i=e?.videoHeight||1080,n=x.current.getScreenshot({width:r,height:i});n&&(S.current=function(e){let r=e.split(","),i=r[0].match(/:(.*?);/)?.[1]||"image/jpeg",a=atob(r[1]),n=new Uint8Array(a.length);for(let e=0;e<a.length;e++)n[e]=a.charCodeAt(e);return new Blob([n],{type:i})}(n),E(S.current),a("success"))},[x]);(0,i.useCallback)(()=>{S.current&&!p&&(c(!0),E(S.current),z("sound"),k.push("/verification/sound"))},[p,E,z,k]);let{handleSubmit:M,handleErrorClose:R}=(0,oT.useHandleSubmit)({faceBlob:T,kodeTiket:I,errorMsg:g,setErrorMsg:y,setSubmitting:w,submitBiometricData:oS.submitBiometricData,getApiErrorMessage:oS.getApiErrorMessage});return p?(0,r.jsx)(v.TransitionLoading,{message:"Menyiapkan verifikasi suara..."}):A?(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(ox.default,{}),(0,r.jsx)(ok.Modal,{open:!!g,onClose:R,title:"Registrasi Gagal",description:g}),(0,r.jsx)("div",{className:"space-y-6",children:(0,r.jsxs)("div",{className:"bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden",children:[(0,r.jsxs)("div",{className:"relative flex items-center justify-between px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-100 gap-2",children:[(0,r.jsxs)("div",{className:"flex items-center gap-2 min-w-0",children:[(0,r.jsx)(d,{className:"w-5 h-5 text-[#3b5bdb] shrink-0"}),(0,r.jsx)("span",{className:"font-semibold text-[#1e2a4a] truncate",children:"Pendaftaran Wajah"})]}),(0,r.jsx)("span",{className:`text-xs font-semibold px-3 py-1 rounded-full border shrink-0 ${"success"===e?"text-emerald-600 bg-emerald-50 border-emerald-200":"text-[#3b5bdb] bg-blue-50 border-blue-200"}`,children:"success"===e?"Selesai":"Langkah 2 dari 3"})]}),(0,r.jsxs)("div",{className:"px-4 sm:px-6 py-6 sm:py-10 flex flex-col items-center text-center",children:["failed"===e&&(0,r.jsx)(oz,{}),"success"===e&&(0,r.jsx)(oA,{}),"verifying"===e&&(0,r.jsx)(oO,{webcamRef:x,faceInFrame:n,setFaceInFrame:l,onCapture:O,isMobile:f})]}),(0,r.jsxs)("div",{className:"px-4 sm:px-6 py-3 sm:py-4 border-t border-gray-100 flex items-center justify-between",children:["failed"===e&&(0,r.jsxs)("button",{onClick:()=>a("verifying"),className:"inline-flex items-center gap-2 px-6 py-2.5 rounded-lg bg-[#3b5bdb] text-white font-medium text-sm hover:bg-[#3451c5] transition-colors",children:[(0,r.jsx)(o.RefreshCw,{className:"w-4 h-4"}),"Ulangi"]}),"verifying"===e&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)("button",{onClick:()=>{C(),k.push("/verification/ticket")},className:"inline-flex items-center gap-2 px-5 py-2.5 rounded-lg border border-gray-200 text-gray-700 font-medium text-sm hover:bg-gray-50 transition-colors",children:[(0,r.jsx)(u.ArrowLeft,{className:"w-4 h-4"}),"Kembali"]}),!f&&(0,r.jsxs)("button",{disabled:!n,onClick:O,className:`ml-auto inline-flex items-center gap-2 px-6 py-2.5 rounded-lg text-white font-medium text-sm transition-colors ${n?"bg-[#3b5bdb] hover:bg-[#3451c5]":"bg-gray-300 cursor-not-allowed"}`,children:[(0,r.jsx)(s.Camera,{className:"w-4 h-4"}),"Ambil Foto"]})]}),"success"===e&&(0,r.jsxs)("div",{className:"flex w-full justify-between",children:[(0,r.jsxs)("button",{onClick:()=>{S.current=null,E(null),a("verifying")},className:"inline-flex items-center gap-2 px-5 py-2.5 rounded-lg border border-gray-200 text-gray-700 font-medium text-sm hover:bg-gray-50 transition-colors",children:[(0,r.jsx)(u.ArrowLeft,{className:"w-4 h-4"}),"Ulangi Foto"]}),(0,r.jsxs)("button",{onClick:M,disabled:p,className:"inline-flex items-center gap-2 px-6 py-2.5 rounded-lg bg-[#3b5bdb] text-white font-medium text-sm hover:bg-[#3451c5] transition-colors",children:[(0,r.jsx)(h,{className:"w-4 h-4"}),$?"Menyimpan...":"Simpan"]})]})]})]})})]}):null}function oz(){return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)("div",{className:"relative mb-6",children:(0,r.jsx)("div",{className:"w-24 h-24 rounded-full bg-red-50 flex items-center justify-center",children:(0,r.jsx)("div",{className:"w-16 h-16 rounded-full bg-red-100 flex items-center justify-center",children:(0,r.jsx)(a.AlertCircle,{className:"w-10 h-10 text-red-500"})})})}),(0,r.jsx)("h2",{className:"text-xl font-bold text-[#1e2a4a] mb-2",children:"Verifikasi Gagal"}),(0,r.jsx)("p",{className:"text-gray-500 text-sm max-w-md mb-6",children:"Kami tidak dapat memverifikasi wajah Anda. Mohon periksa kembali kondisi pengambilan foto berikut:"}),(0,r.jsxs)("div",{className:"bg-red-50 border border-red-100 rounded-xl px-6 py-5 w-full max-w-md text-left space-y-4",children:[(0,r.jsxs)("div",{className:"flex items-start gap-3",children:[(0,r.jsx)(p.XCircle,{className:"w-5 h-5 text-red-500 mt-0.5 shrink-0"}),(0,r.jsxs)("div",{children:[(0,r.jsx)("p",{className:"font-semibold text-red-600 text-sm",children:"Pencahayaan kurang terang"}),(0,r.jsx)("p",{className:"text-gray-500 text-xs mt-0.5",children:"Pastikan wajah tersinari dengan baik."})]})]}),(0,r.jsxs)("div",{className:"flex items-start gap-3",children:[(0,r.jsx)(p.XCircle,{className:"w-5 h-5 text-red-500 mt-0.5 shrink-0"}),(0,r.jsxs)("div",{children:[(0,r.jsx)("p",{className:"font-semibold text-red-600 text-sm",children:"Wajah tidak terdeteksi sepenuhnya"}),(0,r.jsx)("p",{className:"text-gray-500 text-xs mt-0.5",children:"Lepaskan masker atau kacamata hitam."})]})]}),(0,r.jsxs)("div",{className:"flex items-start gap-3",children:[(0,r.jsx)(p.XCircle,{className:"w-5 h-5 text-red-500 mt-0.5 shrink-0"}),(0,r.jsxs)("div",{children:[(0,r.jsx)("p",{className:"font-semibold text-red-600 text-sm",children:"Posisi wajah miring"}),(0,r.jsx)("p",{className:"text-gray-500 text-xs mt-0.5",children:"Harap pandangan lurus ke depan."})]})]})]})]})}function oA(){return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)("div",{className:"relative mb-6",children:(0,r.jsxs)("div",{className:"w-24 h-24 rounded-full bg-emerald-50 flex items-center justify-center relative",children:[(0,r.jsx)("div",{className:"w-16 h-16 rounded-full bg-emerald-100 flex items-center justify-center",children:(0,r.jsx)(n.CheckCircle2,{className:"w-10 h-10 text-emerald-500"})}),(0,r.jsx)("svg",{className:"absolute -top-1 -right-1 w-5 h-5 text-emerald-400",viewBox:"0 0 24 24",fill:"currentColor",children:(0,r.jsx)("path",{d:"M12 0L14.59 8.41L23 11L14.59 13.59L12 22L9.41 13.59L1 11L9.41 8.41L12 0Z"})}),(0,r.jsx)("svg",{className:"absolute bottom-0 -left-2 w-4 h-4 text-emerald-300",viewBox:"0 0 24 24",fill:"currentColor",children:(0,r.jsx)("path",{d:"M12 0L14.59 8.41L23 11L14.59 13.59L12 22L9.41 13.59L1 11L9.41 8.41L12 0Z"})})]})}),(0,r.jsx)("h2",{className:"text-xl font-bold text-[#1e2a4a] mb-2",children:"Verifikasi Berhasil!"}),(0,r.jsx)("p",{className:"text-gray-500 text-sm max-w-md mb-6",children:"Data wajah Anda berhasil didaftarkan. Klik Simpan untuk menyelesaikan proses."})]})}function oO({webcamRef:e,faceInFrame:a,setFaceInFrame:n,onCapture:o,isMobile:u}){let[l,d]=(0,i.useState)("loading"),[p,c]=(0,i.useState)(null),[h,f]=(0,i.useState)(0),[m,g]=(0,i.useState)({facingMode:"user",aspectRatio:16/9}),[_,$]=(0,i.useState)(oI),v=(0,i.useRef)(oI),w=(0,i.useRef)(null),x=(0,i.useRef)(!1),S=(0,i.useRef)(!1),k=(0,i.useRef)(!1);(0,i.useEffect)(()=>{{let e=u?oC:oI;$(e),v.current=e,g({facingMode:"user",aspectRatio:16/9})}},[u]),(0,i.useEffect)(()=>{let r,i=!0;return async function(){x.current=!1,S.current=!1;try{d("loading"),n(!1);let e=new ow;await e.loadModels({includeLiveness:!1}),w.current=e}catch(r){let e=r instanceof Error?r.message:String(r);console.warn(`Failed to load face detection model: ${e}`),i&&(d("error"),n(!1));return}i&&(r=setInterval(async()=>{let a=e.current?.video;if(a&&4===a.readyState&&w.current&&!k.current&&!x.current){k.current=!0;try{let e=await w.current.processFaceFrame(a);if(!i)return;if(!e){n(!1),d("no-face"),c(null),f(0);return}let[r,s,o,u]=e.bbox,l=a.videoWidth,p=a.videoHeight,h=a.clientWidth,m=a.clientHeight;if(0===l||0===p||0===h||0===m)return;let g=Math.max(h/l,m/p),y=Math.max(h/1280,m/720),_=((r+o)/2*g-(l*g-h)/2+(1280*y-h)/2)/y,b=((s+u)/2*g-(p*g-m)/2+(720*y-m)/2)/y,$=(o-r)*g/y,x=v.current,S=(_-x.cx)/x.rx,k=(b-x.cy)/x.ry,T=S*S+k*k<=x.centerTolerance*x.centerTolerance,I=2*x.rx,C=2*x.ry,E=Math.max(1280*x.minFace,.5*I),z=I*x.maxScale,A=T&&$>=E&&(u-s)*g/y>=.55*C&&$<=z;n(A),c(null),f(0),A?d("real"):d("out-of-frame")}catch(e){if(x.current=!0,!S.current){let r=e instanceof Error?e.message:String(e);console.warn(`Face detection disabled: ${r}`),S.current=!0}i&&(n(!1),d("error")),r&&clearInterval(r)}finally{k.current=!1}}},300))}(),()=>{i=!1,r&&clearInterval(r),w.current=null,n(!1)}},[n,e]);let{permissionGrantedTime:T}=(0,b.useVerification)(),I=function(e,r,i){switch(e){case"loading":return{label:"Memuat...",className:"bg-blue-500/90"};case"no-face":return{label:"Posisikan wajah di frame",className:"bg-red-500/90"};case"out-of-frame":return{label:"Wajah belum pas di frame",className:"bg-amber-500/90"};case"verifying":return{label:`Memverifikasi wajah ${i}/4`,className:"bg-amber-500/90"};case"real":return{label:"Posisi wajah sudah pas",className:"bg-emerald-500/90"};case"fake":return{label:"Wajah tidak lolos verifikasi",className:"bg-red-500/90"};default:return{label:"Terjadi kesalahan",className:"bg-red-500/90"}}}(l,0,h);return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)("div",{className:"relative w-full max-w-lg mb-8 rounded-xl bg-gray-900 aspect-3/4 sm:aspect-video",children:[(0,r.jsxs)("div",{className:"absolute inset-0 rounded-xl overflow-hidden",children:[(0,r.jsx)(y.default,{className:"absolute inset-0 w-full h-full object-cover",audio:!1,ref:e,screenshotFormat:"image/jpeg",screenshotQuality:1,mirrored:!0,videoConstraints:m},T||"webcam-default"),(0,r.jsxs)("svg",{className:"absolute inset-0 w-full h-full pointer-events-none",viewBox:"0 0 1280 720",preserveAspectRatio:"xMidYMid slice",children:[(0,r.jsx)("defs",{children:(0,r.jsxs)("mask",{id:"face-cutout",children:[(0,r.jsx)("rect",{width:"1280",height:"720",fill:"white"}),(0,r.jsx)("path",{d:oM(_,!0),fill:"black"})]})}),(0,r.jsx)("rect",{width:"1280",height:"720",fill:"rgba(0,0,0,0.5)",mask:"url(#face-cutout)"}),(0,r.jsx)("path",{d:oM(_),fill:"none",stroke:a?"#16A34A":"#DC2626",strokeWidth:"6",strokeLinejoin:"round",strokeLinecap:"round",style:{transition:"stroke 0.3s ease"}})]})]}),(0,r.jsx)("div",{className:`absolute text-white text-xs font-medium px-3 py-1.5 rounded-full backdrop-blur-sm z-10 ${I.className}`,style:u?{top:"-15px",left:"50%",transform:"translateX(-50%)"}:{bottom:"0.75rem",left:"50%",transform:"translateX(-50%)"},children:I.label}),u&&(0,r.jsx)("div",{className:"absolute bottom-3 left-1/2 -translate-x-1/2 z-20",children:(0,r.jsx)("button",{disabled:!a,onClick:o,className:`flex items-center justify-center w-16 h-16 rounded-full border-4 border-white/80 shadow-lg transition-all active:scale-95 ${a?"bg-[#3b5bdb] hover:bg-[#3451c5]":"bg-gray-400 cursor-not-allowed"}`,children:(0,r.jsx)(s.Camera,{className:"w-7 h-7 text-white"})})})]}),(0,r.jsx)(oR,{})]})}function oM(e,r=!1){let{cx:i,cy:a,rx:n,ry:s}=e,o=a+.98*s,u=i-n*e.shoulderWidth,l=i+n*e.shoulderWidth,d=`M ${u} ${o} C ${i-1.02*n} ${a+.88*s}, ${i-.7*n} ${a+.87*s}, ${i-.48*n} ${a+.82*s} C ${i-.37*n} ${a+.79*s}, ${i-.36*n} ${a+.72*s}, ${i-.36*n} ${a+.62*s} C ${i-.53*n} ${a+.52*s}, ${i-.66*n} ${a+.38*s}, ${i-.72*n} ${a+.2*s} C ${i-.84*n} ${a+.2*s}, ${i-.9*n} ${a+.08*s}, ${i-.9*n} ${a-.07*s} C ${i-.9*n} ${a-.22*s}, ${i-.84*n} ${a-.34*s}, ${i-.73*n} ${a-.35*s} C ${i-.7*n} ${a-.72*s}, ${i-.46*n} ${a-.98*s}, ${i} ${a-.98*s} C ${i+.46*n} ${a-.98*s}, ${i+.7*n} ${a-.72*s}, ${i+.73*n} ${a-.35*s} C ${i+.84*n} ${a-.34*s}, ${i+.9*n} ${a-.22*s}, ${i+.9*n} ${a-.07*s} C ${i+.9*n} ${a+.08*s}, ${i+.84*n} ${a+.2*s}, ${i+.72*n} ${a+.2*s} C ${i+.66*n} ${a+.38*s}, ${i+.53*n} ${a+.52*s}, ${i+.36*n} ${a+.62*s} C ${i+.36*n} ${a+.72*s}, ${i+.37*n} ${a+.79*s}, ${i+.48*n} ${a+.82*s} C ${i+.7*n} ${a+.87*s}, ${i+1.02*n} ${a+.88*s}, ${l} ${o}`;return r?`${d} L ${l} 760 L ${u} 760 Z`:d}function oR(){let[e,a]=(0,i.useState)(!1),n=(0,i.useRef)(!1);return(0,i.useEffect)(()=>{n.current||(a(!0),n.current=!0)},[]),(0,r.jsxs)($.Dialog,{open:e,onOpenChange:a,children:[(0,r.jsx)($.DialogTrigger,{asChild:!0,children:(0,r.jsxs)("button",{className:"inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-gray-200 bg-white text-[#3b5bdb] font-medium text-sm hover:bg-blue-50 transition-colors cursor-pointer",children:[(0,r.jsx)(c.Info,{className:"w-4 h-4"}),"Lihat Tips Pengambilan Foto"]})}),(0,r.jsxs)($.DialogContent,{className:"sm:max-w-md bg-white",children:[(0,r.jsx)($.DialogHeader,{children:(0,r.jsxs)($.DialogTitle,{className:"flex items-center gap-2 text-[#1e2a4a]",children:[(0,r.jsx)(c.Info,{className:"w-5 h-5 text-[#3b5bdb]"}),"Tips Pengambilan Foto"]})}),(0,r.jsx)("p",{className:"text-gray-500 text-sm leading-relaxed",children:"Pastikan pencahayaan cukup terang dan wajah Anda terlihat jelas tanpa aksesoris (masker, kacamata, topi)."}),(0,r.jsxs)("div",{className:"flex items-center justify-around gap-4 py-4",children:[(0,r.jsxs)("div",{className:"flex flex-col gap-2 items-center",children:[(0,r.jsx)("div",{className:"size-12 bg-[#DC2626]/10 text-[#DC2626] flex items-center justify-center rounded-full text-[24px]",children:(0,r.jsx)(g,{})}),(0,r.jsx)("p",{className:"text-[12px] text-center text-[#6B7280] uppercase font-medium",children:"Tanpa Masker"})]}),(0,r.jsxs)("div",{className:"flex flex-col gap-2 items-center",children:[(0,r.jsx)("div",{className:"size-12 bg-[#16A34A]/10 text-[#16A34A] flex items-center justify-center rounded-full text-[24px]",children:(0,r.jsx)(m,{})}),(0,r.jsx)("p",{className:"text-[12px] text-center text-[#6B7280] uppercase font-medium",children:"Cahaya Cukup"})]}),(0,r.jsxs)("div",{className:"flex flex-col gap-2 items-center",children:[(0,r.jsx)("div",{className:"size-12 bg-[#DC2626]/10 text-[#DC2626] flex items-center justify-center rounded-full text-[24px]",children:(0,r.jsx)(f,{})}),(0,r.jsx)("p",{className:"text-[12px] text-center text-[#6B7280] uppercase font-medium",children:"Wajah Jelas"})]})]}),(0,r.jsx)("button",{onClick:()=>a(!1),className:"mt-2 w-full inline-flex items-center justify-center gap-2 px-6 py-2.5 rounded-lg bg-[#3b5bdb] text-white font-medium text-sm hover:bg-[#3451c5] transition-colors",children:"Mengerti"})]})]})}e.s(["default",()=>oE],11559)}]);